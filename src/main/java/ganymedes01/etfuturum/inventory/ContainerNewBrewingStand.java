...
public class ContainerNewBrewingStand extends Container {
    ...
    public ContainerNewBrewingStand(InventoryPlayer playerInvt, TileEntityNewBrewingStand tile) {
        ...
        for (int i = 0; i < 9; i++) addSlotToContainer(new Slot(playerInvt, i, 8 + i * 18, 142));
    }
    ...
    public void detectAndSendChanges() {
        ...
        for (Object crafter : crafters) {
            ...
            if (prevBrewTime != tile.getBrewTime()) icrafting.sendProgressBarUpdate(this, 0, tile.getBrewTime());
    ...
    public void updateProgressBar(int id, int value) {
        if (id == 0) tile.func_145938_d(value); // setBrewTime
        else if (id == 1) tile.setFuel(value);
        else if (id == 2) tile.setCurrentFuel(value);
    }
