...
public class BlockModernWoodFence extends BlockFence implements ISubBlocksBlock {
    ...
    public boolean canConnectFenceTo(IBlockAccess world, int x, int y, int z) {
        ...
        return block instanceof BlockWoodFence || block instanceof BlockModernWoodFence
            ...
            || super.canConnectFenceTo(world, x, y, z);
    }
    ...
    public int getRenderType() {
        // We need to do this because some things stupidly check if there's a fence by checking if the render type is 11
        // and not if it's instance of Fence!!!
