...
public class BlockCopperBulb extends BlockCopper {
        ...
        super(
            powered
                ? new String[] { "copper_bulb_powered", "exposed_copper_bulb_powered", "weathered_copper_bulb_powered",
                    ...
                    "weathered_copper_bulb_lit_powered", "oxidized_copper_bulb_lit_powered",
                    "waxed_copper_bulb_powered", "waxed_exposed_copper_bulb_powered",
                    "waxed_weathered_copper_bulb_powered", "waxed_oxidized_copper_bulb_powered",
                    "waxed_copper_bulb_lit_powered", "waxed_exposed_copper_bulb_lit_powered",
                    "waxed_weathered_copper_bulb_lit_powered", "waxed_oxidized_copper_bulb_lit" }
                : new String[] { "copper_bulb", "exposed_copper_bulb", "weathered_copper_bulb", "oxidized_copper_bulb",
                    "copper_bulb_lit", "exposed_copper_bulb_lit", "weathered_copper_bulb_lit",
                    "oxidized_copper_bulb_lit", "waxed_copper_bulb", "waxed_exposed_copper_bulb",
                    "waxed_weathered_copper_bulb", "waxed_oxidized_copper_bulb", "waxed_copper_bulb_lit",
                    "waxed_exposed_copper_bulb_lit", "waxed_weathered_copper_bulb_lit",
    ...
    public String getNameFor(ItemStack stack) {
        ...
        return "".equals(type) ? getUnlocalizedName().replace("tile.", "")
            .replace(getNameDomain() + ".", "") : type;
    }
    ...
    private void switchBulbState(World world, int x, int y, int z) {
        ...
        if (!powered) {
            world.playSoundEffect(
                ...
                y,
                z,
                Reference.MCAssetVer + ":block.copper_bulb.turn_" + (lit ? "off" : "on"),
                1,
                1);
            if (lit) {
                meta -= 4;
