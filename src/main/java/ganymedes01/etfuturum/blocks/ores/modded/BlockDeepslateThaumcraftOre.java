...
public class BlockDeepslateThaumcraftOre extends BaseSubtypesDeepslateOre implements IEmissiveLayerBlock {
    ...
    public static final int[] colors = new int[] { 0xFFFFFF, 0xFFFF7E, 0xFF3C01, 0x0090FF, 0x00A000, 0xEECCFF,
        0x555577 };
    ...
    public BlockDeepslateThaumcraftOre() {
        super(
            ...
            "air_infused_deepslate",
            "fire_infused_deepslate",
            "water_infused_deepslate",
            "earth_infused_deepslate",
            "order_infused_deepslate",
            "entropy_infused_deepslate",
            "amber_bearing_deepslate");
    }
    ...
    public boolean addHitEffects(World worldObj, MovingObjectPosition target, EffectRenderer effectRenderer) {
        return ExternalContent.Blocks.THAUMCRAFT_ORE.get()
            .addHitEffects(worldObj, target, effectRenderer);
    }
    ...
    public IIcon getIcon(int side, int meta) {
        if (meta == 0) return getIcons()[0];
        if (meta == 7) return getIcons()[2];
        return getIcons()[1];
    }
