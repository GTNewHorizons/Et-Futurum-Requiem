...
public class BlockHoney extends BaseBlock {
    ...
    /**
     * TODO
     * showJumpParticles and showSlideParticles use a packet in modern. I really don't see any reason to implement a
     * packet for this.
    ...
    private static void showParticles(Entity p_53989_, int p_53990_) {
        if (p_53989_.worldObj.isRemote) {
            for (int i = 0; i < p_53990_; ++i) {
                p_53989_.worldObj.spawnParticle(
                    "blockcrack_" + Block.getIdFromBlock(ModBlocks.HONEY_BLOCK.get()) + "_0",
                    p_53989_.posX,
                    p_53989_.posY - p_53989_.height,
                    p_53989_.posZ,
                    0,
                    0,
                    0);
    ...
    private static boolean doesEntityDoHoneyBlockSlideEffects(Entity p_54013_) {
        return p_54013_ instanceof EntityLivingBase || p_54013_ instanceof EntityMinecart
            || p_54013_ instanceof EntityTNTPrimed
            || p_54013_ instanceof EntityBoat
            || p_54013_ instanceof EntityNewBoat;
    }
