    ...
    public void onUpdate() {
        ...
        if (boat == null && !worldObj.isRemote) {
            if (boatID == 0 && boatUUID != null) {
                for (Entity entity : worldObj.loadedEntityList) {
                    if (entity == null || entity.getPersistentID() == null) continue;
                    if (entity.getPersistentID()
                        .equals(boatUUID) && entity instanceof EntityNewBoat
                        && !entity.isDead) {
        ...
        if (worldObj.isRemote) {
            ...
            if (boat != null && boat.getSeat() == null) {
                flag = true;
            } else if (boat != null && boat.getSeat() != null
                && boat.getSeat()
                    .getEntityId() != boatID
                && boat.getSeat().riddenByEntity == null) {
                    flag = true;
                }
            if (flag) {
                boat.setSeat(this);
