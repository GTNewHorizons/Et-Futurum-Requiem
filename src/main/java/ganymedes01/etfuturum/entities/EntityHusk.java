...
public class EntityHusk extends EntityZombie {
     ...
     * return true;
     * }
     * else if (summonAid.getResult() == Result.ALLOW || entitylivingbase != null && this.worldObj.difficultySetting ==
     ...
     * for (int l = 0; l < 50; ++l)
     * {
     * int i1 = i + MathHelper.getRandomIntegerInRange(this.rand, 7, 40) * MathHelper.getRandomIntegerInRange(this.rand,
     * -1, 1);
     * int j1 = j + MathHelper.getRandomIntegerInRange(this.rand, 7, 40) * MathHelper.getRandomIntegerInRange(this.rand,
     * -1, 1);
     * int k1 = k + MathHelper.getRandomIntegerInRange(this.rand, 7, 40) * MathHelper.getRandomIntegerInRange(this.rand,
     * -1, 1);
     * if (World.doesBlockHaveSolidTopSurface(this.worldObj, i1, j1 - 1, k1) && this.worldObj.getBlockLightValue(i1, j1,
     * k1) < 10)
     * {
     ...
     * this.getEntityAttribute(field_110186_bp).applyModifier(new
     * AttributeModifier("Zombie reinforcement caller charge", -0.05000000074505806D, 0));
     * entityzombie.getEntityAttribute(field_110186_bp).applyModifier(new
     * AttributeModifier("Zombie reinforcement callee charge", -0.05000000074505806D, 0));
     * break;
     * }
     * }
     * }
