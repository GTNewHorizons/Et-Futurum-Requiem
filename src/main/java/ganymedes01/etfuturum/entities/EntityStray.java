...
public class EntityStray extends EntitySkeleton {
    ...
    public IEntityLivingData onSpawnWithEgg(IEntityLivingData p_110161_1_) {
        ...
        this.setCanPickUpLoot(
            this.rand.nextFloat()
                < 0.55F * this.worldObj.func_147462_b/* getTensionFactorForBlock */(this.posX, this.posY, this.posZ));
    ...
    public void attackEntityWithRangedAttack(EntityLivingBase p_82196_1_, float p_82196_2_) {
        EntityTippedArrow entityarrow = new EntityTippedArrow(
            this.worldObj,
            this,
            p_82196_1_,
            1.6F,
        ...
        entityarrow.setDamage(
            p_82196_2_ * 2.0F + this.rand.nextGaussian() * 0.25D
    ...
    protected void dropFewItems(boolean p_70628_1_, int p_70628_2_) {
         ...
         * for (k = 0; k < j; ++k) {
         * this.dropItem(TippedArrow.setEffect(new ItemStack(ModItems.tipped_arrow),
         * Potion.potionTypes[Potion.moveSlowdown.getId()], 20*45, 0 ).getItem(), 1);
         * }
         */
    }
