...
public abstract class ExtendedPathNavigator extends PathNavigate {
    ...
    public PathEntity getEntityPathToXYZ(double toPosX, double toPosY, double toPosZ, float searchRange,
        boolean canBreakDoors, boolean canEnterDoors, boolean avoidsWater, boolean canSwim, double xOffset,
    ...
    public PathEntity getEntityPathToXYZ(int toPosX, int toPosY, int toPosZ, float searchRange, boolean canBreakDoors,
    ...
    public PathEntity getPathEntityToEntity(Entity entityIn, float searchRange, boolean canBreakDoors,
        boolean canEnterDoors, boolean avoidsWater, boolean canSwim) {
        return getEntityPathToXYZ(
            entityIn.posX,
            entityIn.posY,
