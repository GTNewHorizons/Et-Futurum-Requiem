...
public class ExtendedEntityMoveHelper extends EntityMoveHelper {
    ...
    public void onUpdateMoveHelper() {
        if (this.action == ExtendedEntityMoveHelper.Action.STRAFE) {
            float f = (float) this.entity.getEntityAttribute(SharedMonsterAttributes.movementSpeed)
                .getAttributeValue();
            ...
            if (pathnavigate != null) {
                ...
                if (pathnavigate.isSafeToStandAt(
                    MathHelper.floor_double(entity.posX),
                    MathHelper.floor_double(entity.posY),
                    MathHelper.floor_double(entity.posZ),
                    width,
                    MathHelper.ceiling_float_int(entity.height),
                    width,
                    entityOrigin,
                    entityOrigin.xCoord,
                    entityOrigin.zCoord)) {
