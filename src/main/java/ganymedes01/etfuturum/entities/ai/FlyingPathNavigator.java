...
public class FlyingPathNavigator extends ExtendedPathNavigator {
        ...
        if (!this.noPath()) {
            if (this.canNavigate()) {
                ...
                && this.currentPath.getCurrentPathIndex() < this.currentPath.getCurrentPathLength()) {
                    Vec3 Vec3 = this.currentPath
                        .getVectorFromIndex(this.theEntity, this.currentPath.getCurrentPathIndex());

                    if (MathHelper.floor_double(this.theEntity.posX) == MathHelper.floor_double(Vec3.xCoord)
                        && MathHelper.floor_double(this.theEntity.posY) == MathHelper.floor_double(Vec3.yCoord)
                        && MathHelper.floor_double(this.theEntity.posZ) == MathHelper.floor_double(Vec3.zCoord)) {
            ...
            if (!this.noPath()) {
                ...
                this.theEntity.getMoveHelper()
                    .setMoveTo(Vec31.xCoord, Vec31.yCoord, Vec31.zCoord, this.speed);
            }
        }
    }
    ...
    @Override
    public boolean isSafeToStandAt(int p_75483_1_, int p_75483_2_, int p_75483_3_, int p_75483_4_, int p_75483_5_,
