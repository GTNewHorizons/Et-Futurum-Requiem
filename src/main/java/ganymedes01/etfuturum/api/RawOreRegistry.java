        ...
        if (Utils.enableModdedRawOres()) {
            for (ItemGeneralModdedRawOre oreItem : ItemGeneralModdedRawOre.loaded) {
                for (int i = 0; i < oreItem.ores.length; i++) {
                    ...
                    for (int j = 0; j < 1; j++) {
                        if (Utils.listGeneralModdedRawOre(type.replace("ingot", "ore"))) { // If it's mythril, we'll run
                                                                                           // this once more, changing
                                                                                           // the spelling to mithril to
                                                                                           // account for both tags.
