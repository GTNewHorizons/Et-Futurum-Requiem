...
public class PistonBehaviorRegistry {
    ...
    /**
     * These blocks will stick to sticky pistons and allow you to push clusters of blocks. They won't stick to each
     * other however.
     */
    ...
    public static void init() {
        ...
        if (ModsList.MINEFACTORY_RELOADED.isLoaded()) {
            addPistonBehavior(
                GameRegistry.findBlock("MineFactoryReloaded", "pinkslime.block"),
                PistonAction.BOUNCES_ENTITIES);
        }
