...
public interface IFallingDustColor {
     ...
     * You don't need to add the interface if you do not wish to; Your IDE may falsely declare the function as unused
     * however.
     * If this function is not overridden by a BlockFalling, it will use the block's MapColor, with FF alpha added
     * before it.
     *
