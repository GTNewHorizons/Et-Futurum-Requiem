...
public class WorldGenMinableCustom extends WorldGenMinable {
    ...
    public boolean generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_) {
        if (ConfigWorld.deepslateReplacesStones && field_150519_a == ModBlocks.STONE.get()
            && p_76484_1_.getBlock(p_76484_3_, p_76484_4_, p_76484_5_) == ModBlocks.DEEPSLATE.get()) {
    ...
    private boolean canGenerate(World world, int x, int y, int z) {
        ...
        return !ConfigWorld.deepslateReplacesStones || field_150519_a != ModBlocks.STONE.get()
            || world.getBlock(x, y, z) != ModBlocks.DEEPSLATE.get();
    }
