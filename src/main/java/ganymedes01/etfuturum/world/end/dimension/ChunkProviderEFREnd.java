...
public class ChunkProviderEFREnd implements IChunkProvider {
    ...
    public void populate(IChunkProvider chunkProvider, int x, int z) {
        ...
        this.worldObj.getBiomeGenForCoords(xPos + 16, zPos + 16)
            .decorate(this.worldObj, rand, xPos, zPos);
        ...
        if (i > 4096L) {
            ...
            if (f < -20.0F && this.rand.nextInt(14) == 0) {
                this.endIslands.generate(
                    this.worldObj,
                    this.rand,
                    xPos + (this.rand.nextInt(16) + 8),
                    yPos + (55 + this.rand.nextInt(16)),
                    zPos + (this.rand.nextInt(16) + 8));
            ...
            if (this.getIslandHeightValue(x, z, 1, 1) > 40.0F) {
                ...
                for (int k = 0; k < j; ++k) {
                    ...
                    if (j1 > 0) {
                        ...
                        if (this.worldObj.isAirBlock(xPos + l, yPos + k1, zPos + i1)
                            && this.worldObj.getBlock(xPos + l, yPos + k1 - 1, zPos + i1) == Blocks.end_stone) {
                            BlockChorusFlower
                                .generatePlant(this.worldObj, xPos + l, yPos + k1, zPos + i1, this.rand, 8);
                        }
                    }
                }
            }
