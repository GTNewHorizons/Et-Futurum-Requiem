...
public class MapGenCavesHellModified extends MapGenBase {
    ...
    protected void func_151543_a(long p_151543_1_, int p_151543_3_, int p_151543_4_, Block[] p_151543_5_,
        ...
        for (boolean flag = random.nextInt(6) == 0; p_151543_15_ < p_151543_16_; ++p_151543_15_) {
            double d6 = 1.5
                + (double) (MathHelper.sin((float) p_151543_15_ * (float) Math.PI / (float) p_151543_16_) * p_151543_12_
                    * 1.0F);
            ...
            if (flag1 || random.nextInt(4) != 0) {
                ...
                if (p_151543_6_ >= d4 - 16.0 - d6 * 2.0 && p_151543_10_ >= d5 - 16.0 - d6 * 2.0
                    && p_151543_6_ <= d4 + 16.0 + d6 * 2.0
                    && p_151543_10_ <= d5 + 16.0 + d6 * 2.0) {
                            ...
                            for (j3 = k4; j3 < j2; ++j3) {
                                ...
                                for (int l3 = i2 - 1; l3 >= j4; --l3) {
                                    ...
                                    if (d12 > -0.7 && d13 * d13 + d12 * d12 + d14 * d14 < 1.0) {
                                        ...
                                        if (block1 == Blocks.netherrack || block1 instanceof BlockNylium
                                            || block1 == Blocks.soul_sand
                                            || block1 == ModBlocks.SOUL_SOIL.get()
                                            || block1 == ModBlocks.BLACKSTONE.get()
                                            || block1 == ModBlocks.BASALT.get()) {
                                            p_151543_5_[k3] = null;
                                        }
                                    }
