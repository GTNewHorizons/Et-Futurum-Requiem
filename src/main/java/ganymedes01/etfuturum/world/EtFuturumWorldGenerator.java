...
public class EtFuturumWorldGenerator implements IWorldGenerator {
    ...
    protected final WorldGenMinable copperGen = new WorldGenMinable(
        ModBlocks.COPPER_ORE.get(),
        ConfigWorld.maxCopperPerCluster);

    protected final WorldGenMinable magmaGen = new WorldGenMinable(
        ModBlocks.MAGMA.get(),
        ConfigWorld.maxMagmaPerCluster,
        Blocks.netherrack);
    protected final WorldGenMinable netherGoldGen = new WorldGenMinable(
        ModBlocks.NETHER_GOLD_ORE.get(),
        ConfigWorld.maxNetherGoldPerCluster,
        Blocks.netherrack);
    protected final WorldGenMinable debrisGen = new WorldGenMinableCustom(
        ModBlocks.ANCIENT_DEBRIS.get(),
        ConfigWorld.debrisMax,
        Blocks.netherrack);
    protected final WorldGenMinable smallDebrisGen = new WorldGenMinableCustom(
        ModBlocks.ANCIENT_DEBRIS.get(),
        ConfigWorld.smallDebrisMax,
        Blocks.netherrack);
    protected final WorldGenMinable mesaGoldGen = new WorldGenMinable(Blocks.gold_ore, 8);

    protected final WorldGenMinable deepslateBlobGen = new WorldGenDeepslateLayerBlob(
        ConfigWorld.maxDeepslatePerCluster,
        false);
    ...
    protected EtFuturumWorldGenerator() {
        stoneGen
            .add(new WorldGenMinableCustom(ModBlocks.STONE.get(), 1, ConfigWorld.maxStonesPerCluster, Blocks.stone));
        stoneGen
            .add(new WorldGenMinableCustom(ModBlocks.STONE.get(), 3, ConfigWorld.maxStonesPerCluster, Blocks.stone));
        stoneGen
            .add(new WorldGenMinableCustom(ModBlocks.STONE.get(), 5, ConfigWorld.maxStonesPerCluster, Blocks.stone));
    }

    public void postInit() {
        if (ConfigWorld.enableAmethystGeodes && ModBlocks.AMETHYST_BLOCK.isEnabled()
            && ModBlocks.AMETHYST_CLUSTER_1.isEnabled()
            && ModBlocks.AMETHYST_CLUSTER_2.isEnabled()
            && ModBlocks.BUDDING_AMETHYST.isEnabled()
            && ConfigWorld.amethystOuterBlock != null
            && ConfigWorld.amethystMiddleBlock != null) {
        ...
        if (ConfigWorld.enableFossils && ConfigWorld.fossilBlock != null) {
            ...
            for (BiomeGenBase biome : fossilBiomesArray) {
                if (!ArrayUtils.contains(BiomeDictionary.getBiomesForType(Type.HOT), biome)
                    || !ArrayUtils.contains(BiomeDictionary.getBiomesForType(Type.DRY), biome)) {
        ...
        if (ModBlocks.SWEET_BERRY_BUSH.isEnabled()) {
            berryBushBiomes = Arrays
                .asList(Utils.excludeBiomesFromTypesWithDefaults(BiomeDictionary.getBiomesForType(Type.CONIFEROUS)));
        ...
        if (ModBlocks.LILY_OF_THE_VALLEY.isEnabled()) {
            ...
            lilyValleyBiomeArray = Utils
                .excludeBiomesFromTypes(lilyValleyBiomeArray, Type.JUNGLE, Type.DRY, Type.HOT, Type.SNOWY, Type.COLD);
        ...
        if (ModBlocks.CORNFLOWER.isEnabled()) {
            ...
            cornflowerBiomeArray = Utils
                .excludeBiomesFromTypes(cornflowerBiomeArray, Type.SAVANNA, Type.SNOWY, Type.SAVANNA);
            cornflowerBiomeArray = ArrayUtils
                .add(cornflowerBiomeArray, BiomeGenBase.getBiome(BiomeGenBase.forest.biomeID + 128));
        ...
        if (ModBlocks.BAMBOO.isEnabled() && ConfigWorld.bambooWorldgen) {
            if (ModsList.BIOMES_O_PLENTY.isLoaded()) { // BoP replaces vanilla jungles with a BoP version but forgets to
                                                       // tag them
                BiomeDictionary.registerBiomeType(BiomeGenBase.getBiome(21), Type.JUNGLE); // Gets biomes by ID so we
                                                                                           // get the BOP version
            ...
            bambooBiomes = Arrays
                .asList(Utils.excludeBiomesFromTypesWithDefaults(BiomeDictionary.getBiomesForType(Type.JUNGLE)));
        }
        ...
        if (ModBlocks.CHERRY_LOG.isEnabled() && ModBlocks.LEAVES.isEnabled()) {
            ...
            cherryBiomeArray = Utils.excludeBiomesFromTypesWithDefaults(
                cherryBiomeArray,
                Type.SNOWY,
                Type.HOT,
                Type.SANDY,
        ...
        if (ModBlocks.MUD.isEnabled()) {
            ...
            if (ModsList.BIOMES_O_PLENTY.isLoaded()) { // BoP replaces vanilla swamps with a BoP version but forgets to
                                                       // tag them
                BiomeDictionary.registerBiomeType(BiomeGenBase.getBiome(6), Type.SWAMP); // Gets biomes by ID so we get
                                                                                         // the BOP version
    ...
    public void generate(Random rand, int chunkX, int chunkZ, World world, IChunkProvider chunkGenerator,
        ...
        if (!isFlatWorld(chunkGenerator) || world.getWorldInfo()
            ...
            if (amethystGen != null
                && ArrayUtils.contains(ConfigWorld.amethystDimensionBlacklist, world.provider.dimensionId)
                    == ConfigWorld.amethystDimensionBlacklistAsWhitelist) {
                ...
                if (ConfigWorld.amethystRarity == 1 || rand.nextInt(ConfigWorld.amethystRarity) == 0) {
                    amethystGen.generate(
                        world,
                        rand,
                        x,
                        MathHelper.getRandomIntegerInRange(rand, 5, ConfigWorld.amethystMaxY - 5),
                        z);
                }
            }
            ...
            if (ConfigWorld.enableExtraMesaGold) {
                if (ArrayUtils.contains(
                    BiomeDictionary.getTypesForBiome(world.getBiomeGenForCoords(chunkX << 4, chunkZ << 4)),
                    Type.MESA)) {
            ...
            if (cherryTreeGen != null) {
                ...
                if (y > 0 && block
                    .canSustainPlant(world, x, y - 1, z, ForgeDirection.UP, (IPlantable) ModBlocks.SAPLING.get())) {
            ...
            if (fossilGen != null && rand.nextInt(64) == 0
                && ArrayUtils.contains(ConfigWorld.fossilDimensionBlacklist, world.provider.dimensionId)
                    == ConfigWorld.fossilDimensionBlacklistAsWhitelist) {
                x = (chunkX << 4) + rand.nextInt(16) + 8;
                z = (chunkZ << 4) + rand.nextInt(16) + 8;
            ...
            if (ConfigWorld.enableOceanMonuments && ModBlocks.PRISMARINE_BLOCK.isEnabled()
                && ModBlocks.SEA_LANTERN.isEnabled()
                ...
                if (OceanMonument.canSpawnAt(world, chunkX, chunkZ)) {
                    ...
                    z = (chunkZ << 4) + rand.nextInt(16) + 8;
                    int y;
                    for (y = world.getActualHeight(); y > 0; y--) if (!world.isAirBlock(x, y, z)) break;
        ...
        if (world.provider instanceof WorldProviderHell) {
            ...
            // this.generateOre(ModBlocks.blackstone, 0, world, rand, chunkX, chunkZ, 1,
            // ConfigurationHandler.maxBlackstonePerCluster, 2, 5, 28, Blocks.netherrack);
        ...
        if (ModBlocks.CHORUS_PLANT.isEnabled() && ModBlocks.CHORUS_FLOWER.isEnabled()
            && !(world.provider instanceof WorldProviderEFREnd)
            && world.provider instanceof WorldProviderEnd) {
    ...
    public void generateSingleOre(Block block, int meta, World world, Random random, int chunkX, int chunkZ,
        float chance, int minY, int maxY, Block generateIn) {
        ...
        for (int i = 0; i < (chance < 1 ? 1 : chance); i++) {
            if (chance > 1 || random.nextFloat() < chance) {
                ...
                if (world.getBlock(xRand, yRand, zRand)
                    .isReplaceableOreGen(world, xRand, yRand, zRand, generateIn))
