...
public enum ModItems {
    ...
    DRAGON_BREATH(ConfigBlocksItems.enableLingeringPotions,
        new BaseItem("dragon_breath").setContainerItem(Items.glass_bottle)
    ...
    RAW_ORE(ConfigBlocksItems.enableRawOres,
        new BaseSubtypesItem("raw_copper", "raw_iron", "raw_gold").setNames("raw_ore")),
    ...
    NETHERITE_HELMET(ConfigBlocksItems.enableNetherite,
        new ItemEFRArmour(ModMaterials.NETHERITE_ARMOUR, 0, ConfigBlocksItems.netheriteHelmetDurability)),
    NETHERITE_CHESTPLATE(ConfigBlocksItems.enableNetherite,
        new ItemEFRArmour(ModMaterials.NETHERITE_ARMOUR, 1, ConfigBlocksItems.netheriteChestplateDurability)),
    NETHERITE_LEGGINGS(ConfigBlocksItems.enableNetherite,
        new ItemEFRArmour(ModMaterials.NETHERITE_ARMOUR, 2, ConfigBlocksItems.netheriteLeggingsDurability)),
    NETHERITE_BOOTS(ConfigBlocksItems.enableNetherite,
        new ItemEFRArmour(ModMaterials.NETHERITE_ARMOUR, 3, ConfigBlocksItems.netheriteBootsDurability)),
    NETHERITE_PICKAXE(ConfigBlocksItems.enableNetherite,
        new ItemEFRPickaxe(ModMaterials.NETHERITE_TOOL, ConfigBlocksItems.netheritePickaxeDurability)),
    NETHERITE_SPADE(ConfigBlocksItems.enableNetherite,
        new ItemEFRSpade(ModMaterials.NETHERITE_TOOL, ConfigBlocksItems.netheriteSpadeDurability)),
    NETHERITE_AXE(ConfigBlocksItems.enableNetherite,
        new ItemEFRAxe(ModMaterials.NETHERITE_TOOL, ConfigBlocksItems.netheriteAxeDurability)),
    NETHERITE_HOE(ConfigBlocksItems.enableNetherite,
        new ItemEFRHoe(ModMaterials.NETHERITE_TOOL, ConfigBlocksItems.netheriteHoeDurability)),
    NETHERITE_SWORD(ConfigBlocksItems.enableNetherite,
        new ItemEFRSword(ModMaterials.NETHERITE_TOOL, ConfigBlocksItems.netheriteSwordDurability)),
    TOTEM_OF_UNDYING(ConfigBlocksItems.enableTotemUndying, new BaseItem("totem_of_undying").setMaxStackSize(1)),
    DYE(ConfigBlocksItems.enableNewDyes,
        new BaseSubtypesItem("white_dye", "blue_dye", "brown_dye", "black_dye").setNames("dye")),
    COPPER_INGOT(ConfigBlocksItems.enableCopper && !ConfigModCompat.disableCopperOreAndIngotOnly,
        new BaseItem("copper_ingot")),
    ...
    SHULKER_BOX_UPGRADE(ModsList.IRON_CHEST.isLoaded() && ConfigModCompat.shulkerBoxesIronChest,
        new ItemShulkerBoxUpgrade()),
    ...
    OAK_BOAT(ConfigBlocksItems.enableNewBoats && !ConfigBlocksItems.replaceOldBoats,
        new ItemNewBoat("minecraft", "oak", () -> Item.getItemFromBlock(Blocks.planks), 0, false, false)),
    OAK_CHEST_BOAT(ConfigBlocksItems.enableNewBoats,
        new ItemNewBoat("minecraft", "oak", () -> Item.getItemFromBlock(Blocks.planks), 0, true, false)),
    SPRUCE_BOAT(ConfigBlocksItems.enableNewBoats,
        new ItemNewBoat("minecraft", "spruce", () -> Item.getItemFromBlock(Blocks.planks), 1, false, false)),
    SPRUCE_CHEST_BOAT(ConfigBlocksItems.enableNewBoats,
        new ItemNewBoat("minecraft", "spruce", () -> Item.getItemFromBlock(Blocks.planks), 1, true, false)),
    BIRCH_BOAT(ConfigBlocksItems.enableNewBoats,
        new ItemNewBoat("minecraft", "birch", () -> Item.getItemFromBlock(Blocks.planks), 2, false, false)),
    BIRCH_CHEST_BOAT(ConfigBlocksItems.enableNewBoats,
        new ItemNewBoat("minecraft", "birch", () -> Item.getItemFromBlock(Blocks.planks), 2, true, false)),
    JUNGLE_BOAT(ConfigBlocksItems.enableNewBoats,
        new ItemNewBoat("minecraft", "jungle", () -> Item.getItemFromBlock(Blocks.planks), 3, false, false)),
    JUNGLE_CHEST_BOAT(ConfigBlocksItems.enableNewBoats,
        new ItemNewBoat("minecraft", "jungle", () -> Item.getItemFromBlock(Blocks.planks), 3, true, false)),
    ACACIA_BOAT(ConfigBlocksItems.enableNewBoats,
        new ItemNewBoat("minecraft", "acacia", () -> Item.getItemFromBlock(Blocks.planks), 4, false, false)),
    ACACIA_CHEST_BOAT(ConfigBlocksItems.enableNewBoats,
        new ItemNewBoat("minecraft", "acacia", () -> Item.getItemFromBlock(Blocks.planks), 4, true, false)),
    DARK_OAK_BOAT(ConfigBlocksItems.enableNewBoats,
        new ItemNewBoat("minecraft", "dark_oak", () -> Item.getItemFromBlock(Blocks.planks), 5, false, false)),
    DARK_OAK_CHEST_BOAT(ConfigBlocksItems.enableNewBoats,
        new ItemNewBoat("minecraft", "dark_oak", () -> Item.getItemFromBlock(Blocks.planks), 5, true, false)),
    MANGROVE_OAK_BOAT(ConfigBlocksItems.enableNewBoats && ConfigExperiments.enableMangroveBlocks,
        new ItemNewBoat("minecraft", "mangrove", ModBlocks.WOOD_PLANKS::getItem, 2, false, false)),
    MANGROVE_CHEST_BOAT(ConfigBlocksItems.enableNewBoats && ConfigExperiments.enableMangroveBlocks,
        new ItemNewBoat("minecraft", "mangrove", ModBlocks.WOOD_PLANKS::getItem, 2, true, false)),
    CHERRY_BOAT(ConfigBlocksItems.enableNewBoats && ConfigBlocksItems.enableCherryBlocks,
        new ItemNewBoat("minecraft", "cherry", ModBlocks.WOOD_PLANKS::getItem, 3, false, false)),
    CHERRY_CHEST_BOAT(ConfigBlocksItems.enableNewBoats && ConfigBlocksItems.enableCherryBlocks,
        new ItemNewBoat("minecraft", "cherry", ModBlocks.WOOD_PLANKS::getItem, 3, true, false)),
    BAMBOO_RAFT(ConfigBlocksItems.enableNewBoats,
        new ItemNewBoat("minecraft", "bamboo", ModBlocks.WOOD_PLANKS::getItem, 4, false, true)),
    BAMBOO_CHEST_RAFT(ConfigBlocksItems.enableNewBoats,
        new ItemNewBoat("minecraft", "bamboo", ModBlocks.WOOD_PLANKS::getItem, 4, true, true)),

    // legacy sign items -- new signs use their ItemBlock as the sign item instead
    ITEM_SIGN_SPRUCE(ConfigBlocksItems.enableVanillaSigns,
        new ItemWoodSign((BlockWoodSign) ModBlocks.SIGN_SPRUCE.get())),
    ITEM_SIGN_BIRCH(ConfigBlocksItems.enableVanillaSigns, new ItemWoodSign((BlockWoodSign) ModBlocks.SIGN_BIRCH.get())),
    ITEM_SIGN_JUNGLE(ConfigBlocksItems.enableVanillaSigns,
        new ItemWoodSign((BlockWoodSign) ModBlocks.SIGN_JUNGLE.get())),
    ITEM_SIGN_ACACIA(ConfigBlocksItems.enableVanillaSigns,
        new ItemWoodSign((BlockWoodSign) ModBlocks.SIGN_ACACIA.get())),
    ITEM_SIGN_DARK_OAK(ConfigBlocksItems.enableVanillaSigns,
        new ItemWoodSign((BlockWoodSign) ModBlocks.SIGN_DARK_OAK.get())),

    // Mod Support
    MODDED_RAW_ORE(Utils.enableModdedRawOres(),
        new ItemGeneralModdedRawOre(
            "raw_aluminum",
            "raw_tin",
            "raw_silver",
            "raw_lead",
    ...
    public static final ModItems[] CHEST_BOATS = new ModItems[] { OAK_CHEST_BOAT, SPRUCE_CHEST_BOAT, BIRCH_CHEST_BOAT,
        JUNGLE_CHEST_BOAT, ACACIA_CHEST_BOAT, DARK_OAK_CHEST_BOAT };
    public static final ModItems[] BOATS = new ModItems[] { OAK_BOAT, SPRUCE_BOAT, BIRCH_BOAT, JUNGLE_BOAT, ACACIA_BOAT,
        DARK_OAK_BOAT };
    public static final ModItems[] OLD_SIGN_ITEMS = new ModItems[] { ITEM_SIGN_SPRUCE, ITEM_SIGN_BIRCH,
        ITEM_SIGN_JUNGLE, ITEM_SIGN_ACACIA, ITEM_SIGN_DARK_OAK };
