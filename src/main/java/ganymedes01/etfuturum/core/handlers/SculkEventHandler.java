...
public class SculkEventHandler {
    ...
    private final Method getXpMethod = ReflectionHelper.findMethod(
    ...
    private TileEntitySculkCatalyst findNearbyCatalyst(Entity entity) {
        ...
        for (TileEntity te : entity.worldObj.loadedTileEntityList) {
            if (!(te instanceof TileEntitySculkCatalyst)) continue;
    ...
    public void onDeath(LivingDeathEvent event) {
        if (event.entityLiving instanceof EntityLiving && !event.entityLiving.worldObj.isRemote
            && getXpMethod != null) {
