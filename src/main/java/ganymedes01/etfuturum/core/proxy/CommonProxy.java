...
public class CommonProxy implements IGuiHandler {
    ...
    public void registerEvents() {
        ...
        if (ModBlocks.SCULK_CATALYST.isEnabled()) {
            FMLCommonHandler.instance()
                .bus()
                .register(SculkEventHandler.INSTANCE);
    ...
    public void registerEntities() {
        ...
        if (ModBlocks.POTION_CAULDRON.isEnabled()) {
            GameRegistry
                .registerTileEntity(TileEntityCauldronPotion.class, Utils.getUnlocalisedName("potion_cauldron"));
        }
        ...
        if (ConfigEntities.enableRabbit) {
            ModEntityList
                .registerEntity(EntityRabbit.class, "rabbit", 3, EtFuturum.instance, 80, 3, true, 0x995F40, 0x734831);
        ...
        if (ConfigBlocksItems.enableArmourStand) {
            ModEntityList
                .registerEntity(EntityArmourStand.class, "wooden_armorstand", 0, EtFuturum.instance, 64, 1, true);
        }
        ...
        if (FMLCommonHandler.instance()
            .getSide() == Side.CLIENT && FMLClientHandler.instance()
                .hasOptifine()) {
            if (!ConfigWorld.oldHuskSpawning) {
                Logger.warn(
                    "OptiFine detected, old husk spawn logic will be enabled since OptiFine is stupid and breaks the default behavior.");
                ConfigWorld.oldHuskSpawning = true;
            }
            if (!ConfigWorld.oldStraySpawning) {
                Logger.warn(
                    "OptiFine detected, old stray spawn logic will be enabled since OptiFine is stupid and breaks the default behavior.");
        ...
        if (ConfigEntities.enableHusk) {
            ModEntityList
                .registerEntity(EntityHusk.class, "husk", 4, EtFuturum.instance, 80, 3, true, 0x777561, 0xE0D991);

            if (ConfigWorld.oldHuskSpawning) {
                List<BiomeGenBase> biomes = new ArrayList<>(
                    Arrays.asList(BiomeDictionary.getBiomesForType(Type.SANDY)));
        ...
        if (ConfigEntities.enableStray) {
            ModEntityList
                .registerEntity(EntityStray.class, "stray", 5, EtFuturum.instance, 80, 3, true, 0x617778, 0xE6EAEA);
        ...
        if (ConfigBlocksItems.enableLingeringPotions) {
            ModEntityList
                .registerEntity(EntityLingeringPotion.class, "lingering_potion", 6, EtFuturum.instance, 64, 10, true);
            ModEntityList
                .registerEntity(EntityLingeringEffect.class, "lingering_effect", 7, EtFuturum.instance, 64, 1, true);
        }

        if (ConfigEntities.enableVillagerZombies) ModEntityList.registerEntity(
        ...
        if (ConfigEntities.enableDragonRespawn) {
            ModEntityList.registerEntity(
                ...
                false);
            ModEntityList
                .registerEntity(EntityRespawnedDragon.class, "ender_dragon", 10, EtFuturum.instance, 160, 3, true);
        }
        ...
        if (ConfigEntities.enableBrownMooshroom) ModEntityList
            .registerEntity(EntityBrownMooshroom.class, "brown_mooshroom", 12, EtFuturum.instance, 80, 3, true);

        ModEntityList
            .registerEntity(EntityItemUninflammable.class, "fireproof_item", 15, EtFuturum.instance, 64, 1, true);
        ...
        if (ConfigEntities.enableShulker) {
            ModEntityList.registerEntity(
                ...
                0x4D3852);
            ModEntityList
                .registerEntity(EntityShulkerBullet.class, "shulker_candy", 17, EtFuturum.instance, 64, 1, true);
        ...
        // {
        // ModEntityList.registerEntity(EntityFallingDripstone.class, "falling_dripstone", 18, EtFuturum.instance, 64,
        // 1, true);
        // }
        ...
        if (ConfigBlocksItems.enableNewBoats) {
            ...
            ModEntityList
                .registerEntity(EntityNewBoatWithChest.class, "chest_boat", 19, EtFuturum.instance, 64, 1, true);
            ModEntityList
                .registerEntity(EntityNewBoatSeat.class, "new_boat_seat", 14, EtFuturum.instance, 64, 1, false);
        }

        if (ConfigMixins.enableElytra) {
            ModEntityList.registerEntity(
                EntityBoostingFireworkRocket.class,
                "boosting_firework_rocket",
                20,
                EtFuturum.instance,
                64,
                1,
        ...
        if (ConfigEntities.enableBees) {
            ModEntityList
                .registerEntity(EntityBee.class, "bee", 21, EtFuturum.instance, 80, 1, true, 0xEDC343, 0x43241B);
        }

        if (ConfigEntities.enableFoxes) {
            ModEntityList
                .registerEntity(EntityFox.class, "fox", 22, EtFuturum.instance, 64, 1, true, 0xD5B69F, 0xCC6920);
            EntityRegistry.addSpawn(
                EntityFox.class,
                8,
                2,
    ...
    public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
        return switch (ID) {
            ...
            case GUIIDs.BREWING_STAND -> new ContainerNewBrewingStand(
                player.inventory,
                (TileEntityNewBrewingStand) world.getTileEntity(x, y, z));
            case GUIIDs.BARREL -> new ContainerChestGeneric(
                player.inventory,
                (TileEntityBarrel) world.getTileEntity(x, y, z),
                ((TileEntityBarrel) world.getTileEntity(x, y, z)).getRowSize(),
                ((TileEntityBarrel) world.getTileEntity(x, y, z)).getSizeInventory() != 27);
            case GUIIDs.SMOKER -> new ContainerSmoker(
                player.inventory,
                (TileEntitySmoker) world.getTileEntity(x, y, z));
            case GUIIDs.BLAST_FURNACE -> new ContainerBlastFurnace(
                player.inventory,
                (TileEntityBlastFurnace) world.getTileEntity(x, y, z));
            case GUIIDs.SHULKER_BOX -> new ContainerChestGeneric(
                player.inventory,
                (TileEntityShulkerBox) world.getTileEntity(x, y, z),
                ((TileEntityShulkerBox) world.getTileEntity(x, y, z)).getRowSize(),
                ((TileEntityShulkerBox) world.getTileEntity(x, y, z)).getSizeInventory() != 27);
    ...
    public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
        return switch (ID) {
            ...
            case GUIIDs.BREWING_STAND -> new GuiNewBrewingStand(
                player.inventory,
                (TileEntityNewBrewingStand) world.getTileEntity(x, y, z));
            ...
            case GUIIDs.BLAST_FURNACE -> new GuiBlastFurnace(
                player.inventory,
                (TileEntityBlastFurnace) world.getTileEntity(x, y, z));
            case GUIIDs.SHULKER_BOX -> new GuiShulkerBox(
                player.inventory,
                (TileEntityShulkerBox) world.getTileEntity(x, y, z));
