...
public class ClientProxy extends CommonProxy {
    ...
    private void registerItemRenderers() {
        MinecraftForgeClient
            .registerItemRenderer(Item.getItemFromBlock(ModBlocks.BANNER.get()), new ItemBannerRenderer());
        ...
        MinecraftForgeClient
            .registerItemRenderer(Item.getItemFromBlock(ModBlocks.SHULKER_BOX.get()), new ItemShulkerBoxRenderer());
        if (ConfigFunctions.inventoryBedModels) {
            ...
            for (ModBlocks bed : ModBlocks.BEDS) {
                if (bed.isEnabled()) {
                    MinecraftForgeClient
                        .registerItemRenderer(bed.getItem(), new Item3DBedRenderer((BlockBed) bed.get()));
                }
            }
        }
    }
    ...
    private void registerBlockRenderers() {
        ...
        ClientRegistry.bindTileEntitySpecialRenderer(
            ...
            new TileEntityShulkerBoxRenderer(new ModelShulker()));
    ...
    private void registerEntityRenderers() {
        ...
        // {
        // RenderingRegistry.registerEntityRenderingHandler(EntityFallingDripstone.class, new
        ...
        if (ConfigFunctions.enablePlayerSkinOverlay) {
            ...
            Minecraft.getMinecraft().field_152350_aA/* skinManager */ = new NewSkinManager(
