...
public class CustomParticles {
    ...
    public static EntityFX spawnDrippingParticleWithSound(World world, double x, double y, double z, String sound,
        int color) {
        return spawnDrippingParticleWithSound(world, x, y, z, sound, color, false);
    }

    public static EntityFX spawnDrippingParticleWithSound(World world, double x, double y, double z, String sound,
        int color, boolean splashes) {
    ...
    public static EntityFX spawnAshParticle(World world, double x, double y, double z) {
        ...
        EntityFX particle = new BiomeFX(
            ...
            d1,
            d2,
            (float) MathHelper.getRandomDoubleInRange(rand, 0.001D, 0.02D));
