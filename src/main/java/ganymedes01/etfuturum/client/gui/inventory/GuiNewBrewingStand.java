...
public class GuiNewBrewingStand extends GuiContainer {
    ...
    private static final ResourceLocation TEXTURE = Utils
        .getResource(Reference.MOD_ID + ":textures/gui/container/brewing_stand.png");
    ...
    protected void drawGuiContainerBackgroundLayer(float f0, int x, int y) {
        ...
        if (i1 > 0) {
            ...
            if (j1 > 0) drawTexturedModalRect(k + 97, l + 16, 176, 0, 9, j1);
            ...
            if (j1 > 0) drawTexturedModalRect(k + 63, l + 14 + 29 - j1, 185, 29 - j1, 12, j1);
        }
