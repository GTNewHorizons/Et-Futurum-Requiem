    ...
    private static class BuiltInFolderResourcePack extends BuiltInResourcePack {
        ...
        protected InputStream getInputStreamByName(String name) throws IOException {
            if (name.endsWith("lang")) {
                ...
                // Reads the lang file, strips unneeded lines and adds it to a list to be compared against the ignore
                // list
                String currentLine;
                ...
                for (String line : langFile) {
                    baos.write((line + "\n").getBytes()); // Add a new line since otherwise the byte array output stream
                                                          // will not have any line breaks and everything goes into the
                                                          // first key
                }
