...
public class ModSounds {
    ...
    public static final SoundType soundLantern = new CustomSound("lantern", true)
        .setDisabledSound(Block.soundTypeMetal);
    ...
    public static final SoundType soundCopperGrate = new CustomSound("copper_grate")
        .setDisabledSound(Block.soundTypeMetal);
    public static final SoundType soundCopperBulb = new CustomSound("copper_bulb", true)
        .setDisabledSound(Block.soundTypeMetal);
    ...
    public static final SoundType soundNetherSprouts = new CustomSound("nether_sprouts")
        .setDisabledSound(Block.soundTypeGrass);
    ...
    public static final SoundType soundWeepingVines = new CustomSound("weeping_vines")
        .setDisabledSound(Block.soundTypeGrass);
    ...
    public static final SoundType soundMangroveRoots = new CustomSound("mangrove_roots")
        .setDisabledSound(Block.soundTypeGrass);
    public static final SoundType soundMuddyMangroveRoots = new CustomSound("muddy_mangrove_roots")
        .setDisabledSound(Block.soundTypeGravel);
    ...
    public static final SoundType soundCherryWood = new CustomSound("cherry_wood")
        .setDisabledSound(Block.soundTypeWood);
    public static final SoundType soundPinkPetals = new CustomSound("pink_petals")
        .setDisabledSound(Block.soundTypeGrass);
    public static final SoundType soundBamboo = new CustomSound("bamboo").setDisabledSound(Block.soundTypeGrass);
    public static final SoundType soundBambooWood = new CustomSound("bamboo_wood")
        .setDisabledSound(Block.soundTypeWood);
