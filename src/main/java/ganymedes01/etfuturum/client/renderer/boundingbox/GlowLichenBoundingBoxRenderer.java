...
public class GlowLichenBoundingBoxRenderer {
    ...
    // This is all hard coded. If someone wants to figure out an efficient way to do this for an arbitrary shape that
    // would be nice,
    // that was too much work for this and I just was able to code this up in like 2 hours rather than figuring out how
    // to do
    // it in all cases. Vanilla does it in a pretty complex way, but I'm sure it's possible to reverse engineer.
    public void render(TileEntityGlowLichen te, int x, int y, int z, EntityPlayer player, float partialTicks) {
                ...
                switch (ForgeDirection.getOrientation(i)) {
                    case DOWN:
                        ...
                        tessellator.addVertex(
                            renderX - boundingBoxOffset,
                            renderY - boundingBoxOffset,
                            renderZ - boundingBoxOffset);
                        tessellator.addVertex(
                            renderX - boundingBoxOffset,
                            renderY - boundingBoxOffset,
                            renderZ + 1.0D + boundingBoxOffset);
                        tessellator.addVertex(
                            renderX + 1.0D + boundingBoxOffset,
                            renderY - boundingBoxOffset,
                            renderZ + 1.0D + boundingBoxOffset);
                        tessellator.addVertex(
                            renderX + 1.0D + boundingBoxOffset,
                        ...
                        switch ((sideGrowth & 0b111100) >> 2) {
                            case 0: // (nothing)
                                ...
                                tessellator.addVertex(
                                    renderX - boundingBoxOffset,
                                    renderY + 0.0625D - boundingBoxOffset,
                                    renderZ - boundingBoxOffset);
                                tessellator.addVertex(
                                    renderX - boundingBoxOffset,
                                    renderY + 0.0625D - boundingBoxOffset,
                            ...
                            case 1: // (north)
                                ...
                                tessellator.addVertex(
                                    renderX - boundingBoxOffset,
                                    renderY + 0.0625D - boundingBoxOffset,
                                    renderZ + 0.0625D - boundingBoxOffset);
                                tessellator.addVertex(
                                    renderX - boundingBoxOffset,
                                    renderY + 0.0625D - boundingBoxOffset,
                                    renderZ + 1.0D + boundingBoxOffset);
                            ...
                            case 2: // (south)
                                ...
                                tessellator.addVertex(
                                    renderX - boundingBoxOffset,
                                    renderY + 0.0625D - boundingBoxOffset,
                                    renderZ + 0.9375D + boundingBoxOffset);
                                tessellator.addVertex(
                                    renderX + 1.0D + boundingBoxOffset,
                                    renderY + 0.0625D - boundingBoxOffset,
                                    renderZ + 0.9375D + boundingBoxOffset);
                            ...
                            case 4: // (west)
                                tessellator.startDrawing(3);
                                tessellator.addVertex(
                                    renderX + 0.0625D - boundingBoxOffset,
                                    renderY + 0.0625D - boundingBoxOffset,
                                    renderZ - boundingBoxOffset);
                                tessellator.addVertex(
                                    renderX + 0.0625D - boundingBoxOffset,
                            ...
                            case 8: // (east)
                                ...
                                tessellator.addVertex(
                                    ...
                                    renderZ + 1.0D + boundingBoxOffset);
                                tessellator.addVertex(
                                    renderX + 0.9375D + boundingBoxOffset,
                                    renderY + 0.0625D - boundingBoxOffset,
                                    renderZ + 1.0D + boundingBoxOffset);
                                tessellator.addVertex(
                                    renderX + 0.9375D + boundingBoxOffset,
                    ...
                    case UP:
                        ...
                        tessellator.addVertex(
                            renderX - boundingBoxOffset,
                            renderY + 1.0D + boundingBoxOffset,
                            renderZ - boundingBoxOffset);
                        tessellator.addVertex(
                            renderX - boundingBoxOffset,
                            renderY + 1.0D + boundingBoxOffset,
                        ...
                        switch ((sideGrowth & 0b111100) >> 2) {
                            case 0:
                                ...
                                tessellator.addVertex(
                                    renderX - boundingBoxOffset,
                                    renderY + 0.9375D + boundingBoxOffset,
                                    renderZ - boundingBoxOffset);
                                tessellator.addVertex(
                                    renderX - boundingBoxOffset,
                                    renderY + 0.9375D + boundingBoxOffset,
