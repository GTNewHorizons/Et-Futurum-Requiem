...
public class TileEntityFancySkullRenderer extends TileEntitySpecialRenderer {
    ...
    private static final ResourceLocation wither_skeleton_texture = Utils
        .getResource("textures/entity/skeleton/wither_skeleton.png");
    ...
    public void renderSkull(float x, float y, float z, int meta, float rotation, int type, GameProfile profile) {
        ...
        switch (type) {
            ...
            case 3:
                ...
                if (profile != null) {
                    ...
                    Map<Type, MinecraftProfileTexture> map = minecraft.func_152342_ad/* getSkinManager */()
                        .func_152788_a/* loadSkinFromCache */(profile);
                    if (map.containsKey(Type.SKIN)) texture = minecraft.func_152342_ad/* getSkinManager */()
                        .func_152792_a/* loadSkin */(map.get(Type.SKIN), Type.SKIN);
                }
                bindTexture(texture);
                break;
            case 4:
        ...
        else GL11.glTranslatef(x + 0.5F, y, z + 0.5F);
    ...
    public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float partialTick) {
        ...
        renderSkull(
            ...
            (float) y,
            (float) z,
            tile.getBlockMetadata() & 7,
            skull.func_145906_b()/* getSkullRotation */ * 360 / 16.0F,
            skull.func_145904_a()/* getSkullType */,
            skull.func_152108_a());
    }
}
