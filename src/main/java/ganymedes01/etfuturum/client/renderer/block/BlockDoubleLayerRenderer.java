...
public class BlockDoubleLayerRenderer extends BlockModelBase {
    ...
    protected void renderInventoryModel(Block block, int meta, int modelId, RenderBlocks renderer, double minX,
        ...
        renderStandardInventoryCubeOrSecondLayer(
            block,
            meta,
            modelId,
            renderer,
    ...
    protected void renderStandardInventoryCubeOrSecondLayer(Block block, int meta, int modelId, RenderBlocks renderer,
        boolean secondLayer, double minX, double minY, double minZ, double maxX, double maxY, double maxZ) {
        final Tessellator tessellator = Tessellator.instance;
        renderer.setRenderBounds(minX, minY, minZ, maxX, maxY, maxZ);
        tessellator.setNormal(0.0F, -1.0F, 0.0F);
        renderer
            .renderFaceYNeg(block, 0.0D, 0.0D, 0.0D, getIconOrSecondLayerIcon(block, renderer, 0, meta, secondLayer));
        tessellator.setNormal(0.0F, 1.0F, 0.0F);
        renderer
            .renderFaceYPos(block, 0.0D, 0.0D, 0.0D, getIconOrSecondLayerIcon(block, renderer, 1, meta, secondLayer));
        tessellator.setNormal(0.0F, 0.0F, -1.0F);
        renderer
            .renderFaceZNeg(block, 0.0D, 0.0D, 0.0D, getIconOrSecondLayerIcon(block, renderer, 2, meta, secondLayer));
        tessellator.setNormal(0.0F, 0.0F, 1.0F);
        renderer
            .renderFaceZPos(block, 0.0D, 0.0D, 0.0D, getIconOrSecondLayerIcon(block, renderer, 3, meta, secondLayer));
        tessellator.setNormal(-1.0F, 0.0F, 0.0F);
        renderer
            .renderFaceXNeg(block, 0.0D, 0.0D, 0.0D, getIconOrSecondLayerIcon(block, renderer, 4, meta, secondLayer));
        tessellator.setNormal(1.0F, 0.0F, 0.0F);
        renderer
            .renderFaceXPos(block, 0.0D, 0.0D, 0.0D, getIconOrSecondLayerIcon(block, renderer, 5, meta, secondLayer));
    }
    ...
    protected boolean renderStandardWorldCubeWithEmissiveness(IBlockAccess world, int x, int y, int z, Block block,
        int modelId, RenderBlocks renderer, boolean secondLayer, double minX, double minY, double minZ, double maxF,
    ...
    private IIcon getIconOrSecondLayerIcon(Block block, RenderBlocks renderer, int side, int meta,
        boolean secondLayer) {
        return secondLayer ? ((IEmissiveLayerBlock) block).getSecondLayerIcon(side, meta)
