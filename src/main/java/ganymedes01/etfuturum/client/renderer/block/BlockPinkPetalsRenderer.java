...
public class BlockPinkPetalsRenderer extends BlockModelBase {
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId,
        ...
        int m = world.getBiomeGenForCoords(x, z)
    ...
    private void setBoundsWithRotation(RenderBlocks renderer, double minX, double minZ, double maxX, double maxZ,
        double y, int rotation) {
        switch (rotation) {
            case 0:
    ...
    private void renderStem(Block block, RenderBlocks renderer, int meta, int x, int y, int z, float xoff, float zoff,
        float brightnessOffset1, float brightnessOffset2, int height, float r, float g, float b, int rotation) {
