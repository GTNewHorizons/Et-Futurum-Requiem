...
public class BlockBambooRenderer extends BlockModelBase {
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId,
        ...
        // Stalk stem
        renderer
            .setRenderBounds(textureOffset, 0, textureOffset, stemSize + textureOffset, 1, stemSize + textureOffset);
        ...
        if (leavesSize > 0 && leavesSize < 3) {
            ...
            drawStraightCrossedSquares(
                renderer,
                block,
                x,
                y,
                z,
                offsetX - 0.5F + sizeOffset,
                0,
                offsetZ - 0.5F + sizeOffset);
