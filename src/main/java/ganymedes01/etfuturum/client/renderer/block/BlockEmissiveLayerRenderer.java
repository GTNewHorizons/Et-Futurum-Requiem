...
public class BlockEmissiveLayerRenderer extends BlockModelBase {
    ...
    @Override
    protected void renderInventoryModel(Block block, int meta, int modelId, RenderBlocks renderer, double minX,
        double minY, double minZ, double maxX, double maxY, double maxZ) {
        if (!(block instanceof IEmissiveLayerBlock)) {
            throw new IllegalArgumentException(
                "Block using emissive layer renderer must implement IEmissiveLayerBlock!");
        }
        ...
        renderStandardInventoryCubeEmissive(
            block,
            meta,
            modelId,
            renderer,
    ...
    protected void renderStandardInventoryCubeEmissive(Block block, int meta, int modelId, RenderBlocks renderer,
        boolean emissive, double minX, double minY, double minZ, double maxX, double maxY, double maxZ) {
        ...
        renderer
            .renderFaceYNeg(block, 0.0D, 0.0D, 0.0D, getIconOrEmissiveLayerIcon(block, renderer, 0, meta, emissive));
        tessellator.setNormal(0.0F, 1.0F, 0.0F);
        renderer
            .renderFaceYPos(block, 0.0D, 0.0D, 0.0D, getIconOrEmissiveLayerIcon(block, renderer, 1, meta, emissive));
        tessellator.setNormal(0.0F, 0.0F, -1.0F);
        renderer
            .renderFaceZNeg(block, 0.0D, 0.0D, 0.0D, getIconOrEmissiveLayerIcon(block, renderer, 2, meta, emissive));
        tessellator.setNormal(0.0F, 0.0F, 1.0F);
        renderer
            .renderFaceZPos(block, 0.0D, 0.0D, 0.0D, getIconOrEmissiveLayerIcon(block, renderer, 3, meta, emissive));
        tessellator.setNormal(-1.0F, 0.0F, 0.0F);
        renderer
            .renderFaceXNeg(block, 0.0D, 0.0D, 0.0D, getIconOrEmissiveLayerIcon(block, renderer, 4, meta, emissive));
        tessellator.setNormal(1.0F, 0.0F, 0.0F);
        renderer
            .renderFaceXPos(block, 0.0D, 0.0D, 0.0D, getIconOrEmissiveLayerIcon(block, renderer, 5, meta, emissive));
        tessellator.draw();
        tessellator.startDrawingQuads();
        if (emissive) {
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId,
        ...
        return renderStandardWorldCubeWithEmissiveness(
            world,
            x,
            y,
            z,
    ...
    protected boolean renderStandardWorldCubeWithEmissiveness(IBlockAccess world, int x, int y, int z, Block block,
        int modelId, RenderBlocks renderer, boolean emissive, double minX, double minY, double minZ, double maxF,
        ...
        if (!emissive) {
            return super.renderStandardWorldCube(
                world,
                x,
                y,
                z,
        ...
        renderFaceYNeg(
            ...
            y,
            z,
            ((IEmissiveLayerBlock) block).getEmissiveMinBrightness(world, x, y, z),
            getIconOrEmissiveLayerIcon(block, renderer, 0, meta, true),
            meta);
        renderFaceYPos(
            renderer,
            block,
            ...
            z,
            ((IEmissiveLayerBlock) block).getEmissiveMinBrightness(world, x, y, z),
            getIconOrEmissiveLayerIcon(block, renderer, 1, meta, true),
            meta);
        renderFaceZNeg(
            renderer,
            block,
            ...
            z,
            ((IEmissiveLayerBlock) block).getEmissiveMinBrightness(world, x, y, z),
            getIconOrEmissiveLayerIcon(block, renderer, 2, meta, true),
            meta);
        renderFaceZPos(
            renderer,
            block,
            ...
            z,
            ((IEmissiveLayerBlock) block).getEmissiveMinBrightness(world, x, y, z),
            getIconOrEmissiveLayerIcon(block, renderer, 3, meta, true),
            meta);
        renderFaceXNeg(
            renderer,
            block,
            ...
            z,
            ((IEmissiveLayerBlock) block).getEmissiveMinBrightness(world, x, y, z),
            getIconOrEmissiveLayerIcon(block, renderer, 4, meta, true),
            meta);
        renderFaceXPos(
            renderer,
            block,
            ...
            z,
            ((IEmissiveLayerBlock) block).getEmissiveMinBrightness(world, x, y, z),
            getIconOrEmissiveLayerIcon(block, renderer, 5, meta, true),
            meta);
        return true;
    }
     ...
     */
    private void renderFaceYNeg(RenderBlocks renderer, Block block, double dx, double dy, double dz, int minBrightness,
        IIcon icon, int meta) {
        final Tessellator tessellator = Tessellator.instance;
            ...
            tessellator.setBrightness(
                floorMixedBrightness(
                    ...
                    renderer.renderMinY > 0.0D ? l
                        : block
                            .getMixedBrightnessForBlock(renderer.blockAccess, x, MathHelper.floor_double(y - 1), z)));
     ...
     */
    private void renderFaceYPos(RenderBlocks renderer, Block block, double dx, double dy, double dz, int minBrightness,
        IIcon icon, int meta) {
        final Tessellator tessellator = Tessellator.instance;
        renderer.enableAO = false;
     ...
     */
    private void renderFaceZNeg(RenderBlocks renderer, Block block, double dx, double dy, double dz, int minBrightness,
        IIcon icon, int meta) {
        final Tessellator tessellator = Tessellator.instance;
        renderer.enableAO = false;
     ...
     */
    private void renderFaceZPos(RenderBlocks renderer, Block block, double dx, double dy, double dz, int minBrightness,
        IIcon icon, int meta) {
        final Tessellator tessellator = Tessellator.instance;
        renderer.enableAO = false;
     ...
     */
    private void renderFaceXNeg(RenderBlocks renderer, Block block, double dx, double dy, double dz, int minBrightness,
        IIcon icon, int meta) {
        final Tessellator tessellator = Tessellator.instance;
        renderer.enableAO = false;
     ...
     */
    private void renderFaceXPos(RenderBlocks renderer, Block block, double dx, double dy, double dz, int minBrightness,
        IIcon icon, int meta) {
        final Tessellator tessellator = Tessellator.instance;
        renderer.enableAO = false;
    ...
    private IIcon getIconOrEmissiveLayerIcon(Block block, RenderBlocks renderer, int side, int meta, boolean emissive) {
        return emissive ? ((IEmissiveLayerBlock) block).getSecondLayerIcon(side, meta)
            : renderer.getBlockIconFromSideAndMetadata(block, side, meta);
    }
}
