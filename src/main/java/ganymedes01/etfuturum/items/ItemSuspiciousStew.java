        ...
        if (hasPotion(stack) && player != null) {
            ...
            if (nbtBase.hasKey(effectsList)) {
                ...
                for (int i = 0; i < list.tagCount(); i++) {
                    ...
                    if (!nbt.hasKey(stewEffect) || nbt.getInteger(stewEffect) <= 0
                        || nbt.getInteger(stewEffect) >= Potion.potionTypes.length
                        || Potion.potionTypes[nbt.getInteger(stewEffect)] == null) continue;
                    ...
                    player.addPotionEffect(
                        new PotionEffect(nbt.getByte(stewEffect), effectDuration, nbt.getByte(stewEffectLevel)));
                }
            }
        }
    }
