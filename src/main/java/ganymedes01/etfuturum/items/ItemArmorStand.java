...
public class ItemArmorStand extends BaseItem {
    ...
    public boolean onItemUse(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int side,
        ...
        boolean flag1 = !world.isAirBlock(x, y, z) && !world.getBlock(x, y, z)
            .isReplaceable(world, x, y, z);
        flag1 |= !world.isAirBlock(x, y + 1, z) && !world.getBlock(x, y + 1, z)
        ...
        List<Entity> list = world.getEntitiesWithinAABBExcludingEntity(
            null,
            AxisAlignedBB.getBoundingBox(d0, d1, d2, d0 + 1.0D, d1 + 2.0D, d2 + 1.0D));
        ...
        if (!world.isRemote) {
            ...
            float f3 = MathHelper
                .floor_float((MathHelper.wrapAngleTo180_float(player.rotationYaw - 180.0F) + 22.5F) / 45.0F) * 45.0F;
    ...
    public void merge(NBTTagCompound nbt, NBTTagCompound other) {
        Iterator<String> iterator = other.func_150296_c()
            .iterator(); // getKeySet
        ...
        while (iterator.hasNext()) {
            ...
            if (nbtbase.getId() == 10) {
                ...
                } else nbt.setTag(s, nbtbase.copy());
            } else nbt.setTag(s, nbtbase.copy());
        }
    }
}
