...
public class ConfigMixins extends ConfigBase {
  ...
  public static boolean enableJumpClimbing;
	...
	protected void syncConfigOptions() {
		...
		editableSigns = getBoolean("editableSigns", catBackport, true, "Allows vanilla oak signs to open the sign editor on right-click.\nModified Classes: net.minecraft.block.BlockSign");
