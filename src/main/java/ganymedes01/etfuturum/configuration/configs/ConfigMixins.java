...
public class ConfigMixins extends ConfigBase {
    ...
    protected void syncConfigOptions() {
        if (EtFuturumEarlyMixins.side == MixinEnvironment.Side.CLIENT) {
            ...
            adjustedAttenuation = getBoolean(
                "adjustedAttenuation",
                catBackport,
                true,
        ...
        fenceWallConnectFix = getBoolean(
            "fenceWallConnectFix",
            catBackport,
            true,
        ...
        avoidDroppingItemsWhenClosing = getBoolean(
            "avoidDroppingItemsWhenClosing",
            catBackport,
            false,
        ...
        enableSpectatorMode = getBoolean(
            "enableSpectatorMode",
            catBackport,
            true,
        ...
        enableObservers = getBoolean(
            "enableObservers",
            catBackport,
            true,
            "Modified Classes: net.minecraft.world.World net.minecraft.world.WorldServer");
        blockHopperInteraction = getBoolean(
            "blockHopperInteraction",
            catBackport,
            true,
        ...
        enableNewElytraTakeoffLogic = getBoolean(
            "enableNewElytraTakeoffLogic",
            catBackport,
            true,
            "When enabled, the 1.15+ elytra takeoff logic is used, when disabled, the 1.9-1.14 elytra takeoff logic is used.");
        enableDoWeatherCycle = getBoolean(
            "enableDoWeatherCycle",
            catBackport,
            true,
            "Add the doWeatherCycle game rule from 1.11+");
        enableRandomTickSpeed = getBoolean(
            "enableRandomTickSpeed",
            catBackport,
            true,
            "Add the randomTickSpeed game rule from 1.8+");
        creativeFlightSpeedModifier = getFloat(
            "creativeFlightSpeedModifier",
            catBackport,
            2,
            1,
            5,
            "When greater than 1, boosts creative flight speed when sprinting, like in newer versions");
        bouncyBeds = getBoolean(
            "bouncyBeds",
            catBackport,
            true,
        ...
        floorCeilingButtons = getBoolean(
            "floorCeilingButtons",
            catBackport,
            true,
        ...
        newMobSounds = getBoolean(
            "newMobSounds",
            catBackport,
            true,
            "New sounds for the witch, snow golem, squid and wither skeleton.");
        newEnchantingSounds = getBoolean(
            "newEnchantingSounds",
            catBackport,
            true,
        ...
        hoeTilling = getBoolean(
            "hoeTilling",
            catBackport,
            true,
            "Sounds for hoes tilling farmland.\nModified Classes: net.minecraft.item.ItemHoe");
        dustUnderFallingBlocks = getBoolean(
            "dustUnderFallingBlocks",
            catBackport,
            true,
        ...
        fireproofItems = getBoolean(
            "fireproofItems",
            catBackport,
            true,
            "Some items such as Netherite will not burn in fire and will float to the surface of lava.");
        thinPanes = getBoolean(
            "thinPanes",
            catBackport,
            true,
            "Panes [Iron Bars, Glass Panes, etc] are changed to a single post if they are not connected to any other blocks"
                ...
                + "\nModified Client Classes: net.minecraft.client.renderer.RenderBlocks");
        colorGrassBlockItemSides = getBoolean(
            "colorGrassBlockItemSides",
            catBackport,
            true,
            "Grass block sides are colored in the player's inventory"
                + "\nModified Client Classes: net.minecraft.client.renderer.RenderBlocks");

        stepHeightFix = getBoolean(
            "stepHeightFix",
            catFixes,
            true,
        ...
        hideSingleLevelEnchants = getBoolean(
            "hideSingleLevelEnchants",
            catFixes,
            true,
        ...
        enablePlayersSleepingPecentageGamerule = getBoolean(
            "enablePlayersSleepingPecentageGamerule",
            catBackport,
            true,
            "You nappa, you get slappa");
        enableJumpClimbing = getBoolean(
            "enableClimbingPlants",
            catBackport,
            true,
            "Allows players to simply hold jump to climb up climable blocks instead of having to collide with something horizontally.");
    }
}
