...
public class ConfigFunctions extends ConfigBase {
	...
	protected void syncConfigOptions() {
		...
		swimmingDataWatcherFlag = (byte) getInt("swimmingDataWatcherFlag", catSettings, 8, 0, 31, "The data watcher flag for Swimming and Crawling, used to sync the animation with other players. In vanilla the max value is 7, players use 0-4, so you can set this to 6 or 7 by default. ASJCore increases the max value to 31.\n" +
