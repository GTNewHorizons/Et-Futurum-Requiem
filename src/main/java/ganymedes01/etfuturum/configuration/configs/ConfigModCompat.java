...
public class ConfigModCompat extends ConfigBase {
	...
	public static boolean enableChestBarrelConversion;
	...
	protected void syncConfigOptions() {
		...
		enableChestBarrelConversion = getBoolean("enableChestBarrelConversion", catMisc, true, "This option value allows the Storageinator to convert chests into barrels and barrels into chests. This option does nothing if Iron Chests is not installed.");
