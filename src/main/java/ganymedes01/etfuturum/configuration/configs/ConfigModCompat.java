...
public class ConfigModCompat extends ConfigBase {
	...
	protected void syncConfigOptions() {
		...
		enableChestBarrelConversion = getBoolean("enableChestBarrelConversion", catMisc, true, "This option value allows Cooper's Mallet to convert chests into barrels and barrels into chests. This option does nothing if Iron Chests is not installed.");
