...
public class ConfigModCompat extends ConfigBase {
    ...
    protected void syncConfigOptions() {
        shulkerBoxesIronChest = getBoolean(
            "shulkerBoxesIronChest",
            catMisc,
            true,
        ...
        barrelIronChest = getBoolean(
            "barrelIronChest",
            catMisc,
            true,
            "If Iron Chests is installed, allow Iron Barrels to be crafted having all the same tiers as Iron Chests except for crystal. This option does nothing if Iron Chests is not installed.");
        elytraBaublesExpandedCompat = getInt(
            "elytraBaublesExpandedCompat",
            catMisc,
            1,
            0,
            2,
        ...
        moddedRawOres = getBoolean(
            "moddedRawOres",
            catMisc,
            true,
            "Raw ores for modded metals. Adds a set of \"general\" raw ores for common metals like \"oreAluminium\", \"oreTin\", etc.");
        moddedRawOresBlacklist = Lists.newArrayList(
            getStringList(
                "moddedRawOresBlacklist",
                catMisc,
                new String[0],
                """
        ...
        moddedDeepslateOres = getBoolean(
            "moddedDeepslateOres",
            catMisc,
            true,
            "Deepslate ores for modded ores. Adds a set of \"general\" deepslate ores for common metals like \"oreAluminium\", \"oreTin\", etc, as well as explicit support for numerous mods.");
        moddedDeepslateOresBlacklist = Lists.newArrayList(
            getStringList(
                "moddedDeepslateOresBlacklist",
                catMisc,
                new String[0],
                """
        ...
        disableBaseBountifulStonesOnly = getBoolean(
            "disableBaseBountifulStonesOnly",
            catMisc,
            false,
        ...
        disableCopperOreAndIngotOnly = getBoolean(
            "disableCopperOreAndIngotOnly",
            catMisc,
            false,
