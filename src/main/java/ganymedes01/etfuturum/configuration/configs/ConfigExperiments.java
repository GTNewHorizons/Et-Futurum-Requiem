...
public class ConfigExperiments extends ConfigBase {
	...
	// 26.3 snapshot
	public static boolean enableCushions;
	...
	protected void syncConfigOptions() {
		...
		enableCushions = getBoolean("enableCushions", catExperiments, false, "Enable cushions. Currently unreleased by Mojang and subject to change.");
