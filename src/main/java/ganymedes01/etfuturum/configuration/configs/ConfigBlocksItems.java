...
public class ConfigBlocksItems extends ConfigBase {
    ...
    protected void syncConfigOptions() {
        ...
        enableChorusFruit = getBoolean(
            "enableChorusBlocks",
            catBlockNatural,
            true,
            "Enables chorus plants and purpur blocks");
        ...
        enableNewNetherBricks = getBoolean(
            "enableRedNetherBricks",
            catBlockMisc,
            true,
            "Note: Also enables cracked and chiseled nether bricks as they use this ID too");
        ...
        enableCopper = getBoolean(
            "enableCopper",
            catBlockNatural,
            true,
            "Copper ore and copper blocks, variants, and waxed variants. (Slime balls are used if no mod introduces wax and if honey is disabled)");
        ...
        enableDeepslateOres = getBoolean(
            "enableDeepslateOres",
            catBlockNatural,
            true,
            "Enable deepslate ores for copper ore and vanilla ores when deepslate generates over them.");
        enableAmethyst = getBoolean(
            "enableAmethyst",
            catBlockNatural,
            true,
            "Enables tinted glass, amethyst blocks, budding amethyst and amethyst crystals. Also enables the item too.");
        enableMud = getBoolean(
            "enableMud",
            catBlockNatural,
            true,
            "Enables mud, packed mud and mud bricks, as well as the mud brick stairs, slabs and walls.");
        // enableMoss = getBoolean("enableMoss", catBlockNatural, true, "Enables moss blocks and carpets");
        // enableCrimsonBlocks = getBoolean("enableCrimsonBlocks", catBlockMisc, true, "Enables the crimson nylium,
        // wood, and plants. This must be on for the crimson forest biome to generate unless Netherlicious is
        // installed.\nThe nether wart block is still a separate toggle, both this and the wart toggle must be turned
        // off to disable the nether wart block, because crimson trees need the wart blocks.");
        // enableWarpedBlocks = getBoolean("enableWarpedBlocks", catBlockMisc, true, "Enables the warped nylium, wood,
        // and plants. This must be on for the warped forest biome to generate unless Netherlicious is installed.");
        enableBlackstone = getBoolean(
            "enableBlackstone",
            catBlockMisc,
            true,
            "This must be on for the basalt deltas biome to generate unless Netherlicious is installed.");
        enableSoulSoil = getBoolean(
            "enableSoulSoil",
            catBlockNatural,
            true,
            "Not required for the Soul Sand Valley to generate.");
        enableSoulLighting = getBoolean("enableSoulLighting", catBlockNatural, true, "Soul torches and soul lanterns.");
        enableBasalt = getBoolean(
            "enableBasalt",
            catBlockNatural,
            true,
            "This must be on for the basalt deltas biome to generate unless Netherlicious is installed.");
        ...
        boolean masterNetherToggle = getBoolean(
            "masterNetherToggle",
            catBlockNatural,
            true,
        ...
        // enableMangroveBlocks = getBoolean("enableMangroveBlocks", catBlockNatural, true, "Enables mangrove wood and
        // all of its wood subtypes, and the roots (+ muddy versions).");
        enableCherryBlocks = getBoolean(
            "enableCherryBlocks",
            catBlockNatural,
            true,
            "Enables cherry wood and all of its wood subtypes.");
        enableBambooBlocks = getBoolean(
            "enableBambooBlocks",
            catBlockNatural,
            true,
            "Enables bamboo wood and all of its wood subtypes, including the bamboo stalks themselves.");

        // Check if we enable wood variants at all. Used by blocks where all the wood is 1 ID
        woodVariants = ConfigExperiments.enableCrimsonBlocks || ConfigExperiments.enableWarpedBlocks
            || ConfigExperiments.enableMangroveBlocks
            || enableCherryBlocks
            || enableBambooBlocks;
        ...
        enableVanillaDoors = getBoolean(
            "enableVanillaDoors",
            catBlockFunc,
            true,
            "Enables variant doors for materials available natively in Minecraft 1.7");
        enableNewDoors = getBoolean(
            "enableNewDoors",
            catBlockFunc,
            true,
            "Enables variant doors for materials available in Minecraft after 1.7");
        enableVanillaTrapdoors = getBoolean(
            "enableVanillaTrapdoors",
            catBlockFunc,
            true,
            "Enables variant trapdoors for materials available natively in Minecraft 1.7");
        enableNewTrapdoors = getBoolean(
            "enableNewTrapdoors",
            catBlockFunc,
            true,
            "Enables variant trapdoors for materials available in Minecraft after 1.7");
        enableSlimeBlock = getBoolean("enableSlimeBlock", catBlockFunc, true, "Just bouncy, does not pull blocks.");
        enableVanillaWoodRedstone = getBoolean(
            "enableVanillaWoodRedstone",
            catBlockFunc,
            true,
            "Enables wood variant buttons and pressure plates for wood available natively in Minecraft 1.7");
        enableNewWoodRedstone = getBoolean(
            "enableNewWoodRedstone",
            catBlockFunc,
            true,
            "Enables wood variant buttons and pressure plates for wood available in Minecraft after 1.7");
        enableBarrel = getBoolean("enableBarrel", catBlockFunc, true, "");
        enableSmoker = getBoolean(
            "enableSmoker",
            catBlockFunc,
            true,
        ...
        enableVanillaSigns = getBoolean(
            "enableVanillaSigns",
            catBlockFunc,
            true,
            "Enables variant signs for materials available natively in Minecraft 1.7");
        enableNewSigns = getBoolean(
            "enableNewSigns",
            catBlockFunc,
            true,
            "Enables wood variant signs for materials available in Minecraft after 1.7");
        enableLavaCauldrons = getBoolean(
            "enableLavaCauldrons",
            catBlockFunc,
            true,
            "Allow lava buckets to fill cauldrons");
        enableShulkerBoxes = getBoolean(
            "enableShulkerBoxes",
            catBlockFunc,
            true,
            "If Shulkers are disabled, a custom recipe will be required to obtain Shulker shells.");
        enablePotionCauldron = getBoolean(
            "enablePotionCauldron",
            catBlockFunc,
            true,
            "A port of potion cauldrons from Bedrock Edition. Used to make tipped arrows and store potions.");
        // Note the above option has an extra check in preInit to ensure Iron Chests is loaded. We can't do this here
        // because Loader doesn't even exist yet since we initialize these configs while Mixins and ASM are being
        // applied.
        enableStonecutter = getBoolean(
            "enableStonecutter",
            catBlockFunc,
            true,
            "Currently DOES NOT HAVE ANY FUNCTIONALITY. Decoration ONLY!");
        enableSmithingTable = getBoolean(
            "enableSmithingTable",
            catBlockFunc,
            true,
        ...
        enableFletchingTable = getBoolean(
            "enableFletchingTable",
            catBlockFunc,
            true,
            "Currently DOES NOT HAVE ANY FUNCTIONALITY. Decoration ONLY!");
        enableComposter = getBoolean(
            "enableComposter",
            catBlockFunc,
            true,
        ...
        enableCartographyTable = getBoolean(
            "enableCartographyTable",
            catBlockFunc,
            true,
            "Currently DOES NOT HAVE ANY FUNCTIONALITY. Decoration ONLY!");
        enableLoom = getBoolean(
            "enableLoom",
            catBlockFunc,
            true,
            "Currently DOES NOT HAVE ANY FUNCTIONALITY. Decoration ONLY!");
        enableDyedBeds = getBoolean(
            "enableDyedBeds",
            catBlockFunc,
            true,
            "Ability to craft differently colored beds out of wool. Mixed wool colors = red bed");

        enableEnchantingTable = getBoolean(
            "enableNewEnchantingTable",
            catBlockFunc,
            true,
        ...
        enableAnvil = getBoolean(
            "enableNewAnvil",
            catBlockFunc,
            true,
            "Enables new anvil behavior, such as less expensive item renaming");
        enableBrewingStands = getBoolean(
            "enableNewBrewingStand",
            catBlockFunc,
            true,
        ...
        enableColourfulBeacons = getBoolean(
            "enableNewBeacon",
            catBlockFunc,
            true,
            "Beacon beam can be colored using stained glass");
        enableInvertedDaylightSensor = getBoolean(
            "enableInvertedSensor",
            catBlockFunc,
            true,
            "Inverted Daylight Sensor");
        enableOldBaseDaylightSensor = getBoolean(
            "enableOldBaseDaylightSensor",
            catBlockFunc,
            false,
            "Enable the old Et Futurum daylight sensor block. Should be enabled if you still have the old Et Futurum copy of the non-inverted daylight detector that need to be converted.");

        enableTarget = getBoolean("enableTarget", catBlockFunc, true, "Enables target block from 1.16");

        // Misc Blocks
        enableVanillaFences = getBoolean(
            "enableVanillaFences",
            catBlockMisc,
            true,
            "Enables variant fences for materials available natively in Minecraft 1.7");
        enableNewFences = getBoolean(
            "enableNewFences",
            catBlockMisc,
            true,
            "Enables variant fences for materials available in Minecraft after 1.7");
        enableVanillaGates = getBoolean(
            "enableVanillaGates",
            catBlockMisc,
            true,
            "Enablesvariant gates for materials available natively in Minecraft 1.7");
        enableNewGates = getBoolean(
            "enableNewGates",
            catBlockMisc,
            true,
            "Enables variant gates for materials available in Minecraft after 1.7");
        ...
        enableExtraVanillaSlabs = getBoolean(
            "enableExtraVanillaSlabs",
            catBlockMisc,
            true,
            "Slabs for vanilla blocks: stone, mossy stone brick, mossy cobble, cut sandstone");
        enableExtraVanillaStairs = getBoolean(
            "enableExtraVanillaStairs",
            catBlockMisc,
            true,
            "Stairs for vanilla blocks: stone, mossy stone brick, mossy cobble");
        enableExtraVanillaWalls = getBoolean(
            "enableExtraVanillaWalls",
            catBlockMisc,
            true,
            "Stairs for vanilla blocks: stone brick, mossy stone brick, sandstone, brick, nether brick");
        enableGlazedTerracotta = getBoolean("enableGlazedTerracotta", catBlockMisc, true, "");
        enableBarrier = getBoolean(
            "enableBarrier",
            catBlockMisc,
            true,
            "A solid, indestructible and invisible block. Can be seen when holding it in Creative mode.");
        enableLightBlock = getBoolean(
            "enableLightBlock",
            catBlockMisc,
            true,
            "Invisible light blocks. Only has a selection box when held, right click to change light level. Otherwise functionally identical to air and can be replaced by placing blocks into it. Invisible, but can be seen when holding it in Creative mode.");
        enableChain = getBoolean("enableChain", catBlockMisc, true, "");
        enableHoney = getBoolean(
            "enableHoney",
            catBlockMisc,
            true,
            "Enables honey blocks, honeycomb blocks, honeycombs, and honey bottles. See entities.cfg for toggling bee nests, beehives, and bees.");
        ...
        enableRawOres = getBoolean(
            "enableRawOres",
            catItemMisc,
            true,
            "If true, vanilla and Et Futurum copper ores will drop raw ore items.");
        ...
        enableOtherside = getBoolean(
            "enableOtherside",
            catItemMisc,
            true,
            "Appears in stronghold corridor and dungeon chests.");
        ...
        netheriteHarvestLevel = getInt(
            "netheriteHarvestLevel",
            catItemEquipment,
            4,
            0,
            Integer.MAX_VALUE,
            "Netherite harvest level, Diamond is 3");
        netheriteSpeed = getFloat(
            "netheriteSpeed",
            catItemEquipment,
            9.0f,
            0.1f,
            Float.MAX_VALUE,
            "Nethherite mining speed, Diamond is 8.0");
        netheriteDamageBase = getFloat(
            "netheriteDamageBase",
            catItemEquipment,
            4.0f,
            0.0f,
            Float.MAX_VALUE,
            "Netherite base damage, Diamond is 3.0");
        netheriteArmourDurabilityFactor = getInt(
            "netheriteArmourDurabilityFactor",
            catItemEquipment,
            37,
            1,
            Integer.MAX_VALUE,
            "Used by the game to generate the durability value for the armor set. The higher the better.");
        netheritePickaxeDurability = getInt(
            "netheritePickaxeDurability",
            catItemEquipment,
            -1,
            -1,
            Integer.MAX_VALUE,
            "Override Netherite Pickaxe Durability, -1 to use netheriteToolDurability");
        netheriteSwordDurability = getInt(
            "netheriteSwordDurability",
            catItemEquipment,
            -1,
            -1,
            Integer.MAX_VALUE,
            "Override Netherite Sword Durability, -1 to use netheriteToolDurability");
        netheriteHoeDurability = getInt(
            "netheriteHoeDurability",
            catItemEquipment,
            -1,
            -1,
            Integer.MAX_VALUE,
            "Override Netherite Hoe Durability, -1 to use netheriteToolDurability");
        netheriteAxeDurability = getInt(
            "netheriteAxeDurability",
            catItemEquipment,
            -1,
            -1,
            Integer.MAX_VALUE,
            "Override Netherite Axe Durability, -1 to use netheriteToolDurability");
        netheriteSpadeDurability = getInt(
            "netheriteSpadeDurability",
            catItemEquipment,
            -1,
            -1,
            Integer.MAX_VALUE,
            "Override Netherite Shovel Durability, -1 to use netheriteToolDurability");
        netheriteHelmetDurability = getInt(
            "netheriteHelmetDurability",
            catItemEquipment,
            -1,
            -1,
            Integer.MAX_VALUE,
            "Override Netherite Helmet Durability, -1 to no override");
        netheriteChestplateDurability = getInt(
            "netheriteChestplateDurability",
            catItemEquipment,
            -1,
            -1,
            Integer.MAX_VALUE,
            "Override Netherite Chestplate Durability, -1 for no override");
        netheriteLeggingsDurability = getInt(
            "netheriteLeggingsDurability",
            catItemEquipment,
            -1,
            -1,
            Integer.MAX_VALUE,
            "Override Netherite Leggings Durability, -1 for no override");
        netheriteBootsDurability = getInt(
            "netheriteBootsDurability",
            catItemEquipment,
            -1,
            -1,
            Integer.MAX_VALUE,
            "Override Netherite Boots Durability, -1 for no override");
        netheriteHelmetProtection = getInt(
            "netheriteHelmetProtection",
            catItemEquipment,
            3,
            1,
            Integer.MAX_VALUE,
            "Netherite Helmet Protection");
        netheriteChestplateProtection = getInt(
            "netheriteChestplateProtection",
            catItemEquipment,
            8,
            1,
            Integer.MAX_VALUE,
            "Netherite Chestplate Protection");
        netheriteLeggingsProtection = getInt(
            "netheriteLeggingsProtection",
            catItemEquipment,
            6,
            1,
            Integer.MAX_VALUE,
            "Netherite Leggings Protection");
        netheriteBootsProtection = getInt(
            "netheriteBootsProtection",
            catItemEquipment,
            3,
            1,
            Integer.MAX_VALUE,
            "Netherite Boots Protection");

        // Entity Items
        enableArmourStand = getBoolean("enableArmorStand", catItemEntity, true, "");
        enableNewBoats = getBoolean(
            "enableNewBoats",
            catItemEntity,
            true,
            "New boats from 1.9+, including the new rowing sounds. All vanilla wood variants included.");

        replaceOldBoats = getBoolean(
            "replaceOldBoats",
            catItemEntity,
            true,
        ...
        newBoatSpeed = getFloat(
            "newBoatSpeed",
            catItemEntity,
            1F,
            0.1F,
            2,
            "The speed multiplier for boats while in water. Use this if you want to make the boats faster or slower. 1 = no speed change");
        newBoatPassengerSeat = getBoolean(
            "newBoatPassengerSeat",
            catItemEntity,
            true,
            "If disabled, only one person can sit in the new boat at a time. The new seat is actually an invisible entity that follows new boats.");
        ...
        newBoatEntityBlacklistAsWhitelist = getBoolean(
            "newBoatEntityBlacklistAsWhitelist",
            catItemEntity,
            false,
            "Treat the entity blacklist as a whitelist, ONLY entities matching that criteria will be allowed.");

        // endGatewaySpawnColor = getInt("endGatewaySpawnColor", catAbandoned, 2, 0, 15, "The color of the end gateway
        // beam when the gateway first appears.");
        // endGatewayEntryColor = getInt("endGatewayEntryColor", catAbandoned, 2, 0, 15, "The color of the end gateway
        // beam when an entity enters it. Originally, this value was 4 (yellow) before version 1.11.");
    }
