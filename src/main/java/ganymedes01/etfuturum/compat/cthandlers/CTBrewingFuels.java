...
public class CTBrewingFuels {
    ...
    public static void remove(IIngredient fuel) {
        ...
        if (((internal instanceof String && BrewingFuelRegistry.isFuel((String) internal))
            || (internal instanceof ItemStack && BrewingFuelRegistry.isFuel((ItemStack) internal)))) {
            final ItemStackMap<Integer> toRemove = new ItemStackMap<>();
            for (Map.Entry<ItemStack, Integer> fuelEntry : BrewingFuelRegistry.getFuels()
                .entrySet()) {
