...
public enum ModBlocks {
    ...
    PRISMARINE_BLOCK(ConfigBlocksItems.enablePrismarine,
        new BaseSubtypesBlock(Material.rock, "prismarine", "prismarine_bricks", "dark_prismarine").setHardness(1.5F)
            .setResistance(10.0F)),
    ...
    BROWN_MUSHROOM(ConfigFunctions.enableSilkTouchingMushrooms,
        new BlockSilkedMushroom(Blocks.brown_mushroom_block, "brown")),
    RED_MUSHROOM(ConfigFunctions.enableSilkTouchingMushrooms,
        new BlockSilkedMushroom(Blocks.red_mushroom_block, "red")),
    ...
    RED_NETHERBRICK(ConfigBlocksItems.enableNewNetherBricks, new BlockNewNetherBrick()), // Also contains chiseled and
    ...
    SMOOTH_STONE(ConfigBlocksItems.enableSmoothStone,
        new BaseBlock(Material.rock).setUnlocalizedNameWithPrefix("smooth_stone")
            .setBlockTextureName("stone_slab_top")
            .setHardness(2F)
            .setResistance(6F)),
    SMOOTH_SANDSTONE(ConfigBlocksItems.enableSmoothSandstone,
        new BaseBlock(Material.rock).setUnlocalizedNameWithPrefix("smooth_sandstone")
            .setBlockTextureName("sandstone_top")
            .setHardness(2F)
            .setResistance(6F)),
    SMOOTH_RED_SANDSTONE(ConfigBlocksItems.enableRedSandstone,
        new BaseBlock(Material.rock).setUnlocalizedNameWithPrefix("smooth_red_sandstone")
            .setBlockTextureName("red_sandstone_top")
            .setHardness(2F)
            .setResistance(6F)),
    SMOOTH_QUARTZ(ConfigBlocksItems.enableSmoothQuartz,
        new BaseBlock(Material.rock).setUnlocalizedNameWithPrefix("smooth_quartz")
    ...
    WOOD2_STRIPPED(ConfigBlocksItems.enableStrippedLogs && ConfigBlocksItems.enableBarkLogs,
        new BlockStrippedNewWood()),
    CONCRETE(ConfigBlocksItems.enableConcrete,
        new BaseSubtypesBlock(
            Material.rock,
            "white_concrete",
            "orange_concrete",
            "magenta_concrete",
            ...
            "green_concrete",
            "red_concrete",
            "black_concrete").setNames("concrete")
                .setMapColorBaseBlock(Blocks.wool)
                .setHardness(1.8F)
                .setResistance(1.8F),
        BaseItemBlock.class),
    ...
    DEEPSLATE_COPPER_ORE(
        (ConfigBlocksItems.enableCopper || ConfigModCompat.moddedDeepslateOres) && ConfigBlocksItems.enableDeepslate
            && ConfigBlocksItems.enableDeepslateOres,
        new BlockDeepslateCopperOre()),
    ...
    POLISHED_DEEPSLATE(ConfigBlocksItems.enableDeepslate, new BaseBlock(Material.rock).setNames("polished_deepslate")
        ...
        .setResistance(6)
        .setCreativeTab(EtFuturum.creativeTabBlocks)),
    DEEPSLATE_BRICKS(ConfigBlocksItems.enableDeepslate,
        new BaseSubtypesBlock(
            Material.rock,
            "deepslate_bricks",
            ...
            "chiseled_deepslate").setNames("deepslate_bricks")
    ...
    DEEPSLATE_COAL_ORE(ConfigBlocksItems.enableDeepslate && ConfigBlocksItems.enableDeepslateOres,
        new BlockDeepslateOre(Blocks.coal_ore)),
    DEEPSLATE_IRON_ORE(ConfigBlocksItems.enableDeepslate && ConfigBlocksItems.enableDeepslateOres,
        new BlockDeepslateOre(Blocks.iron_ore)),
    DEEPSLATE_GOLD_ORE(ConfigBlocksItems.enableDeepslate && ConfigBlocksItems.enableDeepslateOres,
        new BlockDeepslateOre(Blocks.gold_ore)),
    DEEPSLATE_REDSTONE_ORE(ConfigBlocksItems.enableDeepslate && ConfigBlocksItems.enableDeepslateOres,
        new BlockDeepslateRedstoneOre(false)),
    DEEPSLATE_LIT_REDSTONE_ORE(ConfigBlocksItems.enableDeepslate && ConfigBlocksItems.enableDeepslateOres,
        new BlockDeepslateRedstoneOre(true), null),
    DEEPSLATE_LAPIS_ORE(ConfigBlocksItems.enableDeepslate && ConfigBlocksItems.enableDeepslateOres,
        new BlockDeepslateOre(Blocks.lapis_ore)),
    DEEPSLATE_DIAMOND_ORE(ConfigBlocksItems.enableDeepslate && ConfigBlocksItems.enableDeepslateOres,
        new BlockDeepslateOre(Blocks.diamond_ore)),
    DEEPSLATE_EMERALD_ORE(ConfigBlocksItems.enableDeepslate && ConfigBlocksItems.enableDeepslateOres,
        new BlockDeepslateOre(Blocks.emerald_ore)),
    ...
    STONE_SLAB_2(ConfigBlocksItems.enableStones,
        new BaseSlab(
            false,
            Material.rock,
            "granite",
            ...
            "polished_diorite",
            "andesite",
            "polished_andesite").setUnlocalizedNameWithPrefix("stone_slab_2")
                .setHardness(2F)
                .setResistance(6F)),
    DOUBLE_STONE_SLAB_2(ConfigBlocksItems.enableStones,
        new BaseSlab(
            true,
            Material.rock,
            "granite",
    ...
    PRISMARINE_SLAB(ConfigBlocksItems.enablePrismarine,
        new BaseSlab(false, Material.rock, "prismarine", "prismarine_bricks", "dark_prismarine").setHardness(1.5F)
            .setResistance(6.0F),
        BaseSlabItemBlock.class),
    DOUBLE_PRISMARINE_SLAB(ConfigBlocksItems.enablePrismarine,
        new BaseSlab(true, Material.rock, "prismarine", "prismarine_bricks", "dark_prismarine").setHardness(1.5F)
            .setResistance(6.0F),
        BaseSlabItemBlock.class),
    ...
    RED_NETHERBRICK_SLAB(ConfigBlocksItems.enableNewNetherBricks,
        new BaseSlab(false, Material.rock, "red_nether_bricks").setResistance(6)
            .setHardness(2.0F),
        BaseSlabItemBlock.class),
    DOUBLE_RED_NETHERBRICK_SLAB(ConfigBlocksItems.enableNewNetherBricks,
        new BaseSlab(true, Material.rock, "red_nether_bricks").setResistance(6)
            .setHardness(2.0F),
        BaseSlabItemBlock.class),
    END_BRICK_SLAB(ConfigBlocksItems.enableChorusFruit,
        new BaseSlab(false, Material.rock, "end_bricks").setResistance(9)
            .setHardness(3.0F),
        BaseSlabItemBlock.class),
    DOUBLE_END_BRICK_SLAB(ConfigBlocksItems.enableChorusFruit,
        new BaseSlab(true, Material.rock, "end_bricks").setResistance(9)
            .setHardness(3.0F),
        BaseSlabItemBlock.class),
    DEEPSLATE_SLAB(ConfigBlocksItems.enableDeepslate,
        new BaseSlab(false, Material.rock, "cobbled_deepslate", "polished_deepslate").setNames("deepslate_slab")
            .setBlockSound(ModSounds.soundDeepslate)
            .setHardness(ConfigFunctions.useStoneHardnessForDeepslate ? 2.0f : 3.5f)
            .setResistance(6)),
    DOUBLE_DEEPSLATE_SLAB(ConfigBlocksItems.enableDeepslate,
        new BaseSlab(true, Material.rock, "cobbled_deepslate", "polished_deepslate").setNames("deepslate_slab")
            .setBlockSound(ModSounds.soundDeepslate)
            .setHardness(ConfigFunctions.useStoneHardnessForDeepslate ? 2.0f : 3.5f)
            .setResistance(6)),
    DEEPSLATE_BRICK_SLAB(ConfigBlocksItems.enableDeepslate,
        new BaseSlab(false, Material.rock, "deepslate_bricks", "deepslate_tiles")
            .setBlockSound(ModSounds.soundDeepslateBricks)
            .setHardness(ConfigFunctions.useStoneHardnessForDeepslate ? 2.0f : 3.5f)
            .setResistance(6)),
    DOUBLE_DEEPSLATE_BRICK_SLAB(ConfigBlocksItems.enableDeepslate,
        new BaseSlab(true, Material.rock, "deepslate_bricks", "deepslate_tiles")
            .setBlockSound(ModSounds.soundDeepslateBricks)
            .setHardness(ConfigFunctions.useStoneHardnessForDeepslate ? 2.0f : 3.5f)
            .setResistance(6)),
    TUFF_SLAB(ConfigBlocksItems.enableDeepslate,
        new BaseSlab(false, Material.rock, "tuff", "polished_tuff", "tuff_bricks").setBlockSound(ModSounds.soundTuff)
            .setHardness(1.5F)
            .setResistance(6)),
    DOUBLE_TUFF_SLAB(ConfigBlocksItems.enableDeepslate,
        new BaseSlab(true, Material.rock, "tuff", "polished_tuff", "tuff_bricks").setBlockSound(ModSounds.soundTuff)
            .setHardness(1.5F)
            .setResistance(6)),
    MUD_BRICK_SLAB(ConfigBlocksItems.enableMud,
        new BaseSlab(false, Material.rock, "mud_bricks").setBlockSound(ModSounds.soundMudBricks)
            .setHardness(3)
            .setResistance(6)),
    DOUBLE_MUD_BRICK_SLAB(ConfigBlocksItems.enableMud,
        new BaseSlab(true, Material.rock, "mud_bricks").setBlockSound(ModSounds.soundMudBricks)
            .setHardness(3)
            .setResistance(6)),
    ...
    PRISMARINE_STAIRS(ConfigBlocksItems.enablePrismarine,
        new BaseStairs(PRISMARINE_BLOCK.get(), 0).setUnlocalizedNameWithPrefix("prismarine")),
    PRISMARINE_STAIRS_BRICK(ConfigBlocksItems.enablePrismarine,
        new BaseStairs(PRISMARINE_BLOCK.get(), 1).setUnlocalizedNameWithPrefix("prismarine_brick")),
    PRISMARINE_STAIRS_DARK(ConfigBlocksItems.enablePrismarine,
        new BaseStairs(PRISMARINE_BLOCK.get(), 2).setUnlocalizedNameWithPrefix("dark_prismarine")),
    ...
    RED_NETHERBRICK_STAIRS(ConfigBlocksItems.enableNewNetherBricks,
        new BaseStairs(RED_NETHERBRICK.get(), 0).setUnlocalizedNameWithPrefix("red_nether_brick")),
    GRANITE_STAIRS(ConfigBlocksItems.enableStones,
        new BaseStairs(STONE.get(), 1).setUnlocalizedNameWithPrefix("granite")),
    POLISHED_GRANITE_STAIRS(ConfigBlocksItems.enableStones,
        new BaseStairs(STONE.get(), 2).setUnlocalizedNameWithPrefix("polished_granite")),
    DIORITE_STAIRS(ConfigBlocksItems.enableStones,
        new BaseStairs(STONE.get(), 3).setUnlocalizedNameWithPrefix("diorite")),
    POLISHED_DIORITE_STAIRS(ConfigBlocksItems.enableStones,
        new BaseStairs(STONE.get(), 4).setUnlocalizedNameWithPrefix("polished_diorite")),
    ANDESITE_STAIRS(ConfigBlocksItems.enableStones,
        new BaseStairs(STONE.get(), 5).setUnlocalizedNameWithPrefix("andesite")),
    POLISHED_ANDESITE_STAIRS(ConfigBlocksItems.enableStones,
        new BaseStairs(STONE.get(), 6).setUnlocalizedNameWithPrefix("polished_andesite")),
    MOSSY_STONE_BRICK_STAIRS(ConfigBlocksItems.enableExtraVanillaStairs,
        new BaseStairs(Blocks.stonebrick, 1).setUnlocalizedNameWithPrefix("mossy_stone_brick")),
    MOSSY_COBBLESTONE_STAIRS(ConfigBlocksItems.enableExtraVanillaStairs,
        new BaseStairs(Blocks.mossy_cobblestone, 0).setUnlocalizedNameWithPrefix("mossy_cobblestone")),
    ...
    PURPUR_STAIRS(ConfigBlocksItems.enableChorusFruit,
        new BaseStairs(PURPUR_BLOCK.get(), 0).setUnlocalizedNameWithPrefix("purpur")),
    ...
    DEEPSLATE_TILE_STAIRS(ConfigBlocksItems.enableDeepslate,
        new BaseStairs(DEEPSLATE_BRICKS.get(), 2).setUnlocalizedNameWithPrefix("deepslate_tile")
    ...
    POLISHED_TUFF_STAIRS(ConfigBlocksItems.enableTuff,
        new BaseStairs(TUFF.get(), 1).setUnlocalizedNameWithPrefix("polished_tuff")
            .setBlockSound(ModSounds.soundPolishedTuff)),
    TUFF_BRICK_STAIRS(ConfigBlocksItems.enableTuff,
        new BaseStairs(TUFF.get(), 2).setUnlocalizedNameWithPrefix("tuff_bricks")
            .setBlockSound(ModSounds.soundTuffBricks)),
    MUD_BRICK_STAIRS(ConfigBlocksItems.enableMud,
        new BaseStairs(PACKED_MUD.get(), 1).setUnlocalizedNameWithPrefix("mud_brick")
    ...
    NETHER_BRICK_WALL(ConfigBlocksItems.enableExtraVanillaWalls,
        new BaseWall(Material.rock, "nether_brick").setBlockSound(ModSounds.soundNetherBricks)
            .setHardness(2F)
            .setResistance(6F)),
    STONE_WALL_2(ConfigBlocksItems.enableStones,
        new BaseWall(Material.rock, "granite", "diorite", "andesite").setHardness(1.5F)
            .setResistance(6.0F)),
    RED_SANDSTONE_WALL(ConfigBlocksItems.enableRedSandstone,
        new BaseWall(Material.rock, "red_sandstone").setHardness(0.8F)),
    PRISMARINE_WALL(ConfigBlocksItems.enablePrismarine, new BaseWall(Material.rock, "prismarine").setHardness(1.5F)
        .setResistance(10.0F)),
    RED_NETHER_BRICK_WALL(ConfigBlocksItems.enableNewNetherBricks,
        new BaseWall(Material.rock, "red_nether_bricks").setBlockSound(ModSounds.soundNetherBricks)
            .setHardness(2F)
            .setResistance(6F)),
    END_BRICK_WALL(ConfigBlocksItems.enableChorusFruit, new BaseWall(Material.rock, "end_bricks").setHardness(3.0F)
        .setResistance(9.0F)),
    DEEPSLATE_WALL(ConfigBlocksItems.enableDeepslate,
        new BaseWall(Material.rock, "cobbled_deepslate", "polished_deepslate")
            .setHardness(ConfigFunctions.useStoneHardnessForDeepslate ? 2.0f : 3.5f)
            .setResistance(6.0F)),
    DEEPSLATE_BRICK_WALL(ConfigBlocksItems.enableDeepslate,
        new BaseWall(Material.rock, "deepslate_bricks", "deepslate_tiles")
            .setHardness(ConfigFunctions.useStoneHardnessForDeepslate ? 1.5f : 3.5f)
            .setResistance(6.0F)),
    TUFF_WALL(ConfigBlocksItems.enableTuff,
        new BaseWall(Material.rock, "tuff", "polished_tuff", "tuff_bricks").setBlockSound(ModSounds.soundTuff)
            .setHardness(1.5F)
            .setResistance(6.0F)),
    MUD_BRICK_WALL(ConfigBlocksItems.enableMud,
        new BaseWall(Material.rock, "mud_bricks").setBlockSound(ModSounds.soundMudBricks)
            .setHardness(1.5F)
            .setResistance(3.0F)),
    ...
    SOUL_LANTERN(ConfigBlocksItems.enableLantern && ConfigBlocksItems.enableSoulLighting,
        new BlockLantern("soul_lantern", 10)),
    ...
    FLETCHING_TABLE(ConfigBlocksItems.enableFletchingTable, new BlockFletchingTable(),
        ItemBlockDecorationWorkbench.class),
    CARTOGRAPHY_TABLE(ConfigBlocksItems.enableCartographyTable, new BlockCartographyTable(),
        ItemBlockDecorationWorkbench.class),
    ...
    DRIPSTONE_BLOCK(ConfigExperiments.enableDripstone, new BaseBlock(Material.rock).setNames("dripstone_block")
        .setBlockSound(ModSounds.soundDripstoneBlock)
        .setHardness(1.5F)
        .setResistance(1F)),
    ...
    DAYLIGHT_DETECTOR(ConfigBlocksItems.enableInvertedDaylightSensor && ConfigBlocksItems.enableOldBaseDaylightSensor,
        new BlockNewDaylightSensor()),
    ...
    IRON_BARREL(ModsList.IRON_CHEST.isLoaded() && ConfigBlocksItems.enableBarrel && ConfigModCompat.barrelIronChest,
        new BlockBarrel(TileEntityBarrel.BarrelType.IRON)),
    GOLD_BARREL(ModsList.IRON_CHEST.isLoaded() && ConfigBlocksItems.enableBarrel && ConfigModCompat.barrelIronChest,
        new BlockBarrel(TileEntityBarrel.BarrelType.GOLD)),
    DIAMOND_BARREL(ModsList.IRON_CHEST.isLoaded() && ConfigBlocksItems.enableBarrel && ConfigModCompat.barrelIronChest,
        new BlockBarrel(TileEntityBarrel.BarrelType.DIAMOND)),
    COPPER_BARREL(ModsList.IRON_CHEST.isLoaded() && ConfigBlocksItems.enableBarrel && ConfigModCompat.barrelIronChest,
        new BlockBarrel(TileEntityBarrel.BarrelType.COPPER)),
    SILVER_BARREL(ModsList.IRON_CHEST.isLoaded() && ConfigBlocksItems.enableBarrel && ConfigModCompat.barrelIronChest,
        new BlockBarrel(TileEntityBarrel.BarrelType.SILVER)),
    STEEL_BARREL(ModsList.IRON_CHEST.isLoaded() && ConfigBlocksItems.enableBarrel && ConfigModCompat.barrelIronChest,
        new BlockBarrel(TileEntityBarrel.BarrelType.STEEL)),
    OBSIDIAN_BARREL(ModsList.IRON_CHEST.isLoaded() && ConfigBlocksItems.enableBarrel && ConfigModCompat.barrelIronChest,
        new BlockBarrel(TileEntityBarrel.BarrelType.OBSIDIAN)),
    DARKSTEEL_BARREL(
        ModsList.IRON_CHEST.isLoaded() && ConfigBlocksItems.enableBarrel && ConfigModCompat.barrelIronChest,
        new BlockBarrel(TileEntityBarrel.BarrelType.DARKSTEEL)),
    NETHERITE_BARREL(
        ModsList.IRON_CHEST.isLoaded() && ConfigBlocksItems.enableBarrel && ConfigModCompat.barrelIronChest,
        new BlockBarrel(TileEntityBarrel.BarrelType.NETHERITE)),
    ...
    POLISHED_BLACKSTONE_STAIRS(ConfigBlocksItems.enableBlackstone,
        new BaseStairs(ModBlocks.BLACKSTONE.get(), 1).setUnlocalizedNameWithPrefix("polished_blackstone")),
    POLISHED_BLACKSTONE_BRICK_STAIRS(ConfigBlocksItems.enableBlackstone,
        new BaseStairs(ModBlocks.BLACKSTONE.get(), 2).setUnlocalizedNameWithPrefix("polished_blackstone_brick")),
    ...
    NETHER_ROOTS(ConfigExperiments.enableCrimsonBlocks || ConfigExperiments.enableWarpedBlocks, new BlockNetherRoots(),
        BaseSubtypesPotableItemBlock.class),
    NETHER_FUNGUS(ConfigExperiments.enableCrimsonBlocks || ConfigExperiments.enableWarpedBlocks,
        new BlockNetherFungus(), BaseSubtypesPotableItemBlock.class),
    ...
    BAMBOO_BLOCK(ConfigBlocksItems.enableBambooBlocks,
        new BlockBambooBlock("bamboo").setBlockSound(ModSounds.soundBambooWood)),
    BAMBOO(ConfigBlocksItems.enableBambooBlocks, new BlockBamboo(), null),

    // new wood stairs
    CRIMSON_STAIRS(ConfigExperiments.enableCrimsonBlocks,
        new BaseStairs(WOOD_PLANKS.get(), 0).setBlockSound(ModSounds.soundNetherWood)
            .setUnlocalizedNameWithPrefix("crimson")),
    WARPED_STAIRS(ConfigExperiments.enableWarpedBlocks,
        new BaseStairs(WOOD_PLANKS.get(), 1).setBlockSound(ModSounds.soundNetherWood)
            .setUnlocalizedNameWithPrefix("warped")),
    MANGROVE_STAIRS(ConfigExperiments.enableMangroveBlocks,
        new BaseStairs(WOOD_PLANKS.get(), 2).setBlockSound(Block.soundTypeWood)
            .setUnlocalizedNameWithPrefix("mangrove")),
    CHERRY_STAIRS(ConfigBlocksItems.enableCherryBlocks,
        new BaseStairs(WOOD_PLANKS.get(), 3).setBlockSound(ModSounds.soundCherryWood)
            .setUnlocalizedNameWithPrefix("cherry")),
    BAMBOO_STAIRS(ConfigBlocksItems.enableBambooBlocks,
        new BaseStairs(WOOD_PLANKS.get(), 4).setBlockSound(ModSounds.soundBambooWood)
            .setUnlocalizedNameWithPrefix("bamboo")),

    // Not plank, but like plank
    BAMBOO_MOSAIC(ConfigBlocksItems.enableBambooBlocks, new BlockBambooMosaic()),
    BAMBOO_MOSAIC_SLAB(ConfigBlocksItems.enableBambooBlocks,
        new BaseSlab(false, Material.wood, "bamboo_mosaic").setNames("bamboo_mosaic_slab")
            .setBlockSound(ModSounds.soundBambooWood)
            .setHardness(2)
            .setResistance(3)),
    DOUBLE_BAMBOO_MOSAIC_SLAB(ConfigBlocksItems.enableBambooBlocks,
        new BaseSlab(true, Material.wood, "bamboo_mosaic").setNames("bamboo_mosaic_slab")
            .setBlockSound(ModSounds.soundBambooWood)
            .setHardness(2)
            .setResistance(3)),
    BAMBOO_MOSAIC_STAIRS(ConfigBlocksItems.enableBambooBlocks,
        new BaseStairs(BAMBOO_MOSAIC.get(), 0).setBlockSound(ModSounds.soundBambooWood)
            .setUnlocalizedNameWithPrefix("bamboo_mosaic")),

    // legacy fences
    // This is left as-is because fences should really be meta states anyways, so new fences use a different class, so
    // why touch this int-based constructor?
    ...
    // new fence, this can just be one block, meta states are fine, the fences above were made by ganymedes01 and not me
    // hence the lack of meta usage
    ...
    BUTTON_DARK_OAK(ConfigBlocksItems.enableVanillaWoodRedstone,
        new BlockWoodButton("dark_oak", Blocks.planks, 5, true)),

    // new buttons (different ID format)
    CRIMSON_BUTTON(ConfigExperiments.enableCrimsonBlocks && ConfigBlocksItems.enableNewWoodRedstone,
        new BlockWoodButton("crimson", WOOD_PLANKS.get(), 0, false)),
    WARPED_BUTTON(ConfigExperiments.enableWarpedBlocks && ConfigBlocksItems.enableNewWoodRedstone,
        new BlockWoodButton("warped", WOOD_PLANKS.get(), 1, false)),
    MANGROVE_BUTTON(ConfigExperiments.enableMangroveBlocks && ConfigBlocksItems.enableNewWoodRedstone,
        new BlockWoodButton("mangrove", WOOD_PLANKS.get(), 2, true)),
    CHERRY_BUTTON(ConfigBlocksItems.enableCherryBlocks && ConfigBlocksItems.enableNewWoodRedstone,
        new BlockWoodButton("cherry", WOOD_PLANKS.get(), 3, true)),
    BAMBOO_BUTTON(ConfigBlocksItems.enableBambooBlocks && ConfigBlocksItems.enableNewWoodRedstone,
        new BlockWoodButton("bamboo", WOOD_PLANKS.get(), 4, true)),

    // legacy pressure plates
    PRESSURE_PLATE_SPRUCE(ConfigBlocksItems.enableVanillaWoodRedstone,
        new BlockWoodPressurePlate("spruce", Blocks.planks, 1, true)),
    PRESSURE_PLATE_BIRCH(ConfigBlocksItems.enableVanillaWoodRedstone,
        new BlockWoodPressurePlate("birch", Blocks.planks, 2, true)),
    PRESSURE_PLATE_JUNGLE(ConfigBlocksItems.enableVanillaWoodRedstone,
        new BlockWoodPressurePlate("jungle", Blocks.planks, 3, true)),
    PRESSURE_PLATE_ACACIA(ConfigBlocksItems.enableVanillaWoodRedstone,
        new BlockWoodPressurePlate("acacia", Blocks.planks, 4, true)),
    PRESSURE_PLATE_DARK_OAK(ConfigBlocksItems.enableVanillaWoodRedstone,
        new BlockWoodPressurePlate("dark_oak", Blocks.planks, 5, true)),

    // new pressure plates (different ID format)
    CRIMSON_PRESSURE_PLATE(ConfigExperiments.enableCrimsonBlocks && ConfigBlocksItems.enableNewWoodRedstone,
        new BlockWoodPressurePlate("crimson", WOOD_PLANKS.get(), 0, false)),
    WARPED_PRESSURE_PLATE(ConfigExperiments.enableWarpedBlocks && ConfigBlocksItems.enableNewWoodRedstone,
        new BlockWoodPressurePlate("warped", WOOD_PLANKS.get(), 1, false)),
    MANGROVE_PRESSURE_PLATE(ConfigExperiments.enableMangroveBlocks && ConfigBlocksItems.enableNewWoodRedstone,
        new BlockWoodPressurePlate("mangrove", WOOD_PLANKS.get(), 2, true)),
    CHERRY_PRESSURE_PLATE(ConfigBlocksItems.enableCherryBlocks && ConfigBlocksItems.enableNewWoodRedstone,
        new BlockWoodPressurePlate("cherry", WOOD_PLANKS.get(), 3, true)),
    BAMBOO_PRESSURE_PLATE(ConfigBlocksItems.enableBambooBlocks && ConfigBlocksItems.enableNewWoodRedstone,
        new BlockWoodPressurePlate("bamboo", WOOD_PLANKS.get(), 4, true)),
    ...
    FENCE_GATE_DARK_OAK(ConfigBlocksItems.enableVanillaGates,
        new BlockWoodFenceGate("dark_oak", Blocks.planks, 5, true)),

    // new fence gates (different ID format)
    CRIMSON_FENCE_GATE(ConfigExperiments.enableCrimsonBlocks && ConfigBlocksItems.enableNewGates,
        new BlockWoodFenceGate("crimson", WOOD_PLANKS.get(), 0, false)),
    WARPED_FENCE_GATE(ConfigExperiments.enableWarpedBlocks && ConfigBlocksItems.enableNewGates,
        new BlockWoodFenceGate("warped", WOOD_PLANKS.get(), 1, false)),
    MANGROVE_FENCE_GATE(ConfigExperiments.enableMangroveBlocks && ConfigBlocksItems.enableNewGates,
        new BlockWoodFenceGate("mangrove", WOOD_PLANKS.get(), 2, true)),
    CHERRY_FENCE_GATE(ConfigBlocksItems.enableCherryBlocks && ConfigBlocksItems.enableNewGates,
        new BlockWoodFenceGate("cherry", WOOD_PLANKS.get(), 3, true)),
    BAMBOO_FENCE_GATE(ConfigBlocksItems.enableBambooBlocks && ConfigBlocksItems.enableNewGates,
        new BlockWoodFenceGate("bamboo", WOOD_PLANKS.get(), 4, true)),
    ...
    CRIMSON_DOOR(ConfigExperiments.enableCrimsonBlocks && ConfigBlocksItems.enableNewDoors,
        new BaseDoor("crimson").setBlockSound(ModSounds.soundNetherWood)),
    WARPED_DOOR(ConfigExperiments.enableWarpedBlocks && ConfigBlocksItems.enableNewDoors,
        new BaseDoor("warped").setBlockSound(ModSounds.soundNetherWood)),
    MANGROVE_DOOR(ConfigExperiments.enableMangroveBlocks && ConfigBlocksItems.enableNewDoors, new BaseDoor("mangrove")),
    CHERRY_DOOR(ConfigBlocksItems.enableCherryBlocks && ConfigBlocksItems.enableNewDoors,
        new BaseDoor("cherry").setBlockSound(ModSounds.soundCherryWood)),
    BAMBOO_DOOR(ConfigBlocksItems.enableBambooBlocks && ConfigBlocksItems.enableNewDoors,
        new BaseDoor("bamboo").setBlockSound(ModSounds.soundBambooWood)),
    ...
    CRIMSON_TRAPDOOR(ConfigExperiments.enableCrimsonBlocks && ConfigBlocksItems.enableNewTrapdoors,
        new BaseTrapdoor("crimson").setBlockSound(ModSounds.soundNetherWood)),
    WARPED_TRAPDOOR(ConfigExperiments.enableWarpedBlocks && ConfigBlocksItems.enableNewTrapdoors,
        new BaseTrapdoor("warped").setBlockSound(ModSounds.soundNetherWood)),
    MANGROVE_TRAPDOOR(ConfigExperiments.enableMangroveBlocks && ConfigBlocksItems.enableNewTrapdoors,
        new BaseTrapdoor("mangrove")),
    CHERRY_TRAPDOOR(ConfigBlocksItems.enableCherryBlocks && ConfigBlocksItems.enableNewTrapdoors,
        new BaseTrapdoor("cherry").setBlockSound(ModSounds.soundCherryWood)),
    BAMBOO_TRAPDOOR(ConfigBlocksItems.enableBambooBlocks && ConfigBlocksItems.enableNewTrapdoors,
        new BaseTrapdoor("bamboo").setBlockSound(ModSounds.soundBambooWood)),

    // legacy signs
    SIGN_SPRUCE(ConfigBlocksItems.enableVanillaSigns,
        new BlockWoodSign(TileEntityWoodSign.class, true, "spruce", Blocks.planks, 1), null),
    WALL_SIGN_SPRUCE(ConfigBlocksItems.enableVanillaSigns,
        new BlockWoodSign(TileEntityWoodSign.class, false, "spruce", Blocks.planks, 1), null),
    SIGN_BIRCH(ConfigBlocksItems.enableVanillaSigns,
        new BlockWoodSign(TileEntityWoodSign.class, true, "birch", Blocks.planks, 2), null),
    WALL_SIGN_BIRCH(ConfigBlocksItems.enableVanillaSigns,
        new BlockWoodSign(TileEntityWoodSign.class, false, "birch", Blocks.planks, 2), null),
    SIGN_JUNGLE(ConfigBlocksItems.enableVanillaSigns,
        new BlockWoodSign(TileEntityWoodSign.class, true, "jungle", Blocks.planks, 3), null),
    WALL_SIGN_JUNGLE(ConfigBlocksItems.enableVanillaSigns,
        new BlockWoodSign(TileEntityWoodSign.class, false, "jungle", Blocks.planks, 3), null),
    SIGN_ACACIA(ConfigBlocksItems.enableVanillaSigns,
        new BlockWoodSign(TileEntityWoodSign.class, true, "acacia", Blocks.planks, 4), null),
    WALL_SIGN_ACACIA(ConfigBlocksItems.enableVanillaSigns,
        new BlockWoodSign(TileEntityWoodSign.class, false, "acacia", Blocks.planks, 4), null),
    SIGN_DARK_OAK(ConfigBlocksItems.enableVanillaSigns,
        new BlockWoodSign(TileEntityWoodSign.class, true, "dark_oak", Blocks.planks, 5), null),
    WALL_SIGN_DARK_OAK(ConfigBlocksItems.enableVanillaSigns,
        new BlockWoodSign(TileEntityWoodSign.class, false, "dark_oak", Blocks.planks, 5), null),

    // new wood signs (instead of a separate ItemBlock we use the standing sign as the ItemBlock
    CRIMSON_SIGN(ConfigExperiments.enableCrimsonBlocks && ConfigBlocksItems.enableNewSigns,
        new BlockWoodSign(TileEntityWoodSign.class, true, "crimson", WOOD_PLANKS.get(), 0), ItemBlockSign.class),
    CRIMSON_WALL_SIGN(ConfigExperiments.enableCrimsonBlocks && ConfigBlocksItems.enableNewSigns,
        new BlockWoodSign(TileEntityWoodSign.class, false, "crimson", WOOD_PLANKS.get(), 0), null),
    WARPED_SIGN(ConfigExperiments.enableWarpedBlocks && ConfigBlocksItems.enableNewSigns,
        new BlockWoodSign(TileEntityWoodSign.class, true, "warped", WOOD_PLANKS.get(), 1), ItemBlockSign.class),
    WARPED_WALL_SIGN(ConfigExperiments.enableWarpedBlocks && ConfigBlocksItems.enableNewSigns,
        new BlockWoodSign(TileEntityWoodSign.class, false, "warped", WOOD_PLANKS.get(), 1), null),
    MANGROVE_SIGN(ConfigExperiments.enableMangroveBlocks && ConfigBlocksItems.enableNewSigns,
        new BlockWoodSign(TileEntityWoodSign.class, true, "mangrove", WOOD_PLANKS.get(), 2), ItemBlockSign.class),
    MANGROVE_WALL_SIGN(ConfigExperiments.enableMangroveBlocks && ConfigBlocksItems.enableNewSigns,
        new BlockWoodSign(TileEntityWoodSign.class, false, "mangrove", WOOD_PLANKS.get(), 2), null),
    CHERRY_SIGN(ConfigBlocksItems.enableCherryBlocks && ConfigBlocksItems.enableNewSigns,
        new BlockWoodSign(TileEntityWoodSign.class, true, "cherry", WOOD_PLANKS.get(), 3), ItemBlockSign.class),
    CHERRY_WALL_SIGN(ConfigBlocksItems.enableCherryBlocks && ConfigBlocksItems.enableNewSigns,
        new BlockWoodSign(TileEntityWoodSign.class, false, "cherry", WOOD_PLANKS.get(), 3), null),
    BAMBOO_SIGN(ConfigBlocksItems.enableBambooBlocks && ConfigBlocksItems.enableNewSigns,
        new BlockWoodSign(TileEntityWoodSign.class, true, "bamboo", WOOD_PLANKS.get(), 4), ItemBlockSign.class),
    BAMBOO_WALL_SIGN(ConfigBlocksItems.enableBambooBlocks && ConfigBlocksItems.enableNewSigns,
        new BlockWoodSign(TileEntityWoodSign.class, false, "bamboo", WOOD_PLANKS.get(), 4), null),
    ...
    // Mod support
    MODDED_RAW_ORE_BLOCK(Utils.enableModdedRawOres(),
        new BlockGeneralModdedRawOre(
            "raw_aluminum_block",
            "raw_tin_block",
            "raw_silver_block",
            "raw_lead_block",
    ...
    MODDED_DEEPSLATE_ORE(Utils.enableModdedDeepslateOres(),
        new BlockGeneralModdedDeepslateOre(
    ...
    DEEPSLATE_CERTUS_QUARTZ_ORE(Utils.enableModdedDeepslateOres(ModsList.APPLIED_ENERGISTICS_2),
        new BlockDeepslateCertusQuartzOre()),
    DEEPSLATE_DRACONIUM_ORE(Utils.enableModdedDeepslateOres(ModsList.DRACONIC_EVOLUTION),
        new BlockDeepslateDraconiumOre()),
    ...
    DEEPSLATE_PROJRED_ORE(Utils.enableModdedDeepslateOres(ModsList.PROJECT_RED_EXPLORATION),
        new BlockDeepslateProjectRedOre()),
    ...
    public static final ModBlocks[] DOORS = new ModBlocks[] { DOOR_SPRUCE, DOOR_BIRCH, DOOR_JUNGLE, DOOR_ACACIA,
        DOOR_DARK_OAK, CRIMSON_DOOR, WARPED_DOOR, MANGROVE_DOOR, CHERRY_DOOR, BAMBOO_DOOR };
    public static final ModBlocks[] FENCE_GATES = new ModBlocks[] { FENCE_GATE_SPRUCE, FENCE_GATE_BIRCH,
        FENCE_GATE_JUNGLE, FENCE_GATE_ACACIA, FENCE_GATE_DARK_OAK, CRIMSON_FENCE_GATE, WARPED_FENCE_GATE,
        MANGROVE_FENCE_GATE, CHERRY_FENCE_GATE, BAMBOO_FENCE_GATE };
    public static final ModBlocks[] PRESSURE_PLATES = new ModBlocks[] { PRESSURE_PLATE_SPRUCE, PRESSURE_PLATE_BIRCH,
        PRESSURE_PLATE_JUNGLE, PRESSURE_PLATE_ACACIA, PRESSURE_PLATE_DARK_OAK, CRIMSON_PRESSURE_PLATE,
        WARPED_PRESSURE_PLATE, MANGROVE_PRESSURE_PLATE, CHERRY_PRESSURE_PLATE, BAMBOO_PRESSURE_PLATE };
    public static final ModBlocks[] BUTTONS = new ModBlocks[] { BUTTON_SPRUCE, BUTTON_BIRCH, BUTTON_JUNGLE,
        BUTTON_ACACIA, BUTTON_DARK_OAK, CRIMSON_BUTTON, WARPED_BUTTON, MANGROVE_BUTTON, CHERRY_BUTTON, BAMBOO_BUTTON };
    public static final ModBlocks[] TRAPDOORS = new ModBlocks[] { TRAPDOOR_SPRUCE, TRAPDOOR_BIRCH, TRAPDOOR_JUNGLE,
        TRAPDOOR_ACACIA, TRAPDOOR_DARK_OAK, CRIMSON_TRAPDOOR, WARPED_TRAPDOOR, MANGROVE_TRAPDOOR, CHERRY_TRAPDOOR,
        BAMBOO_TRAPDOOR };

    public static final ModBlocks[] FENCES = new ModBlocks[] { FENCE_SPRUCE, FENCE_BIRCH, FENCE_JUNGLE, FENCE_ACACIA,
        FENCE_DARK_OAK };

    public static final ModBlocks[] BEDS = new ModBlocks[] { WHITE_BED, ORANGE_BED, MAGENTA_BED, LIGHT_BLUE_BED,
        YELLOW_BED, LIME_BED, PINK_BED, GRAY_BED, LIGHT_GRAY_BED, CYAN_BED, PURPLE_BED, BLUE_BED, BROWN_BED, GREEN_BED,
        BLACK_BED };
    public static final ModBlocks[] TERRACOTTA = new ModBlocks[] { WHITE_GLAZED_TERRACOTTA, ORANGE_GLAZED_TERRACOTTA,
                ...
                : block instanceof BaseDoor ? ItemBlockNewDoor.class
                    : block instanceof BaseFlower ? BasePotableItemBlock.class
                        : block instanceof BaseLeaves ? BaseLeavesItemBlock.class
                            : block instanceof ISubBlocksBlock ? BaseItemBlock.class : null);
        hasItemBlock = true;
    }
