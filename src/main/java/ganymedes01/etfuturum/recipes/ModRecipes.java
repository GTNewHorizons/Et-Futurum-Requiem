...
public class ModRecipes {
    ...
    public static final String[] ore_dyes = new String[] { "dyeBlack", "dyeRed", "dyeGreen", "dyeBrown", "dyeBlue",
        "dyePurple", "dyeCyan", "dyeLightGray", "dyeGray", "dyePink", "dyeLime", "dyeYellow", "dyeLightBlue",
        "dyeMagenta", "dyeOrange", "dyeWhite" };
    public static final String[] dye_names = new String[] { "white", "orange", "magenta", "light_blue", "yellow",
    ...
    public static void init() {
        if (ConfigBlocksItems.enableBanners) {
            RecipeSorter.register(
                Reference.MOD_ID + ".RecipeDuplicatePattern",
                RecipeDuplicatePattern.class,
                Category.SHAPELESS,
                "after:minecraft:shapeless");
            RecipeSorter.register(
                Reference.MOD_ID + ".RecipeAddPattern",
                RecipeAddPattern.class,
                Category.SHAPED,
                "after:minecraft:shaped");
        }
        RecipeSorter.register(
            Reference.MOD_ID + ":shaped",
            ShapedEtFuturumRecipe.class,
            RecipeSorter.Category.SHAPED,
            "before:minecraft:shaped");
        RecipeSorter.register(
            Reference.MOD_ID + ":shapeless",
            ShapelessEtFuturumRecipe.class,
    ...
    private static void registerLoot() {
        if (ModItems.BEETROOT_SEEDS.isEnabled()) {
            ChestGenHooks.addItem(
                ...
                new WeightedRandomChestContent(ModItems.BEETROOT_SEEDS.newItemStack(), 1, 2, 5));
            ChestGenHooks.addItem(
    ...
    private static void tweakRecipes() {
        ...
        if (ConfigFunctions.enableDoorRecipeBuffs && !ModsList.GTNH.isLoaded()) {
            ...
            GameRegistry.addRecipe(
                new ShapedOreRecipe(new ItemStack(Items.wooden_door, 3), "xx", "xx", "xx", 'x', "plankWood"));
            removeFirstRecipeFor(Items.iron_door);
            GameRegistry
                .addRecipe(new ShapedOreRecipe(new ItemStack(Items.iron_door, 3), "xx", "xx", "xx", 'x', "ingotIron"));
        }
        ...
        if (ConfigFunctions.fireworkRecipeFixes) {
            for (int i = 0; i < CraftingManager.getInstance()
                .getRecipeList()
                .size(); i++) {
                Object recipe = CraftingManager.getInstance()
                    .getRecipeList()
                    .get(i);
                if (recipe != null && recipe.getClass() == RecipeFireworks.class) {
                    ...
                    CraftingManager.getInstance()
                        .getRecipeList()
                        .add(i, new RecipeFixedFireworks());
                    break;
                }
            }
        }
    ...
    private static void registerOreDictionary() {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            if (i == 0 || (i == 1 && ConfigBlocksItems.enableStrippedLogs)
        ...
        if (ConfigBlocksItems.enableColourfulBeacons && ModsList.TINKERS_CONSTRUCT.isLoaded()) { // TCon lacks proper
                                                                                                 // tagging for their
                                                                                                 // glass; let's add the
                                                                                                 // right tags so
                                                                                                 // beacons can see it
        ...
        if (ConfigFunctions.registerRawItemAsOre) {
            registerOre("oreCopper", ModItems.RAW_ORE.newItemStack()); // Todo: the registration of copper raw ore
                                                                       // should be conditional because it is a
                                                                       // configurable meta value, I may make the raw
                                                                       // ore class itself provide enabled metas.
    ...
    private static void registerRecipes() {
        if (!ModsList.GTNH.isLoaded()) {
            addShapedRecipe(
                ModBlocks.OLD_GRAVEL.newItemStack(4),
                "xy",
                "yx",
                'x',
                ModBlocks.COARSE_DIRT.get(),
                'y',
                Blocks.gravel);
        }
        ...
        if (ConfigFunctions.enableRecipeForTotem) {
            addShapedRecipe(
                ModItems.TOTEM_OF_UNDYING.newItemStack(),
                "EBE",
                "GBG",
                " G ",
                'E',
        ...
        if (!ModsList.GTNH.isLoaded()) {
            ...
            addShapedRecipe(
                ModBlocks.COARSE_DIRT.newItemStack(4),
                "xy",
                "yx",
                'x',
        ...
        // Diorite
        addShapedRecipe(
            ModBlocks.STONE.newItemStack(2, 3),
            "xy",
            "yx",
            'x',
            new ItemStack(Blocks.cobblestone),
        ...
        Block[] stone_stairs = new Block[] { ModBlocks.GRANITE_STAIRS.get(), ModBlocks.POLISHED_GRANITE_STAIRS.get(),
            ModBlocks.DIORITE_STAIRS.get(), ModBlocks.POLISHED_DIORITE_STAIRS.get(), ModBlocks.ANDESITE_STAIRS.get(),
            ModBlocks.POLISHED_ANDESITE_STAIRS.get() };
        for (int i = 0; i < stone_stairs.length; i++) { // TODO: Rewrite this, this seems needlessly convoluted
            String dictName = "stone"
                + StringUtils.capitalize(((BaseSlab) ModBlocks.STONE_SLAB_2.get()).types[(i / 2) * 2])
                + (i % 2 == 1 ? "Polished" : "");
            if (!ModsList.GTNH.isLoaded()) {
            ...
            if (i % 2 == 1) {
                addShapedRecipe(
                    ModBlocks.STONE_WALL_2.newItemStack(6, i == 5 ? 2 : i == 3 ? 1 : 0),
                    "xxx",
                    "xxx",
                    'x',
                    ModBlocks.STONE.newItemStack(1, i));
            }
        }
        ...
        addShapedRecipe(
            ModBlocks.PRISMARINE_BLOCK.newItemStack(1, 2),
            "xxx",
            "xyx",
            "xxx",
            'x',
            ...
            "dyeBlack");
        addShapedRecipe(
            ModBlocks.SEA_LANTERN.newItemStack(),
            "xyx",
            "yyy",
            "xyx",
            'x',
        ...
        addShapedRecipe(
            ModBlocks.PRISMARINE_STAIRS.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
            ModBlocks.PRISMARINE_BLOCK.newItemStack());
        addShapedRecipe(
            ModBlocks.PRISMARINE_STAIRS_BRICK.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
            ModBlocks.PRISMARINE_BLOCK.newItemStack(1, 1));
        addShapedRecipe(
            ModBlocks.PRISMARINE_STAIRS_DARK.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
            ModBlocks.PRISMARINE_BLOCK.newItemStack(1, 2));
        addShapedRecipe(
            ModBlocks.PRISMARINE_WALL.newItemStack(6),
            "xxx",
            "xxx",
            'x',
            ModBlocks.PRISMARINE_BLOCK.newItemStack());
        ...
        for (int i = 0; i < 3; i++) {
            addShapedRecipe(
                ModBlocks.PRISMARINE_SLAB.newItemStack(6, i),
                "xxx",
                'x',
                ModBlocks.PRISMARINE_BLOCK.newItemStack(1, i));
        }

        if (!ModsList.BOTANIA.isLoaded()) {
            addShapedRecipe(
                ModItems.PRISMARINE_SHARD.newItemStack(4),
                "xy",
                "zx",
                'x',
                "gemQuartz",
                ...
                "dyeGreen");
            addShapedRecipe(
                ModItems.PRISMARINE_CRYSTALS.newItemStack(4),
                "xy",
                "yx",
                'x',
                "gemQuartz",
        ...
        if (!ModsList.GTNH.isLoaded()) {
            Block[] metaBlocks = new Block[] { Blocks.stone, Blocks.mossy_cobblestone, Blocks.stonebrick,
                Blocks.sandstone };
            for (int i = 0; i < metaBlocks.length; i++) {
                addShapedRecipe(
                    ModBlocks.STONE_SLAB.newItemStack(6, i),
                    "xxx",
                    'x',
                    new ItemStack(metaBlocks[i], 1, i != 0 ? i - 1 : i));
            }
            addShapedRecipe(new ItemStack(Blocks.stone_slab, 6, 0), "xxx", 'x', ModBlocks.SMOOTH_STONE.newItemStack());
        }

        addShapedRecipe(
            ModBlocks.STONE_STAIRS.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
        ...
        addShapedRecipe(
            ModBlocks.MOSSY_COBBLESTONE_STAIRS.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
        ...
        addShapedRecipe(
            ModBlocks.MOSSY_STONE_BRICK_STAIRS.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
        ...
        addShapedRecipe(
            ModBlocks.WOOD_STRIPPED.newItemStack(3),
            "xx",
            "xx",
            'x',
            ModBlocks.LOG_STRIPPED.newItemStack(1));
        addShapedRecipe(
            ModBlocks.WOOD_STRIPPED.newItemStack(3, 1),
            "xx",
            "xx",
            'x',
            ModBlocks.LOG_STRIPPED.newItemStack(1, 1));
        addShapedRecipe(
            ModBlocks.WOOD_STRIPPED.newItemStack(3, 2),
            "xx",
            "xx",
            'x',
            ModBlocks.LOG_STRIPPED.newItemStack(1, 2));
        addShapedRecipe(
            ModBlocks.WOOD_STRIPPED.newItemStack(3, 3),
            "xx",
            "xx",
            'x',
            ModBlocks.LOG_STRIPPED.newItemStack(1, 3));
        addShapedRecipe(
            ModBlocks.WOOD2_STRIPPED.newItemStack(3),
            "xx",
            "xx",
            'x',
            ModBlocks.LOG2_STRIPPED.newItemStack(1));
        addShapedRecipe(
            ModBlocks.WOOD2_STRIPPED.newItemStack(3, 1),
            "xx",
            "xx",
            'x',
            ModBlocks.LOG2_STRIPPED.newItemStack(1, 1));

        if (!ModsList.GTNH.isLoaded()) {
            // New logs, bark, stripped log and stripped bark to planks
            addShapedRecipe(
                ModBlocks.WOOD_PLANKS.newItemStack(4),
                "x",
                'x',
                ModBlocks.CRIMSON_STEM.newItemStack(1, OreDictionary.WILDCARD_VALUE));
            addShapedRecipe(
                ModBlocks.WOOD_PLANKS.newItemStack(4, 1),
                "x",
                'x',
                ModBlocks.WARPED_STEM.newItemStack(1, OreDictionary.WILDCARD_VALUE));
            addShapedRecipe(
                ModBlocks.WOOD_PLANKS.newItemStack(4, 2),
                "x",
                'x',
                ModBlocks.MANGROVE_LOG.newItemStack(1, OreDictionary.WILDCARD_VALUE));
            addShapedRecipe(
                ModBlocks.WOOD_PLANKS.newItemStack(4, 3),
                "x",
                'x',
                ModBlocks.CHERRY_LOG.newItemStack(1, OreDictionary.WILDCARD_VALUE));
            addShapedRecipe(
                ModBlocks.WOOD_PLANKS.newItemStack(2, 4),
                "x",
                'x',
                ModBlocks.BAMBOO_BLOCK.newItemStack(1, OreDictionary.WILDCARD_VALUE));
        }

        if (ConfigBlocksItems.enableStrippedLogs && ConfigBlocksItems.enableBarkLogs) {
            // New stripped logs to new stripped bark
            addShapedRecipe(
                ModBlocks.CRIMSON_STEM.newItemStack(3, 3),
                "xx",
                "xx",
                'x',
                ModBlocks.CRIMSON_STEM.newItemStack(2, 2));
            addShapedRecipe(
                ModBlocks.WARPED_STEM.newItemStack(3, 3),
                "xx",
                "xx",
                'x',
                ModBlocks.WARPED_STEM.newItemStack(2, 2));
            addShapedRecipe(
                ModBlocks.MANGROVE_LOG.newItemStack(3, 3),
                "xx",
                "xx",
                'x',
                ModBlocks.MANGROVE_LOG.newItemStack(2, 2));
            addShapedRecipe(
                ModBlocks.CHERRY_LOG.newItemStack(3, 3),
                "xx",
                "xx",
                'x',
                ModBlocks.CHERRY_LOG.newItemStack(2, 2));
        }

        if (ConfigBlocksItems.enableBarkLogs) {
            // New logs to new bark
            addShapedRecipe(
                ModBlocks.CRIMSON_STEM.newItemStack(3, 1),
                "xx",
                "xx",
                'x',
                ModBlocks.CRIMSON_STEM.newItemStack(1));
            addShapedRecipe(
                ModBlocks.WARPED_STEM.newItemStack(3, 1),
                "xx",
                "xx",
                'x',
                ModBlocks.WARPED_STEM.newItemStack(1));
            addShapedRecipe(
                ModBlocks.MANGROVE_LOG.newItemStack(3, 1),
                "xx",
                "xx",
                'x',
                ModBlocks.MANGROVE_LOG.newItemStack(1));
            addShapedRecipe(
                ModBlocks.CHERRY_LOG.newItemStack(3, 1),
                "xx",
                "xx",
                'x',
                ModBlocks.CHERRY_LOG.newItemStack(1));
        }

        if (!ModsList.GTNH.isLoaded()) {
            addShapedRecipe(
                ModBlocks.FENCE_SPRUCE.newItemStack(3),
                "xyx",
                "xyx",
                'x',
                ...
                "stickWood");
            addShapedRecipe(
                ModBlocks.FENCE_BIRCH.newItemStack(3),
                "xyx",
                "xyx",
                'x',
                ...
                "stickWood");
            addShapedRecipe(
                ModBlocks.FENCE_JUNGLE.newItemStack(3),
                "xyx",
                "xyx",
                'x',
                ...
                "stickWood");
            addShapedRecipe(
                ModBlocks.FENCE_ACACIA.newItemStack(3),
                "xyx",
                "xyx",
                'x',
                ...
                "stickWood");
            addShapedRecipe(
                ModBlocks.FENCE_DARK_OAK.newItemStack(3),
                "xyx",
                "xyx",
                'x',
            ...
            if (ConfigExperiments.enableCrimsonBlocks) {
                addShapedRecipe(
                    ModBlocks.WOOD_FENCE.newItemStack(3),
                    "xyx",
                    "xyx",
                    'x',
                    ModBlocks.WOOD_PLANKS.newItemStack(1),
                    'y',
                    "stickWood");
                addShapedRecipe(
                    ModBlocks.WOOD_SLAB.newItemStack(6, 0),
                    "xxx",
                    'x',
                    ModBlocks.WOOD_PLANKS.newItemStack(1, 0));
            }
            if (ConfigExperiments.enableWarpedBlocks) {
                addShapedRecipe(
                    ModBlocks.WOOD_FENCE.newItemStack(3, 1),
                    "xyx",
                    "xyx",
                    'x',
                    ModBlocks.WOOD_PLANKS.newItemStack(1, 1),
                    'y',
                    "stickWood");
                addShapedRecipe(
                    ModBlocks.WOOD_SLAB.newItemStack(6, 1),
                    "xxx",
                    'x',
                    ModBlocks.WOOD_PLANKS.newItemStack(1, 1));
            }
            if (ConfigExperiments.enableMangroveBlocks) {
                addShapedRecipe(
                    ModBlocks.WOOD_FENCE.newItemStack(3, 2),
                    "xyx",
                    "xyx",
                    'x',
                    ModBlocks.WOOD_PLANKS.newItemStack(1, 2),
                    'y',
                    "stickWood");
                addShapedRecipe(
                    ModBlocks.WOOD_SLAB.newItemStack(6, 2),
                    "xxx",
                    'x',
                    ModBlocks.WOOD_PLANKS.newItemStack(1, 2));
            }
            if (ConfigBlocksItems.enableCherryBlocks) {
                addShapedRecipe(
                    ModBlocks.WOOD_FENCE.newItemStack(3, 3),
                    "xyx",
                    "xyx",
                    'x',
                    ModBlocks.WOOD_PLANKS.newItemStack(1, 3),
                    'y',
                    "stickWood");
                addShapedRecipe(
                    ModBlocks.WOOD_SLAB.newItemStack(6, 3),
                    "xxx",
                    'x',
                    ModBlocks.WOOD_PLANKS.newItemStack(1, 3));
            }
            if (ConfigBlocksItems.enableBambooBlocks) {
                addShapedRecipe(
                    ModBlocks.WOOD_FENCE.newItemStack(3, 4),
                    "xyx",
                    "xyx",
                    'x',
                    ModBlocks.WOOD_PLANKS.newItemStack(1, 4),
                    'y',
                    "stickWood");
                addShapedRecipe(
                    ModBlocks.WOOD_SLAB.newItemStack(6, 4),
                    "xxx",
                    'x',
                    ModBlocks.WOOD_PLANKS.newItemStack(1, 4));
            }
        ...
        addShapedRecipe(
            ModBlocks.CRIMSON_STAIRS.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
            ModBlocks.WOOD_PLANKS.newItemStack(1, 0));
        addShapedRecipe(
            ModBlocks.WARPED_STAIRS.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
            ModBlocks.WOOD_PLANKS.newItemStack(1, 1));
        addShapedRecipe(
            ModBlocks.MANGROVE_STAIRS.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
            ModBlocks.WOOD_PLANKS.newItemStack(1, 2));
        addShapedRecipe(
            ModBlocks.CHERRY_STAIRS.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
            ModBlocks.WOOD_PLANKS.newItemStack(1, 3));
        addShapedRecipe(
            ModBlocks.BAMBOO_STAIRS.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
        ...
        addShapedRecipe(
            ModBlocks.BAMBOO_BLOCK.newItemStack(),
            "bbb",
            "bbb",
            "bbb",
            'b',
            ModItems.BAMBOO.newItemStack());
        addShapedRecipe(new ItemStack(Items.stick), "b", "b", 'b', ModItems.BAMBOO.newItemStack());

        // Bamboo Mosaic
        addShapedRecipe(
            ModBlocks.BAMBOO_MOSAIC.newItemStack(1, 0),
            "x",
            "x",
            'x',
            ModBlocks.WOOD_SLAB.newItemStack(1, 4));
        addShapedRecipe(
            ModBlocks.BAMBOO_MOSAIC_SLAB.newItemStack(6, 5),
            "xxx",
            'x',
            ModBlocks.BAMBOO_MOSAIC.newItemStack(1, 0));
        addShapedRecipe(
            ModBlocks.BAMBOO_MOSAIC_STAIRS.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
        ...
        addShapedRecipe(
            ModBlocks.FENCE_GATE_SPRUCE.newItemStack(),
            "yxy",
            "yxy",
            'x',
            new ItemStack(Blocks.planks, 1, 1),
            ...
            "stickWood");
        addShapedRecipe(
            ModBlocks.FENCE_GATE_BIRCH.newItemStack(),
            "yxy",
            "yxy",
            'x',
            new ItemStack(Blocks.planks, 1, 2),
            ...
            "stickWood");
        addShapedRecipe(
            ModBlocks.FENCE_GATE_JUNGLE.newItemStack(),
            "yxy",
            "yxy",
            'x',
            new ItemStack(Blocks.planks, 1, 3),
            ...
            "stickWood");
        addShapedRecipe(
            ModBlocks.FENCE_GATE_ACACIA.newItemStack(),
            "yxy",
            "yxy",
            'x',
            new ItemStack(Blocks.planks, 1, 4),
            ...
            "stickWood");
        addShapedRecipe(
            ModBlocks.FENCE_GATE_DARK_OAK.newItemStack(),
            "yxy",
            "yxy",
            'x',
            new ItemStack(Blocks.planks, 1, 5),
        ...
        addShapedRecipe(
            ModBlocks.CRIMSON_FENCE_GATE.newItemStack(),
            "yxy",
            "yxy",
            'x',
            ModBlocks.WOOD_PLANKS.newItemStack(1),
            ...
            "stickWood");
        addShapedRecipe(
            ModBlocks.WARPED_FENCE_GATE.newItemStack(),
            "yxy",
            "yxy",
            'x',
            ModBlocks.WOOD_PLANKS.newItemStack(1, 1),
            ...
            "stickWood");
        addShapedRecipe(
            ModBlocks.MANGROVE_FENCE_GATE.newItemStack(),
            "yxy",
            "yxy",
            'x',
            ModBlocks.WOOD_PLANKS.newItemStack(1, 2),
            ...
            "stickWood");
        addShapedRecipe(
            ModBlocks.CHERRY_FENCE_GATE.newItemStack(),
            "yxy",
            "yxy",
            'x',
            ModBlocks.WOOD_PLANKS.newItemStack(1, 3),
            ...
            "stickWood");
        addShapedRecipe(
            ModBlocks.BAMBOO_FENCE_GATE.newItemStack(),
            "yxy",
            "yxy",
            'x',
            ModBlocks.WOOD_PLANKS.newItemStack(1, 4),
        ...
        addShapedRecipe(
            ModBlocks.DOOR_SPRUCE.newItemStack(output),
            "xx",
            "xx",
            "xx",
            'x',
            new ItemStack(Blocks.planks, 1, 1));
        addShapedRecipe(
            ModBlocks.DOOR_BIRCH.newItemStack(output),
            "xx",
            "xx",
            "xx",
            'x',
            new ItemStack(Blocks.planks, 1, 2));
        addShapedRecipe(
            ModBlocks.DOOR_JUNGLE.newItemStack(output),
            "xx",
            "xx",
            "xx",
            'x',
            new ItemStack(Blocks.planks, 1, 3));
        addShapedRecipe(
            ModBlocks.DOOR_ACACIA.newItemStack(output),
            "xx",
            "xx",
            "xx",
            'x',
            new ItemStack(Blocks.planks, 1, 4));
        addShapedRecipe(
            ModBlocks.DOOR_DARK_OAK.newItemStack(output),
            "xx",
            "xx",
            "xx",
            'x',
        ...
        addShapedRecipe(
            ModBlocks.CRIMSON_DOOR.newItemStack(output),
            "xx",
            "xx",
            "xx",
            'x',
            ModBlocks.WOOD_PLANKS.newItemStack(1));
        addShapedRecipe(
            ModBlocks.WARPED_DOOR.newItemStack(output),
            "xx",
            "xx",
            "xx",
            'x',
            ModBlocks.WOOD_PLANKS.newItemStack(1, 1));
        addShapedRecipe(
            ModBlocks.MANGROVE_DOOR.newItemStack(output),
            "xx",
            "xx",
            "xx",
            'x',
            ModBlocks.WOOD_PLANKS.newItemStack(1, 2));
        addShapedRecipe(
            ModBlocks.CHERRY_DOOR.newItemStack(output),
            "xx",
            "xx",
            "xx",
            'x',
            ModBlocks.WOOD_PLANKS.newItemStack(1, 3));
        addShapedRecipe(
            ModBlocks.BAMBOO_DOOR.newItemStack(output),
            "xx",
            "xx",
            "xx",
            'x',
        ...
        addShapedRecipe(
            ModBlocks.TRAPDOOR_SPRUCE.newItemStack(2),
            "xxx",
            "xxx",
            'x',
            new ItemStack(Blocks.planks, 1, 1));
        addShapedRecipe(
            ModBlocks.TRAPDOOR_BIRCH.newItemStack(2),
            "xxx",
            "xxx",
            'x',
            new ItemStack(Blocks.planks, 1, 2));
        addShapedRecipe(
            ModBlocks.TRAPDOOR_JUNGLE.newItemStack(2),
            "xxx",
            "xxx",
            'x',
            new ItemStack(Blocks.planks, 1, 3));
        addShapedRecipe(
            ModBlocks.TRAPDOOR_ACACIA.newItemStack(2),
            "xxx",
            "xxx",
            'x',
            new ItemStack(Blocks.planks, 1, 4));
        addShapedRecipe(
            ModBlocks.TRAPDOOR_DARK_OAK.newItemStack(2),
            "xxx",
            "xxx",
            'x',
            new ItemStack(Blocks.planks, 1, 5));
        ...
        addShapedRecipe(
            ModBlocks.CRIMSON_TRAPDOOR.newItemStack(2),
            "xxx",
            "xxx",
            'x',
            ModBlocks.WOOD_PLANKS.newItemStack(1));
        addShapedRecipe(
            ModBlocks.WARPED_TRAPDOOR.newItemStack(2),
            "xxx",
            "xxx",
            'x',
            ModBlocks.WOOD_PLANKS.newItemStack(1, 1));
        addShapedRecipe(
            ModBlocks.MANGROVE_TRAPDOOR.newItemStack(2),
            "xxx",
            "xxx",
            'x',
            ModBlocks.WOOD_PLANKS.newItemStack(1, 2));
        addShapedRecipe(
            ModBlocks.CHERRY_TRAPDOOR.newItemStack(2),
            "xxx",
            "xxx",
            'x',
            ModBlocks.WOOD_PLANKS.newItemStack(1, 3));
        addShapedRecipe(
            ModBlocks.BAMBOO_TRAPDOOR.newItemStack(2),
            "xxx",
            "xxx",
            'x',
            ModBlocks.WOOD_PLANKS.newItemStack(1, 4));
        ...
        if (!ModsList.GTNH.isLoaded()) {
            ...
            addShapedRecipe(
                ModBlocks.MANGROVE_BUTTON.newItemStack(),
                "x",
                'x',
                ModBlocks.WOOD_PLANKS.newItemStack(1, 2));
            ...
            addShapedRecipe(
                ModBlocks.PRESSURE_PLATE_SPRUCE.newItemStack(),
                "xx",
                'x',
                new ItemStack(Blocks.planks, 1, 1));
            addShapedRecipe(
                ModBlocks.PRESSURE_PLATE_BIRCH.newItemStack(),
                "xx",
                'x',
                new ItemStack(Blocks.planks, 1, 2));
            addShapedRecipe(
                ModBlocks.PRESSURE_PLATE_JUNGLE.newItemStack(),
                "xx",
                'x',
                new ItemStack(Blocks.planks, 1, 3));
            addShapedRecipe(
                ModBlocks.PRESSURE_PLATE_ACACIA.newItemStack(),
                "xx",
                'x',
                new ItemStack(Blocks.planks, 1, 4));
            addShapedRecipe(
                ModBlocks.PRESSURE_PLATE_DARK_OAK.newItemStack(),
                "xx",
                'x',
                new ItemStack(Blocks.planks, 1, 5));

            addShapedRecipe(
                ModBlocks.CRIMSON_PRESSURE_PLATE.newItemStack(),
                "xx",
                'x',
                ModBlocks.WOOD_PLANKS.newItemStack(1));
            addShapedRecipe(
                ModBlocks.WARPED_PRESSURE_PLATE.newItemStack(),
                "xx",
                'x',
                ModBlocks.WOOD_PLANKS.newItemStack(1, 1));
            addShapedRecipe(
                ModBlocks.MANGROVE_PRESSURE_PLATE.newItemStack(),
                "xx",
                'x',
                ModBlocks.WOOD_PLANKS.newItemStack(1, 2));
            addShapedRecipe(
                ModBlocks.CHERRY_PRESSURE_PLATE.newItemStack(),
                "xx",
                'x',
                ModBlocks.WOOD_PLANKS.newItemStack(1, 3));
            addShapedRecipe(
                ModBlocks.BAMBOO_PRESSURE_PLATE.newItemStack(),
                "xx",
                'x',
                ModBlocks.WOOD_PLANKS.newItemStack(1, 4));

            addShapedRecipe(
                ModItems.ITEM_SIGN_SPRUCE.newItemStack(3),
                "xxx",
                "xxx",
                " y ",
                'x',
                ...
                "stickWood");
            addShapedRecipe(
                ModItems.ITEM_SIGN_BIRCH.newItemStack(3),
                "xxx",
                "xxx",
                " y ",
                'x',
                ...
                "stickWood");
            addShapedRecipe(
                ModItems.ITEM_SIGN_JUNGLE.newItemStack(3),
                "xxx",
                "xxx",
                " y ",
                'x',
                ...
                "stickWood");
            addShapedRecipe(
                ModItems.ITEM_SIGN_ACACIA.newItemStack(3),
                "xxx",
                "xxx",
                " y ",
                'x',
                ...
                "stickWood");
            addShapedRecipe(
                ModItems.ITEM_SIGN_DARK_OAK.newItemStack(3),
                "xxx",
                "xxx",
                " y ",
                'x',
            ...
            addShapedRecipe(
                ModBlocks.CRIMSON_SIGN.newItemStack(3),
                "xxx",
                "xxx",
                " y ",
                'x',
                ...
                "stickWood");
            addShapedRecipe(
                ModBlocks.WARPED_SIGN.newItemStack(3),
                "xxx",
                "xxx",
                " y ",
                'x',
                ...
                "stickWood");
            addShapedRecipe(
                ModBlocks.MANGROVE_SIGN.newItemStack(3),
                "xxx",
                "xxx",
                " y ",
                'x',
                ...
                "stickWood");
            addShapedRecipe(
                ModBlocks.CHERRY_SIGN.newItemStack(3),
                "xxx",
                "xxx",
                " y ",
                'x',
                ...
                "stickWood");
            addShapedRecipe(
                ModBlocks.BAMBOO_SIGN.newItemStack(3),
                "xxx",
                "xxx",
                " y ",
                'x',
        ...
        if (!ModsList.GTNH.isLoaded()) {
            ...
            addShapedRecipe(
                ModBlocks.RED_SANDSTONE_SLAB.newItemStack(6, 1),
                "xxx",
                'x',
                ModBlocks.RED_SANDSTONE.newItemStack(1, 2));
            addShapedRecipe(
                ModBlocks.RED_SANDSTONE_SLAB.newItemStack(6),
                "xxx",
                'x',
                ModBlocks.RED_SANDSTONE.newItemStack(1, OreDictionary.WILDCARD_VALUE));
        }
        addShapedRecipe(
            ModBlocks.RED_SANDSTONE.newItemStack(1, 1),
            "x",
            "x",
            'x',
            ModBlocks.RED_SANDSTONE_SLAB.newItemStack());
        addShapedRecipe(
            ModBlocks.RED_SANDSTONE.newItemStack(4, 2),
            "xx",
            "xx",
            'x',
            ModBlocks.RED_SANDSTONE.newItemStack());
        addShapedRecipe(
            ModBlocks.RED_SANDSTONE_STAIRS.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
        ...
        addShapedRecipe(
            ModBlocks.RED_SANDSTONE_WALL.newItemStack(6),
            "xxx",
            "xxx",
            'x',
            ModBlocks.RED_SANDSTONE.newItemStack());
        ...
        if (ConfigBlocksItems.enableVanillaFences && !ModsList.GTNH.isLoaded()) {
            GameRegistry.addRecipe(
                new ShapedOreRecipe(new ItemStack(Blocks.fence, 3), "xyx", "xyx", 'x', "plankWood", 'y', "stickWood"));
            GameRegistry.addRecipe(
                new ShapedOreRecipe(
        ...
        for (EnumColor colour : EnumColor.VALUES) {
            addShapedRecipe(
                ModBlocks.BANNER.newItemStack(1, colour.getDamage()),
                "xxx",
                "xxx",
                " y ",
                'x',
                new ItemStack(Blocks.wool, 1, colour.getDamage()),
                'y',
                "stickWood");
        }
        ...
        addShapedRecipe(
            ModItems.WOODEN_ARMORSTAND.newItemStack(),
            "xxx",
            " x ",
            "xyx",
            'x',
        ...
        addShapedRecipe(
            ModItems.RABBIT_STEW.newItemStack(),
            " R ",
            "CPM",
            " B ",
            'R',
            ModItems.RABBIT_COOKED.newItemStack(),
            'C',
            Items.carrot,
            'P',
            Items.baked_potato,
        ...
        addSmelting(
            ModBlocks.SPONGE.newItemStack(1, 1),
            ConfigWorld.tileReplacementMode == -1 ? ModBlocks.SPONGE.newItemStack() : new ItemStack(Blocks.sponge),
            0.15F);

        addShapedRecipe(
            ModItems.BEETROOT_SOUP.newItemStack(),
            "xxx",
            "xxx",
            " y ",
            'x',
        ...
        addShapedRecipe(
            ModBlocks.END_BRICK_STAIRS.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
            ModBlocks.END_BRICKS.get());
        addShapedRecipe(
            ModBlocks.END_BRICK_WALL.newItemStack(6),
            "xxx",
            "xxx",
            'x',
            ModBlocks.END_BRICKS.newItemStack());

        addShapedRecipe(ModBlocks.PURPUR_BLOCK.newItemStack(4), "xx", "xx", 'x', ModItems.CHORUS_FRUIT_POPPED.get());
        addShapedRecipe(
            ModBlocks.PURPUR_STAIRS.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
            ModBlocks.PURPUR_BLOCK.get());
        if (!ModsList.GTNH.isLoaded()) {
        ...
        addShapedRecipe(
            ModBlocks.END_ROD.newItemStack(),
            "x",
            "y",
            'x',
            Items.blaze_rod,
            'y',
            ModItems.CHORUS_FRUIT_POPPED.get());

        addShapelessRecipe(
            ModItems.DRAGON_BREATH.newItemStack(),
            new ItemStack(Items.potionitem, 1, 8195),
            ModItems.CHORUS_FRUIT.get(),
            ModItems.CHORUS_FRUIT.get());
        ...
        if (ModItems.TIPPED_ARROW.isEnabled() && ModItems.LINGERING_POTION.isEnabled()) {
            RecipeSorter.register(
                Reference.MOD_ID + ".RecipeTippedArrow",
                RecipeTippedArrow.class,
                Category.SHAPED,
                "after:minecraft:shaped");
            GameRegistry.addRecipe(
                new RecipeTippedArrow(
                    ModItems.TIPPED_ARROW.newItemStack(),
                    "xxx",
                    "xyx",
                    "xxx",
                    'x',
                    Items.arrow,
                    'y',
                    ModItems.LINGERING_POTION.newItemStack(1, OreDictionary.WILDCARD_VALUE)));
        }
        ...
        if (!ModsList.GTNH.isLoaded()) {
            for (int i = 0; i < ModBlocks.BEDS.length; i++) {
                int j = i == 14 ? 15 : i;
                addShapedRecipe(
                    ModBlocks.BEDS[i].newItemStack(1),
                    "###",
                    "XXX",
                    '#',
        ...
        if (!ModsList.GTNH.isLoaded()) {
            addShapedRecipe(
                ModBlocks.RED_NETHERBRICK.newItemStack(),
                "xi",
                "ix",
                'x',
                Items.nether_wart,
                ...
                "ingotBrickNether");
            addShapedRecipe(
                ModBlocks.RED_NETHERBRICK.newItemStack(1, 2),
                "x",
                "x",
                'x',
            ...
            addShapedRecipe(
                ModBlocks.RED_NETHERBRICK_SLAB.newItemStack(6),
                "xxx",
                'x',
                ModBlocks.RED_NETHERBRICK.newItemStack());
        }
        addShapedRecipe(
            ModBlocks.RED_NETHERBRICK_STAIRS.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
            ModBlocks.RED_NETHERBRICK.newItemStack());
        addShapedRecipe(
            ModBlocks.RED_NETHER_BRICK_WALL.newItemStack(6),
            "xxx",
            "xxx",
            'x',
            ModBlocks.RED_NETHERBRICK.newItemStack());
        ...
        if (!ModsList.GTNH.isLoaded()) {
            for (int i = 0; i < ore_dyes.length; i++) {
                int dye = ~i & 15;
                addShapelessRecipe(
                    ModBlocks.CONCRETE_POWDER.newItemStack(8, i),
                    ore_dyes[dye],
                ...
                addSmelting(
                    ...
                    ModBlocks.TERRACOTTA[i].newItemStack(),
                    0.1F);
            }
        }
        ...
        if (!ModsList.GTNH.isLoaded()) {
            if (!OreDictionary.getOres("nuggetIron")
                .isEmpty()) {
                addShapedRecipe(
                    ModBlocks.LANTERN.newItemStack(),
                    "xxx",
                    "xix",
                    "xxx",
                    'x',
                    ...
                    Blocks.torch);
                addShapedRecipe(
                    ModBlocks.SOUL_LANTERN.newItemStack(),
                    "xxx",
                    "xix",
                    "xxx",
                    'x',
        ...
        addShapedRecipe(
            ModBlocks.SOUL_TORCH.newItemStack(4),
            "i",
            "x",
            "s",
            'x',
        ...
        addShapedRecipe(
            ModBlocks.BLAST_FURNACE.newItemStack(),
            "iii",
            "ixi",
            "sss",
            'x',
            ...
            "ingotIron",
            's',
            ConfigBlocksItems.enableSmoothStone ? ModBlocks.SMOOTH_STONE.get() : Blocks.stone);

        addSmelting(ModBlocks.ANCIENT_DEBRIS.get(), ModItems.NETHERITE_SCRAP.newItemStack(), 2F);
        addShapelessRecipe(
            ModItems.NETHERITE_INGOT.newItemStack(),
            ModItems.NETHERITE_SCRAP.newItemStack(),
            ModItems.NETHERITE_SCRAP.newItemStack(),
            ModItems.NETHERITE_SCRAP.newItemStack(),
            ModItems.NETHERITE_SCRAP.newItemStack(),
            "ingotGold",
        ...
        if (!ModsList.GTNH.isLoaded()) {
            addShapedRecipe(
                ModBlocks.NETHERITE_BLOCK.newItemStack(),
                "xxx",
                "xxx",
                "xxx",
                'x',
                ModItems.NETHERITE_INGOT.get());
        }
        ...
        if (!ModsList.GTNH.isLoaded()) {
            ...
            if (ModBlocks.SMOOTH_STONE.isEnabled()) {
                ItemStack stoneTile = ExternalContent.Items.BLUEPOWER_CIRCUIT_PLATE.isEnabled()
                    ? ExternalContent.Items.BLUEPOWER_CIRCUIT_PLATE.newItemStack(2)
                    : ExternalContent.Items.PROJECTRED_CIRCUIT_PLATE.isEnabled()
                        ? ExternalContent.Items.PROJECTRED_CIRCUIT_PLATE.newItemStack(2)
                        : null;
                if (stoneTile != null) {
            ...
            addShapedRecipe(
                ModBlocks.SMOOTH_SANDSTONE_SLAB.newItemStack(6),
                "xxx",
                'x',
                ModBlocks.SMOOTH_SANDSTONE.newItemStack());
            addSmelting(ModBlocks.RED_SANDSTONE.newItemStack(), ModBlocks.SMOOTH_RED_SANDSTONE.newItemStack(), .1F);
            addShapedRecipe(
                ModBlocks.SMOOTH_RED_SANDSTONE_SLAB.newItemStack(6),
                "xxx",
                'x',
                ModBlocks.SMOOTH_RED_SANDSTONE.newItemStack());
        }
        addShapedRecipe(
            ModBlocks.SMOOTH_SANDSTONE_STAIRS.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
            ModBlocks.SMOOTH_SANDSTONE.newItemStack());
        addShapedRecipe(
            ModBlocks.SMOOTH_RED_SANDSTONE_STAIRS.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
        ...
        if (!ModsList.GTNH.isLoaded()) {
            ...
            addShapedRecipe(
                ModBlocks.SMOOTH_QUARTZ_SLAB.newItemStack(6),
                "xxx",
                'x',
                ModBlocks.SMOOTH_QUARTZ.newItemStack());
        }
        addShapedRecipe(
            ModBlocks.SMOOTH_QUARTZ_STAIRS.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
        ...
        addShapedRecipe(
            ModBlocks.QUARTZ_BRICKS.newItemStack(4),
            "xx",
            "xx",
            'x',
        ...
        if (!ModsList.GTNH.isLoaded()) {
            addShapedRecipe(
                ModBlocks.COPPER_BLOCK.newItemStack(1),
                "xxx",
                "xxx",
                "xxx",
                'x',
                ModItems.COPPER_INGOT.newItemStack());
        ...
        addShapedRecipe(
            ModBlocks.COPPER_BLOCK.newItemStack(4, 4),
            "xx",
            "xx",
            'x',
            ModBlocks.COPPER_BLOCK.newItemStack());
        addShapedRecipe(
            ModBlocks.COPPER_BLOCK.newItemStack(4, 5),
            "xx",
            "xx",
            'x',
            ModBlocks.COPPER_BLOCK.newItemStack(1, 1));
        addShapedRecipe(
            ModBlocks.COPPER_BLOCK.newItemStack(4, 6),
            "xx",
            "xx",
            'x',
            ModBlocks.COPPER_BLOCK.newItemStack(1, 2));
        addShapedRecipe(
            ModBlocks.COPPER_BLOCK.newItemStack(4, 7),
            "xx",
            "xx",
            'x',
            ModBlocks.COPPER_BLOCK.newItemStack(1, 3));

        // Waxed copper block to waxed cut copper block
        addShapedRecipe(
            ModBlocks.COPPER_BLOCK.newItemStack(4, 12),
            "xx",
            "xx",
            'x',
            ModBlocks.COPPER_BLOCK.newItemStack(1, 8));
        addShapedRecipe(
            ModBlocks.COPPER_BLOCK.newItemStack(4, 13),
            "xx",
            "xx",
            'x',
            ModBlocks.COPPER_BLOCK.newItemStack(1, 9));
        addShapedRecipe(
            ModBlocks.COPPER_BLOCK.newItemStack(4, 14),
            "xx",
            "xx",
            'x',
            ModBlocks.COPPER_BLOCK.newItemStack(1, 10));
        addShapedRecipe(
            ModBlocks.COPPER_BLOCK.newItemStack(4, 15),
            "xx",
            "xx",
            'x',
            ModBlocks.COPPER_BLOCK.newItemStack(1, 11));

        // Copper block to copper grate
        addShapedRecipe(
            ModBlocks.COPPER_GRATE.newItemStack(4),
            " x ",
            "x x",
            " x ",
            'x',
            ModBlocks.COPPER_BLOCK.newItemStack());
        addShapedRecipe(
            ModBlocks.COPPER_GRATE.newItemStack(4, 1),
            " x ",
            "x x",
            " x ",
            'x',
            ModBlocks.COPPER_BLOCK.newItemStack(1, 1));
        addShapedRecipe(
            ModBlocks.COPPER_GRATE.newItemStack(4, 2),
            " x ",
            "x x",
            " x ",
            'x',
            ModBlocks.COPPER_BLOCK.newItemStack(1, 2));
        addShapedRecipe(
            ModBlocks.COPPER_GRATE.newItemStack(4, 3),
            " x ",
            "x x",
            " x ",
            'x',
        ...
        addShapedRecipe(
            ModBlocks.COPPER_GRATE.newItemStack(4, 4),
            " x ",
            "x x",
            " x ",
            'x',
            ModBlocks.COPPER_BLOCK.newItemStack(1, 8));
        addShapedRecipe(
            ModBlocks.COPPER_GRATE.newItemStack(4, 5),
            " x ",
            "x x",
            " x ",
            'x',
            ModBlocks.COPPER_BLOCK.newItemStack(1, 9));
        addShapedRecipe(
            ModBlocks.COPPER_GRATE.newItemStack(4, 6),
            " x ",
            "x x",
            " x ",
            'x',
            ModBlocks.COPPER_BLOCK.newItemStack(1, 10));
        addShapedRecipe(
            ModBlocks.COPPER_GRATE.newItemStack(4, 7),
            " x ",
            "x x",
            " x ",
            'x',
        ...
        // Copper block to copper grate
        addShapedRecipe(
            ModBlocks.COPPER_BULB.newItemStack(4),
            " x ",
            "xbx",
            " r ",
            'x',
            ...
            "dustRedstone");
        addShapedRecipe(
            ModBlocks.COPPER_BULB.newItemStack(4, 1),
            " x ",
            "xbx",
            " r ",
            'x',
            ...
            "dustRedstone");
        addShapedRecipe(
            ModBlocks.COPPER_BULB.newItemStack(4, 2),
            " x ",
            "xbx",
            " r ",
            'x',
            ...
            "dustRedstone");
        addShapedRecipe(
            ModBlocks.COPPER_BULB.newItemStack(4, 3),
            " x ",
            "xbx",
            " r ",
            'x',
        ...
        // Waxed copper block to waxed copper grate
        addShapedRecipe(
            ModBlocks.COPPER_BULB.newItemStack(4, 8),
            " x ",
            "xbx",
            " r ",
            'x',
            ...
            "dustRedstone");
        addShapedRecipe(
            ModBlocks.COPPER_BULB.newItemStack(4, 9),
            " x ",
            "xbx",
            " r ",
            'x',
            ...
            "dustRedstone");
        addShapedRecipe(
            ModBlocks.COPPER_BULB.newItemStack(4, 10),
            " x ",
            "xbx",
            " r ",
            'x',
            ...
            "dustRedstone");
        addShapedRecipe(
            ModBlocks.COPPER_BULB.newItemStack(4, 11),
            " x ",
            "xbx",
            " r ",
            'x',
        ...
        // Copper block to copper grate
        addShapedRecipe(
            ModBlocks.CHISELED_COPPER.newItemStack(),
            "x",
            "x",
            'x',
            ModBlocks.CUT_COPPER_SLAB.newItemStack());
        addShapedRecipe(
            ModBlocks.CHISELED_COPPER.newItemStack(1, 1),
            "x",
            "x",
            'x',
            ModBlocks.CUT_COPPER_SLAB.newItemStack(1, 1));
        addShapedRecipe(
            ModBlocks.CHISELED_COPPER.newItemStack(1, 2),
            "x",
            "x",
            'x',
            ModBlocks.CUT_COPPER_SLAB.newItemStack(1, 2));
        addShapedRecipe(
            ModBlocks.CHISELED_COPPER.newItemStack(1, 3),
            "x",
            "x",
            'x',
            ModBlocks.CUT_COPPER_SLAB.newItemStack(1, 3));

        // Waxed copper block to waxed copper grate
        addShapedRecipe(
            ModBlocks.CHISELED_COPPER.newItemStack(1, 4),
            "x",
            "x",
            'x',
            ModBlocks.CUT_COPPER_SLAB.newItemStack(1, 4));
        addShapedRecipe(
            ModBlocks.CHISELED_COPPER.newItemStack(1, 5),
            "x",
            "x",
            'x',
            ModBlocks.CUT_COPPER_SLAB.newItemStack(1, 5));
        addShapedRecipe(
            ModBlocks.CHISELED_COPPER.newItemStack(1, 6),
            "x",
            "x",
            'x',
            ModBlocks.CUT_COPPER_SLAB.newItemStack(1, 6));
        addShapedRecipe(
            ModBlocks.CHISELED_COPPER.newItemStack(1, 7),
            "x",
            "x",
            'x',
            ModBlocks.CUT_COPPER_SLAB.newItemStack(1, 7));

        // Cut copper to cut copper slab
        if (!ModsList.GTNH.isLoaded()) {
            addShapedRecipe(
                ModBlocks.CUT_COPPER_SLAB.newItemStack(6),
                "xxx",
                'x',
                ModBlocks.COPPER_BLOCK.newItemStack(1, 4));
            addShapedRecipe(
                ModBlocks.CUT_COPPER_SLAB.newItemStack(6, 1),
                "xxx",
                'x',
                ModBlocks.COPPER_BLOCK.newItemStack(1, 5));
            addShapedRecipe(
                ModBlocks.CUT_COPPER_SLAB.newItemStack(6, 2),
                "xxx",
                'x',
                ModBlocks.COPPER_BLOCK.newItemStack(1, 6));
            addShapedRecipe(
                ModBlocks.CUT_COPPER_SLAB.newItemStack(6, 3),
                "xxx",
                'x',
                ModBlocks.COPPER_BLOCK.newItemStack(1, 7));

            // Waxed cut copper to waxed cut copper slab
            addShapedRecipe(
                ModBlocks.CUT_COPPER_SLAB.newItemStack(6, 4),
                "xxx",
                'x',
                ModBlocks.COPPER_BLOCK.newItemStack(1, 12));
            addShapedRecipe(
                ModBlocks.CUT_COPPER_SLAB.newItemStack(6, 5),
                "xxx",
                'x',
                ModBlocks.COPPER_BLOCK.newItemStack(1, 13));
            addShapedRecipe(
                ModBlocks.CUT_COPPER_SLAB.newItemStack(6, 6),
                "xxx",
                'x',
                ModBlocks.COPPER_BLOCK.newItemStack(1, 14));
            addShapedRecipe(
                ModBlocks.CUT_COPPER_SLAB.newItemStack(6, 7),
                "xxx",
                'x',
                ModBlocks.COPPER_BLOCK.newItemStack(1, 15));
        }

        // Cut copper to cut copper stairs
        addShapedRecipe(
            ModBlocks.CUT_COPPER_STAIRS.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
            ModBlocks.COPPER_BLOCK.newItemStack(1, 4));
        addShapedRecipe(
            ModBlocks.EXPOSED_CUT_COPPER_STAIRS.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
            ModBlocks.COPPER_BLOCK.newItemStack(1, 5));
        addShapedRecipe(
            ModBlocks.WEATHERED_CUT_COPPER_STAIRS.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
            ModBlocks.COPPER_BLOCK.newItemStack(1, 6));
        addShapedRecipe(
            ModBlocks.OXIDIZED_CUT_COPPER_STAIRS.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
        ...
        addShapedRecipe(
            ModBlocks.WAXED_CUT_COPPER_STAIRS.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
            ModBlocks.COPPER_BLOCK.newItemStack(1, 12));
        addShapedRecipe(
            ModBlocks.WAXED_EXPOSED_CUT_COPPER_STAIRS.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
            ModBlocks.COPPER_BLOCK.newItemStack(1, 13));
        addShapedRecipe(
            ModBlocks.WAXED_WEATHERED_CUT_COPPER_STAIRS.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
            ModBlocks.COPPER_BLOCK.newItemStack(1, 14));
        addShapedRecipe(
            ModBlocks.WAXED_OXIDIZED_CUT_COPPER_STAIRS.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
        ...
        if (!ModsList.GTNH.isLoaded()) {
            addShapedRecipe(
                ModBlocks.COPPER_DOOR.newItemStack(3),
                "xx",
                "xx",
                "xx",
                'x',
                ModItems.COPPER_INGOT.newItemStack());
            addShapedRecipe(
                ModBlocks.COPPER_TRAPDOOR.newItemStack(2),
                "xxX",
                "xxX",
                'x',
                ModItems.COPPER_INGOT.newItemStack());
        ...
        for (int k = 0; k <= IDegradable.waxStrings.length; k++) {
            ...
            if (OreDictionary.doesOreNameExist(waxString)) {
                ...
                addShapelessRecipe(
                    ModBlocks.COPPER_GRATE.newItemStack(1, 4),
                    waxString,
                    ModBlocks.COPPER_GRATE.newItemStack(1));
                addShapelessRecipe(
                    ModBlocks.COPPER_GRATE.newItemStack(1, 5),
                    waxString,
                    ModBlocks.COPPER_GRATE.newItemStack(1, 1));
                addShapelessRecipe(
                    ModBlocks.COPPER_GRATE.newItemStack(1, 6),
                    waxString,
                    ModBlocks.COPPER_GRATE.newItemStack(1, 2));
                addShapelessRecipe(
                    ModBlocks.COPPER_GRATE.newItemStack(1, 7),
                    waxString,
                    ModBlocks.COPPER_GRATE.newItemStack(1, 3));

                // Copper grate to waxed copper grate
                addShapelessRecipe(
                    ModBlocks.CHISELED_COPPER.newItemStack(1, 4),
                    waxString,
                    ModBlocks.CHISELED_COPPER.newItemStack(1));
                addShapelessRecipe(
                    ModBlocks.CHISELED_COPPER.newItemStack(1, 5),
                    waxString,
                    ModBlocks.CHISELED_COPPER.newItemStack(1, 1));
                ...
                // Cut copper block to waxed cut copper blocks
                addShapelessRecipe(
                    ModBlocks.COPPER_BULB.newItemStack(1, 12),
                    waxString,
                    ModBlocks.COPPER_BULB.newItemStack(1, 4));
                addShapelessRecipe(
                    ModBlocks.COPPER_BULB.newItemStack(1, 13),
                    waxString,
                    ModBlocks.COPPER_BULB.newItemStack(1, 5));
                addShapelessRecipe(
                    ModBlocks.COPPER_BULB.newItemStack(1, 14),
                    waxString,
                    ModBlocks.COPPER_BULB.newItemStack(1, 6));
                addShapelessRecipe(
                    ModBlocks.COPPER_BULB.newItemStack(1, 15),
                    waxString,
                    ModBlocks.COPPER_BULB.newItemStack(1, 7));

                // Cut copper slabs to waxed cut copper slabs
                addShapelessRecipe(
                    ModBlocks.CUT_COPPER_SLAB.newItemStack(1, 4),
                    waxString,
                    ModBlocks.CUT_COPPER_SLAB.newItemStack(1));
                addShapelessRecipe(
                    ModBlocks.CUT_COPPER_SLAB.newItemStack(1, 5),
                    waxString,
                    ModBlocks.CUT_COPPER_SLAB.newItemStack(1, 1));
                ...
                addShapelessRecipe(
                    ModBlocks.WAXED_CUT_COPPER_STAIRS.newItemStack(),
                    waxString,
                    ModBlocks.CUT_COPPER_STAIRS.newItemStack());
                addShapelessRecipe(
                    ModBlocks.WAXED_EXPOSED_CUT_COPPER_STAIRS.newItemStack(),
                    waxString,
                    ModBlocks.EXPOSED_CUT_COPPER_STAIRS.newItemStack());
                addShapelessRecipe(
                    ModBlocks.WAXED_WEATHERED_CUT_COPPER_STAIRS.newItemStack(),
                    waxString,
                    ModBlocks.WEATHERED_CUT_COPPER_STAIRS.newItemStack());
                addShapelessRecipe(
                    ModBlocks.WAXED_OXIDIZED_CUT_COPPER_STAIRS.newItemStack(),
                    waxString,
                    ModBlocks.OXIDIZED_CUT_COPPER_STAIRS.newItemStack());

                // Copper door to waxed copper door
                addShapelessRecipe(
                    ModBlocks.WAXED_COPPER_DOOR.newItemStack(),
                    waxString,
                    ModBlocks.COPPER_DOOR.newItemStack());
                addShapelessRecipe(
                    ModBlocks.WAXED_EXPOSED_COPPER_DOOR.newItemStack(),
                    waxString,
                    ModBlocks.EXPOSED_COPPER_DOOR.newItemStack());
                addShapelessRecipe(
                    ModBlocks.WAXED_WEATHERED_COPPER_DOOR.newItemStack(),
                    waxString,
                    ModBlocks.WEATHERED_COPPER_DOOR.newItemStack());
                addShapelessRecipe(
                    ModBlocks.WAXED_OXIDIZED_COPPER_DOOR.newItemStack(),
                    waxString,
                    ModBlocks.OXIDIZED_COPPER_DOOR.newItemStack());

                // Copper trapdoor to waxed cut copper trapdoor
                addShapelessRecipe(
                    ModBlocks.WAXED_COPPER_TRAPDOOR.newItemStack(),
                    waxString,
                    ModBlocks.COPPER_TRAPDOOR.newItemStack());
                addShapelessRecipe(
                    ModBlocks.WAXED_EXPOSED_COPPER_TRAPDOOR.newItemStack(),
                    waxString,
                    ModBlocks.EXPOSED_COPPER_TRAPDOOR.newItemStack());
                addShapelessRecipe(
                    ModBlocks.WAXED_WEATHERED_COPPER_TRAPDOOR.newItemStack(),
                    waxString,
                    ModBlocks.WEATHERED_COPPER_TRAPDOOR.newItemStack());
                addShapelessRecipe(
                    ModBlocks.WAXED_OXIDIZED_COPPER_TRAPDOOR.newItemStack(),
                    waxString,
                    ModBlocks.OXIDIZED_COPPER_TRAPDOOR.newItemStack());
            }
        }
        ...
        addShapedRecipe(
            ModBlocks.POLISHED_DEEPSLATE.newItemStack(4),
            "xx",
            "xx",
            'x',
            ModBlocks.COBBLED_DEEPSLATE.newItemStack());
        addShapedRecipe(
            ModBlocks.DEEPSLATE_BRICKS.newItemStack(4),
            "xx",
            "xx",
            'x',
            ModBlocks.POLISHED_DEEPSLATE.newItemStack());
        addShapedRecipe(
            ModBlocks.DEEPSLATE_BRICKS.newItemStack(4, 2),
            "xx",
            "xx",
            'x',
            ModBlocks.DEEPSLATE_BRICKS.newItemStack());
        addShapedRecipe(
            ModBlocks.DEEPSLATE_BRICKS.newItemStack(1, 4),
            "x",
            "x",
            'x',
            ModBlocks.DEEPSLATE_SLAB.newItemStack());
        ...
        addShapedRecipe(
            ModBlocks.COBBLED_DEEPSLATE_STAIRS.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
            ModBlocks.COBBLED_DEEPSLATE.newItemStack());
        addShapedRecipe(
            ModBlocks.POLISHED_DEEPSLATE_STAIRS.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
            ModBlocks.POLISHED_DEEPSLATE.newItemStack());
        addShapedRecipe(
            ModBlocks.DEEPSLATE_BRICK_STAIRS.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
            ModBlocks.DEEPSLATE_BRICKS.newItemStack());
        addShapedRecipe(
            ModBlocks.DEEPSLATE_TILE_STAIRS.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
            ModBlocks.DEEPSLATE_BRICKS.newItemStack(1, 2));
        if (!ModsList.GTNH.isLoaded()) {
            addShapedRecipe(
                ModBlocks.DEEPSLATE_SLAB.newItemStack(6),
                "xxx",
                'x',
                ModBlocks.COBBLED_DEEPSLATE.newItemStack());
            addShapedRecipe(
                ModBlocks.DEEPSLATE_SLAB.newItemStack(6, 1),
                "xxx",
                'x',
                ModBlocks.POLISHED_DEEPSLATE.newItemStack());
            addShapedRecipe(
                ModBlocks.DEEPSLATE_BRICK_SLAB.newItemStack(6),
                "xxx",
                'x',
                ModBlocks.DEEPSLATE_BRICKS.newItemStack());
            addShapedRecipe(
                ModBlocks.DEEPSLATE_BRICK_SLAB.newItemStack(6, 1),
                "xxx",
                'x',
                ModBlocks.DEEPSLATE_BRICKS.newItemStack(1, 2));
        }
        addShapedRecipe(
            ModBlocks.DEEPSLATE_WALL.newItemStack(6),
            "xxx",
            "xxx",
            'x',
            ModBlocks.COBBLED_DEEPSLATE.newItemStack());
        addShapedRecipe(
            ModBlocks.DEEPSLATE_WALL.newItemStack(6, 1),
            "xxx",
            "xxx",
            'x',
            ModBlocks.POLISHED_DEEPSLATE.newItemStack());
        addShapedRecipe(
            ModBlocks.DEEPSLATE_BRICK_WALL.newItemStack(6),
            "xxx",
            "xxx",
            'x',
            ModBlocks.DEEPSLATE_BRICKS.newItemStack());
        addShapedRecipe(
            ModBlocks.DEEPSLATE_BRICK_WALL.newItemStack(6, 1),
            "xxx",
            "xxx",
            'x',
            ModBlocks.DEEPSLATE_BRICKS.newItemStack(1, 2));
        ...
        addShapedRecipe(
            ModBlocks.POLISHED_TUFF_STAIRS.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
            ModBlocks.TUFF.newItemStack(1, 1));
        addShapedRecipe(
            ModBlocks.TUFF_BRICK_STAIRS.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
            ModBlocks.TUFF.newItemStack(1, 2));
        if (!ModsList.GTNH.isLoaded()) {
        ...
        // Mud Recipes
        addShapelessRecipe(
            ModBlocks.MUDDY_MANGROVE_ROOTS.newItemStack(1),
            ModBlocks.MUD.newItemStack(),
            ModBlocks.MANGROVE_ROOTS.newItemStack());

        // VANILLA
        addShapelessRecipe(
            ModBlocks.PACKED_MUD.newItemStack(1, 0),
            ModBlocks.MUD.newItemStack(1),
            new ItemStack(Items.wheat, 1));
        addShapedRecipe(
            ModBlocks.PACKED_MUD.newItemStack(4, 1),
            "xx",
            "xx",
            'x',
            ModBlocks.PACKED_MUD.newItemStack(1, 0));
        ...
        addShapedRecipe(
            ModBlocks.MUD_BRICK_STAIRS.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
            ModBlocks.PACKED_MUD.newItemStack(1, 1));
        if (!ModsList.GTNH.isLoaded()) {
            addShapedRecipe(
                ModBlocks.MUD_BRICK_SLAB.newItemStack(6, 0),
                "xxx",
                'x',
                ModBlocks.PACKED_MUD.newItemStack(1, 1));
        }
        addShapedRecipe(
            ModBlocks.MUD_BRICK_WALL.newItemStack(6, 0),
            "xxx",
            "xxx",
            'x',
            ModBlocks.PACKED_MUD.newItemStack(1, 1));
        ...
        addShapedRecipe(
            ModBlocks.MOSS_BLOCK.newItemStack(1, 0),
            "xxx",
            "xyx",
            "xxx",
            'x',
        ...
        if (!ModsList.GTNH.isLoaded()) {
            for (Map.Entry<String, ItemNewBoat.BoatInfo> entry : ItemNewBoat.BOAT_INFO.entrySet()) {
                String key = entry.getKey();
                if (key == null) continue;
                boolean isOak = entry.getKey()
                    .equals("minecraft:oak");
                ItemStack boat = (isOak && ConfigBlocksItems.replaceOldBoats ? new ItemStack(Items.boat)
                    : entry.getValue()
                        .getBoatItem());
                if (key.endsWith("_chest")) {
                    ItemStack inputBoat = ItemNewBoat.BOAT_INFO.get(key.substring(0, key.indexOf("_chest")))
                        .getBoatItem();
                    ...
                    if (isOak) { // We're using the plankWood tag for this, so it needs to be in the vanilla sorter
                        GameRegistry.addRecipe(
                            new ShapedOreRecipe(
                                boat,
                                (ConfigBlocksItems.replaceOldBoats ? "x x" : "xyx"),
                                "xxx",
                                'x',
                                "plankWood",
                                'y',
                                new ItemStack(Items.wooden_shovel, 1)));
                    } else { // Not a tagged recipe, we sort this before vanilla recipes, so it takes precedent over
                             // them
                        addShapedRecipe(
                            boat,
                            (ConfigBlocksItems.replaceOldBoats ? "x x" : "xyx"),
            ...
            addShapedRecipe(
                ModBlocks.SHULKER_BOX.newItemStack(),
                "x",
                "c",
                "x",
                'x',
                ModItems.SHULKER_SHELL.newItemStack(),
                'c',
        ...
        if (ModBlocks.SHULKER_BOX.isEnabled()) {
            for (int i = ore_dyes.length - 1; i >= 0; i--) {// Dyed box recipes
                ...
                shulker.getTagCompound()
                    .setByte("Color", (byte) (16 - i));
                GameRegistry.addRecipe(
                    new RecipeDyedShulkerBox(shulker, new Object[] { ModBlocks.SHULKER_BOX.get(), ore_dyes[i] }));
            }
        }
        addShapedRecipe(
            ModItems.SHULKER_BOX_UPGRADE.newItemStack(),
            "XXX",
            "XYX",
            "XXX",
            'X',
            "ingotIron",
            'Y',
            ModItems.SHULKER_SHELL.get());
        addShapedRecipe(
            ModItems.SHULKER_BOX_UPGRADE.newItemStack(1, 1),
            "XXX",
            "XYX",
            "XXX",
            'X',
            ...
            ModItems.SHULKER_SHELL.get());
        addShapedRecipe(
            ModItems.SHULKER_BOX_UPGRADE.newItemStack(1, 2),
            "XYX",
            "XXX",
            "XXX",
            'X',
            ...
            "ingotIron");
        addShapedRecipe(
            ModItems.SHULKER_BOX_UPGRADE.newItemStack(1, 3),
            "GXG",
            "GYG",
            "GXG",
            'X',
            ...
            "blockGlassColorless");
        addShapedRecipe(
            ModItems.SHULKER_BOX_UPGRADE.newItemStack(1, 4),
            "XYX",
            "XXX",
            "XXX",
            'X',
            ...
            "blockGlassColorless");
        addShapedRecipe(
            ModItems.SHULKER_BOX_UPGRADE.newItemStack(1, 5),
            "XYX",
            "XXX",
            "XXX",
            'X',
            ...
            Blocks.obsidian);
        addShapedRecipe(
            ModItems.SHULKER_BOX_UPGRADE.newItemStack(1, 6),
            "GGG",
            "XYX",
            "XGX",
            'X',
            ...
            "blockGlassColorless");
        addShapedRecipe(
            ModItems.SHULKER_BOX_UPGRADE.newItemStack(1, 7),
            "XYX",
            "XXX",
            "XXX",
            'X',
            ...
            "ingotCopper");
        addShapedRecipe(
            ModItems.SHULKER_BOX_UPGRADE.newItemStack(1, 8),
            "XYX",
            "GGG",
            "XGX",
            'X',
        ...
        if (ConfigWorld.tileReplacementMode == -1) {
            // We keep the original enabled checks inside of the booleans and use the original addShapedRecipe function
            // because we need to check it anyways for recipe removal
            if (ModBlocks.ANVIL.isEnabled()) {
                GameRegistry.addShapedRecipe(
                    ModBlocks.ANVIL.newItemStack(),
                    "BBB",
                    " I ",
                    "III",
                    'I',
            ...
            if (ModBlocks.BREWING_STAND.isEnabled()) {
                GameRegistry.addShapedRecipe(
                    ModBlocks.BREWING_STAND.newItemStack(),
                    " B ",
                    "CCC",
                    'C',
                    new ItemStack(Blocks.cobblestone),
            ...
            if (ModBlocks.ENCHANTMENT_TABLE.isEnabled()) {
                GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                        ModBlocks.ENCHANTMENT_TABLE.newItemStack(),
                        " B ",
                        "D#D",
                        "###",
                        '#',
            ...
            if (ModBlocks.SPONGE.isEnabled()) {
                ...
                addShapelessRecipe(new ItemStack(Blocks.sponge), ModBlocks.SPONGE.get()); // For recipes that want the
                                                                                          // vanilla sponge you can
                                                                                          // convert it
            }
        }

        addShapedRecipe(
            ModBlocks.STONE_WALL.newItemStack(6),
            "BBB",
            "BBB",
            'B',
            new ItemStack(Blocks.stonebrick, 1, 0));
        addShapedRecipe(
            ModBlocks.STONE_WALL.newItemStack(6, 1),
            "BBB",
            "BBB",
            'B',
            new ItemStack(Blocks.stonebrick, 1, 1));
        addShapedRecipe(
            ModBlocks.STONE_WALL.newItemStack(6, 2),
            "BBB",
            "BBB",
            'B',
            new ItemStack(Blocks.sandstone, 1, 0));
        addShapedRecipe(
            ModBlocks.STONE_WALL.newItemStack(6, 3),
            "BBB",
            "BBB",
            'B',
        ...
        addShapedRecipe(
            ModBlocks.NETHER_BRICK_WALL.newItemStack(6),
            "BBB",
            "BBB",
            'B',
        ...
        addShapedRecipe(
            ModBlocks.FLETCHING_TABLE.newItemStack(),
            "FF",
            "PP",
            "PP",
            'P',
        ...
        addShapedRecipe(
            ModBlocks.CARTOGRAPHY_TABLE.newItemStack(),
            "pp",
            "PP",
            "PP",
            'P',
        ...
        addShapedRecipe(
            ModBlocks.TINTED_GLASS.newItemStack(2, 0),
            " A ",
            "AGA",
            " A ",
            'A',
        ...
        if (!ModsList.GTNH.isLoaded()) {
            ...
            addShapedRecipe(
                ModBlocks.OBSERVER.newItemStack(),
                "CCC",
                "RRQ",
                "CCC",
                'R',
        ...
        addShapedRecipe(
            ModBlocks.BEEHIVE.newItemStack(),
            "WWW",
            "HHH",
            "WWW",
            'W',
        ...
        addShapedRecipe(
            ModBlocks.BLACKSTONE.newItemStack(4, 2),
            "xx",
            "xx",
            'x',
            ModBlocks.BLACKSTONE.newItemStack(1, 1));
        addShapedRecipe(
            ModBlocks.BLACKSTONE.newItemStack(1, 4),
            "x",
            "x",
            'x',
            ModBlocks.BLACKSTONE_SLAB.newItemStack(1, 1));
        ...
        if (!ModsList.GTNH.isLoaded()) {
            ...
            addShapedRecipe(
                ModBlocks.BLACKSTONE_SLAB.newItemStack(6, 1),
                "xxx",
                'x',
                ModBlocks.BLACKSTONE.newItemStack(1, 1));
            addShapedRecipe(
                ModBlocks.BLACKSTONE_SLAB.newItemStack(6, 2),
                "xxx",
                'x',
                ModBlocks.BLACKSTONE.newItemStack(1, 2));
        }

        addShapedRecipe(
            ModBlocks.BLACKSTONE_STAIRS.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
        ...
        addShapedRecipe(
            ModBlocks.POLISHED_BLACKSTONE_STAIRS.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
            ModBlocks.BLACKSTONE.newItemStack(1, 1));
        addShapedRecipe(
            ModBlocks.POLISHED_BLACKSTONE_BRICK_STAIRS.newItemStack(4),
            "x  ",
            "xx ",
            "xxx",
            'x',
        ...
        addShapedRecipe(
            ModBlocks.BLACKSTONE_WALL.newItemStack(6),
            "xxx",
            "xxx",
            'x',
            ModBlocks.BLACKSTONE.newItemStack());
        addShapedRecipe(
            ModBlocks.BLACKSTONE_WALL.newItemStack(6, 1),
            "xxx",
            "xxx",
            'x',
            ModBlocks.BLACKSTONE.newItemStack(1, 1));
        addShapedRecipe(
            ModBlocks.BLACKSTONE_WALL.newItemStack(6, 2),
            "xxx",
            "xxx",
            'x',
            ModBlocks.BLACKSTONE.newItemStack(1, 2));
        ...
        if (!ModsList.GTNH.isLoaded()) {
            addShapedRecipe(
                ModBlocks.POLISHED_BLACKSTONE_BUTTON.newItemStack(1),
                "x",
                'x',
                ModBlocks.BLACKSTONE.newItemStack(1, 1));
            addShapedRecipe(
                ModBlocks.POLISHED_BLACKSTONE_PRESSURE_PLATE.newItemStack(1),
                "xx",
                'x',
                ModBlocks.BLACKSTONE.newItemStack(1, 1));
        }
        ...
        if (ModsList.LOTR.isLoaded()) {// LoTR ores and ingots stupidly lack dictionary entries; let's add them so the
                                       // code below can find them.
        ...
        if (!ConfigExperiments.netherDimensionProvider) { // A way to get soul soil without new Nether
            addShapelessRecipe(
                ModBlocks.SOUL_SOIL.newItemStack(5),
                Blocks.dirt,
                Blocks.soul_sand,
                Blocks.soul_sand,
                Blocks.soul_sand,
        ...
        if (ConfigModCompat.moddedDeepslateOres) { // OreDict-based registration is only used when mod support is
                                                   // enabled
        ...
        addShapedRecipe(
            ModBlocks.RAW_ORE_BLOCK.newItemStack(),
            "xxx",
            "xxx",
            "xxx",
            'x',
            ModItems.RAW_ORE.newItemStack());
        ...
        addShapedRecipe(
            ModBlocks.RAW_ORE_BLOCK.newItemStack(1, 1),
            "xxx",
            "xxx",
            "xxx",
            'x',
            ModItems.RAW_ORE.newItemStack(1, 1));
        ...
        addShapedRecipe(
            ModBlocks.RAW_ORE_BLOCK.newItemStack(1, 2),
            "xxx",
            "xxx",
            "xxx",
            'x',
            ModItems.RAW_ORE.newItemStack(1, 2));
    ...
    public static void registerGeneralDeepslateOres() {
        // Insert alternate Mythril spelling to list. Yes I know "mithril" is technically the primary spelling but
        // "mythril" is used by most mods, so "mithril" is secondary to it here.
        for (BlockGeneralModdedDeepslateOre block : BlockGeneralModdedDeepslateOre.loaded) { // Future-proofing in case
                                                                                             // I add more than one
            for (int i = 0; i < block.ores.length; i++) {
                ...
                // Well it's probably *technically* possible but I don't want to do it, PR an OD remover if you need EFR
                // to do it.
                // For now just restart your game to clear entries that would no longer get a tag.
                for (int j = 0; j < 1; j++) { // If it's mythril, we'll run this once more, changing the spelling to
                                              // mithril to account for both tags.
                    if (Utils.listGeneralModdedDeepslateOre(type)) { // Make sure an ore is present.
                        ...
                        registerOre(type, ModBlocks.MODDED_DEEPSLATE_ORE.newItemStack(1, i));
                        registerOre(
                            type.replace("ore", "oreDeepslate"),
                            ModBlocks.MODDED_DEEPSLATE_ORE.newItemStack(1, i));
                    }
    ...
    public static void unregisterGeneralRawOres() {
        Pair<List<ItemGeneralModdedRawOre>, List<BlockGeneralModdedRawOre>> pair = Pair
            .of(ItemGeneralModdedRawOre.loaded, BlockGeneralModdedRawOre.loaded);
        if (pair.getLeft()
            .isEmpty()) {
            return;
        }
        for (int j = 0; j < pair.getLeft()
            .size(); j++) {
            ItemGeneralModdedRawOre oreItem = pair.getLeft()
                .get(j);
            BlockGeneralModdedRawOre oreBlock = pair.getRight()
                .get(j);
            for (int i = 0; i < oreItem.ores.length; i++) {
                ...
                Iterator<ItemStack> iterator = FurnaceRecipes.smelting()
                    .getSmeltingList()
                    .keySet()
                    .iterator();
                while (iterator.hasNext()) {
                    ItemStack smeltingInput = iterator.next();
                    if (stack.getItem() == smeltingInput.getItem()
                        && stack.getItemDamage() == smeltingInput.getItemDamage()) {
                        iterator.remove();
                    }
                }
            }
    ...
    public static void registerGeneralRawOres() {
        // Future-proofing in case I add more of these. Also will have only the meta-combined versions when enabled for
        // the eventual NEID/EID support
        Pair<List<ItemGeneralModdedRawOre>, List<BlockGeneralModdedRawOre>> pair = Pair
            .of(ItemGeneralModdedRawOre.loaded, BlockGeneralModdedRawOre.loaded);
        if (pair.getLeft()
            .size()
            ...
            for (int i = 0; i < oreItem.ores.length; i++) {
                ...
                for (int j = 0; j < 1; j++) { // If it's mythril, we'll run this once more, changing the spelling to
                    ...
                    if (Utils.listGeneralModdedRawOre(type)) { // Make sure an ingot AND ore is present
                        ...
                        if (!registeredRecipe) {
                            addShapedRecipe(
                                new ItemStack(oreBlock, 1, i),
                                "xxx",
                                "xxx",
                                "xxx",
                                'x',
                                new ItemStack(oreItem, 1, i));
    ...
    private static void registerModSupportRawOres() {
        if (ModItems.RAW_ADAMANTIUM.isEnabled() && ModBlocks.RAW_ADAMANTIUM_BLOCK.isEnabled()) {
            ...
            addShapedRecipe(
                ModBlocks.RAW_ADAMANTIUM_BLOCK.newItemStack(),
                "xxx",
                "xxx",
                "xxx",
                'x',
                ModItems.RAW_ADAMANTIUM.newItemStack());
            addShapedRecipe(
                ModItems.RAW_ADAMANTIUM.newItemStack(9),
                "x",
                'x',
                ModBlocks.RAW_ADAMANTIUM_BLOCK.newItemStack());
            addSmelting(
                ModItems.RAW_ADAMANTIUM.newItemStack(),
                ExternalContent.Items.SIMPLEORES_ADAMANTIUM_INGOT.newItemStack(),
                ExternalContent.Items.SIMPLEORES_ADAMANTIUM_INGOT.get()
                    .getSmeltingExperience(ExternalContent.Items.SIMPLEORES_ADAMANTIUM_INGOT.newItemStack()));
    ...
    private static void removeFurnaceRecipeFor(ItemStack input, ItemStack output) {
        for (Map.Entry<ItemStack, ItemStack> set : FurnaceRecipes.smelting()
            .getSmeltingList()
            .entrySet()) {
            ItemStack setInput = set.getKey();
            ItemStack setOutput = set.getValue();
            int wildcard = OreDictionary.WILDCARD_VALUE;
            if (input.getItem() == setInput.getItem()
                && (input.getItemDamage() == wildcard || setInput.getItemDamage() == wildcard
                    || (input.getItemDamage() == setInput.getItemDamage()))) {
                if (output.getItem() == setOutput.getItem()
                    && (output.getItemDamage() == wildcard || setOutput.getItemDamage() == wildcard
                        || (output.getItemDamage() == setOutput.getItemDamage()))) {
                    FurnaceRecipes.smelting()
                        .getSmeltingList()
                        .remove(setInput, setOutput);
                    return;
                }
            }
        }
        ...
        for (Object object : objects) {
            ...
            if (object instanceof ItemStack) {
                if (((ItemStack) object).getItem() == null
                    || Item.itemRegistry.getNameForObject(((ItemStack) object).getItem()) == null) {
                    return false;
                }
            }
