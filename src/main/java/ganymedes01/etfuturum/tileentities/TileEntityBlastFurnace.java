...
public class TileEntityBlastFurnace extends TileEntity implements ISidedInventory {
    ...
    public String getInventoryName() {
        return this.hasCustomInventoryName() ? this.furnaceCustomName
            : "container." + Reference.MOD_ID + ".blast_furnace";
    }
    ...
    public void updateEntity() {
        ...
        if (!this.worldObj.isRemote) {
            ...
            if (flag != this.furnaceBurnTime > 0) {
                flag1 = true;
                BlockBlastFurnace.updateFurnaceBlockState(
    ...
    private boolean canSmelt() {
        ...
        ItemStack itemstack = BlastFurnaceRecipes.smelting()
    ...
    public boolean canExtractItem(int p_102008_1_, ItemStack p_102008_2_, int p_102008_3_) {
        if (p_102008_2_ != null) return p_102008_3_ != 0 || p_102008_1_ != 1 || p_102008_2_.getItem() == Items.bucket;
