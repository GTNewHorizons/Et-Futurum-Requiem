...
public class TileEntityShulkerBox extends TileEntity implements IInventory {
    ...
    public void readFromNBT(NBTTagCompound nbt) {
        ...
        this.type = ConfigModCompat.shulkerBoxesIronChest ? ShulkerBoxType.VALUES[nbt.getByte("Type")]
            : ShulkerBoxType.VANILLA;
    ...
    public void openInventory() {
        ...
        if (this.numPlayersUsing == 1) {
            this.worldObj.playSoundEffect(
                ...
                yCoord + 0.5D,
                zCoord + 0.5D,
                Reference.MCAssetVer + ":block.shulker_box.open",
                1,
                1);
        }
        this.worldObj
        ...
        if (this.getBlockType() instanceof BlockShulkerBox) {
            ...
            if (this.numPlayersUsing <= 0) {
                this.worldObj.playSoundEffect(
                    ...
                    yCoord + 0.5D,
                    zCoord + 0.5D,
                    Reference.MCAssetVer + ":block.shulker_box.close",
                    1,
                    1);
            }
            this.worldObj
    ...
    public boolean isItemValidForSlot(int index, ItemStack stack) {
        return !(stack.getItem() instanceof ItemBlockShulkerBox
            || ConfigFunctions.shulkerBans.contains(stack.getItem()));
    }
    ...
    public ItemStack createItemStack(EntityPlayer player) {
        ...
        if ((!empty || player == null || !player.capabilities.isCreativeMode) && worldObj.getGameRules()
    ...
    public ItemStack writeToStack(ItemStack stack) {
        ...
        if (nbttaglist.tagCount() > 0) stack.getTagCompound()
            .setTag("Items", nbttaglist);

        byte typeOrd = (byte) type.ordinal();
        if (typeOrd > 0) stack.getTagCompound()
            .setByte("Type", typeOrd);

        if (color > 0) stack.getTagCompound()
            .setByte("Color", color);
    ...
    public AxisAlignedBB getBoundingBox(EnumFacing p_190587_1_) {
        return AxisAlignedBB.getBoundingBox(0.0D, 0.0D, 0.0D, 1.0D, 1.0D, 1.0D)
            .addCoord(
                0.5F * this.getProgress(1.0F) * (float) p_190587_1_.getFrontOffsetX(),
                0.5F * this.getProgress(1.0F) * (float) p_190587_1_.getFrontOffsetY(),
                0.5F * this.getProgress(1.0F) * (float) p_190587_1_.getFrontOffsetZ());
    }
    ...
    private AxisAlignedBB getTopBoundingBox(EnumFacing p_190588_1_) {
        ...
        return contract(
            this.getBoundingBox(p_190588_1_),
     ...
     * 
     * <pre>
     * <samp>box[0.0, 0.0, 0.0 -> 2.0, 2.0, 2.0]</samp>
     * </pre>
     * 
     * </td>
     * </tr>
     ...
     * 
     * <pre>
     * <code>new AxisAlignedBB(5, 5, 5, 7, 7, 7).contract(0, 1, -1)</code>
     * </pre>
     * 
     * </td>
     * <td>
     ...
     * 
     * <pre>
     * <code>new AxisAlignedBB(-2, -2, -2, 2, 2, 2).contract(4, -4, 0)</code>
     * </pre>
     * 
     * </td>
     * <td>
    ...
    public static final String[] tiers = new String[] { "iron", "gold", "diamond", "copper", "silver", "crystal",
        "obsidian" };
